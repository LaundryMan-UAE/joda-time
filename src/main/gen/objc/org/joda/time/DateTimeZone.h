...
/*!
 ...
 <ol>
 <li>load the specific <code>Provider</code> specified by the system property
 ...
 <li>load <code>ZoneInfoProvider</code> using the data in the classpath location
 <code>org/joda/time/tz/data</code>.
 <li>load <code>UTCProvider</code>
 </ol>
 <p>
...
/*!
 ...
 local time.
 This conversion is used before performing a calculation
...
/*!
 @brief Gets a hash code compatible with equals.
...
/*!
 @brief The default TZ data path
 This is the default classpath location containing the compiled data files.
 */
inline NSString *OrgJodaTimeDateTimeZone_get_DEFAULT_TZ_DATA_PATH();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT NSString *OrgJodaTimeDateTimeZone_DEFAULT_TZ_DATA_PATH;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgJodaTimeDateTimeZone, DEFAULT_TZ_DATA_PATH, NSString *)
...
/*!
 @brief Lazy initialization to avoid a synchronization lock.
 */
...
/*!
 @brief Time zone offset formatter.
 */
