...
//  source: /Users/Salton/Documents/Projects/joda-time/src/main/java/org/joda/time/tz/ZoneInfoCompiler.java
//
...
jint OrgJodaTimeTzZoneInfoCompiler_parseYearWithNSString_withInt_(NSString *str, jint def) {
  OrgJodaTimeTzZoneInfoCompiler_initialize();
  str = [((NSString *) nil_chk(str)) lowercaseStringWithJRELocale:JreLoadStatic(JavaUtilLocale, ENGLISH)];
...
- (void)addRecurringWithOrgJodaTimeTzDateTimeZoneBuilder:(OrgJodaTimeTzDateTimeZoneBuilder *)builder
  ...
  if (negativeSave < 0) {
    ...
    jint slashPos = [((NSString *) nil_chk(nameFormat)) indexOfString:@"/"];
    if (slashPos > 0) {
      nameFormat = JreStrcat("$C$", [nameFormat substring:slashPos + 1], '/', [nameFormat substring:0 endIndex:slashPos]);
    }
  }
