...
//  source: /Users/Salton/Documents/Projects/joda-time/src/main/java/org/joda/time/Interval.java
//
...
/*!
 @brief Parses an <code>Interval</code> from the specified string.
 <p>
 The String formats are described by <code>ISODateTimeFormat.dateTimeParser()</code>
 and <code>ISOPeriodFormat.standard()</code>, and may be 'datetime/datetime',
 'datetime/period' or 'period/datetime'.
 ...
 offset of the default time-zone. See also <code>parseWithOffset(String)</code>.
...
/*!
 @brief Parses an <code>Interval</code> from the specified string, using any offset it contains.
 <p>
 The String formats are described by
 <code>ISODateTimeFormat.dateTimeParser()</code><code>.withOffsetParsed()</code>
 and <code>ISOPeriodFormat.standard()</code>, and may be 'datetime/datetime',
 'datetime/period' or 'period/datetime'.
 <p>
 Sometimes this method and <code>new Interval(str)</code> return different results.
 This can be confusing as the difference is not visible in <code>toString()</code>.
 <p>
 ...
 As such, <code>Interval.parseWithOffset("2010-06-30T01:20/P1D")</code> and
 <code>new Interval("2010-06-30T01:20/P1D"))</code> are equal.
 <p>
 However, when this method is passed a string with an offset,
 the offset is directly parsed and stored.
 As such, <code>Interval.parseWithOffset("2010-06-30T01:20+02:00/P1D")</code> and
 <code>new Interval("2010-06-30T01:20+02:00/P1D"))</code> are NOT equal.
 The object produced via this method has a zone of <code>DateTimeZone.forOffsetHours(2)</code>.
...
/*!
 @brief Creates a new interval with the specified end millisecond instant.
