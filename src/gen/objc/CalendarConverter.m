...
//  source: /Users/andrewebling/Laundrapp/Joda-time-Project/joda-time/src/main/java/org/joda/time/convert/CalendarConverter.java
//
...
- (OrgJodaTimeChronology *)getChronologyWithId:(id)object
  ...
  @try {
    zone = [OrgJodaTimeDateTimeZone forTimeZoneWithJavaUtilTimeZone:[((JavaUtilCalendar *) nil_chk(cal)) getTimeZone]];
  }
...
- (OrgJodaTimeChronology *)getChronologyWithId:(id)object
  ...
  if ([((NSString *) nil_chk([[nil_chk(object) getClass] getName])) hasSuffix:@".BuddhistCalendar"]) {
    ...
    long long int cutover = [((JavaUtilDate *) nil_chk([gc getGregorianChange])) getTime];
    if (cutover == JavaLangLong_MIN_VALUE) {
      ...
      return [OrgJodaTimeChronoGJChronology getInstanceWithOrgJodaTimeDateTimeZone:zone withLong:cutover withInt:4];
    }
  }
  else {
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertCalendarConverter class]) {
    OrgJodaTimeConvertCalendarConverter_INSTANCE_ = [[OrgJodaTimeConvertCalendarConverter alloc] init];
    OrgJodaTimeConvertCalendarConverter_initialized = YES;
  }
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaTimeConvertCalendarConverter = { "CalendarConverter", "org.joda.time.convert", NULL, 0x10, 5, methods, 1, fields, 0, NULL};
