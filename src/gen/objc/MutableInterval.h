...
__attribute__((always_inline)) inline void OrgJodaTimeMutableInterval_init() {}

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeMutableInterval, serialVersionUID, long long int)
