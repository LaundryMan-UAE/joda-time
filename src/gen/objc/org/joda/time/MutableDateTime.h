...
/*!
 ...
 @throw IllegalArgumentExceptionif mode is unknown, no exception if field is null
 */
- (void)setRoundingWithOrgJodaTimeDateTimeField:(OrgJodaTimeDateTimeField *)field
                                        withInt:(jint)mode;
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_NONE(void);
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_FLOOR(void);
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_CEILING(void);
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_HALF_FLOOR(void);
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_HALF_CEILING(void);
 ...
 */
inline jint OrgJodaTimeMutableDateTime_get_ROUND_HALF_EVEN(void);
...
FOUNDATION_EXPORT OrgJodaTimeMutableDateTime *OrgJodaTimeMutableDateTime_now(void);
...
FOUNDATION_EXPORT OrgJodaTimeMutableDateTime *new_OrgJodaTimeMutableDateTime_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeMutableDateTime *create_OrgJodaTimeMutableDateTime_init(void);
...
/*!
 @brief Round to the nearest whole unit of this field.If halfway, the ceiling
