...
//  source: /Users/marcussmith/temp/joda-time/src/main/java/org/joda/time/TimeOfDay.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgJodaTimeTimeOfDay")
#ifdef RESTRICT_OrgJodaTimeTimeOfDay
#define INCLUDE_ALL_OrgJodaTimeTimeOfDay 0
#else
#define INCLUDE_ALL_OrgJodaTimeTimeOfDay 1
#endif
#undef RESTRICT_OrgJodaTimeTimeOfDay

#if !defined (OrgJodaTimeTimeOfDay_) && (INCLUDE_ALL_OrgJodaTimeTimeOfDay || defined(INCLUDE_OrgJodaTimeTimeOfDay))
...
/*!
 @brief TimeOfDay is an immutable partial supporting the hour, minute, second
 ...
 <p>
  Calculations on TimeOfDay are performed using a <code>Chronology</code>.
...
/*!
 @brief Constructs a TimeOfDay with the current time, using ISOChronology in
...
/*!
 @brief Constructs a TimeOfDay with the current time, using the specified chronology
...
/*!
 @brief Constructs a TimeOfDay with specified time field values using 
...
/*!
 @brief Constructs a TimeOfDay extracting the partial fields from the specified
...
/*!
 ...
 <code>ConverterManager</code> and
  ...
  The String formats are described by <code>ISODateTimeFormat.timeParser()</code>.
  <p>
  The chronology used will be derived from the object, defaulting to ISO. 
 <p>
  NOTE: Prior to v1.3 the string format was described by 
 <code>ISODateTimeFormat.dateTimeParser()</code>. Dates are now rejected.
...
/*!
 @brief Constructs a TimeOfDay from an Object that represents a time, using the
...
/*!
 @brief Constructs a TimeOfDay from a <code>java.util.Calendar</code>
 ...
 @throw IllegalArgumentExceptionif the time is invalid for the ISO chronology
 @since 1.2
 */
+ (OrgJodaTimeTimeOfDay *)fromCalendarFieldsWithJavaUtilCalendar:(JavaUtilCalendar *)calendar;

/*!
 @brief Constructs a TimeOfDay from a <code>java.util.Date</code>
  using exactly the same field values avoiding any time zone effects.
 <p>
...
/*!
 @brief Constructs a TimeOfDay from the specified millis of day using the
  ISO chronology.
 <p>
...
/*!
 ...
 @throw ArithmeticExceptionif the new time exceeds capacity
 */
...
/*!
 ...
 @throw ArithmeticExceptionif the new datetime exceeds the capacity of a long
 */
...
@endcode
 ...
 @throw IllegalArgumentExceptionif the value is null or invalid
 @throw ArithmeticExceptionif the new datetime exceeds the capacity
 */
 ...
 */
inline OrgJodaTimeTimeOfDay *OrgJodaTimeTimeOfDay_get_MIDNIGHT(void);
 ...
 */
inline jint OrgJodaTimeTimeOfDay_get_HOUR_OF_DAY(void);
 ...
 */
inline jint OrgJodaTimeTimeOfDay_get_MINUTE_OF_HOUR(void);
 ...
 */
inline jint OrgJodaTimeTimeOfDay_get_SECOND_OF_MINUTE(void);
 ...
 */
inline jint OrgJodaTimeTimeOfDay_get_MILLIS_OF_SECOND(void);
...
FOUNDATION_EXPORT OrgJodaTimeTimeOfDay *new_OrgJodaTimeTimeOfDay_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeTimeOfDay *create_OrgJodaTimeTimeOfDay_init(void);
...
#if !defined (OrgJodaTimeTimeOfDay_Property_) && (INCLUDE_ALL_OrgJodaTimeTimeOfDay || defined(INCLUDE_OrgJodaTimeTimeOfDay_Property))
...
/*!
 @brief Adds to the value of this field in a copy of this TimeOfDay,
...
/*!
 ...
 <p>
  ...
  with no wrapping see <code>addNoWrapToCopy(int)</code>.
  <p>
  The TimeOfDay attached to this property is unchanged by this call.
  Instead, a new instance is returned.
 @param valueToAdd the value to add to the field in the copy
...
/*!
 @brief Adds to the value of this field in a copy of this TimeOfDay wrapping
...
/*!
 @brief Returns a new TimeOfDay with this field set to the maximum value
  for this field.
 <p>
  The TimeOfDay attached to this property is unchanged by this call.
...
/*!
 @brief Returns a new TimeOfDay with this field set to the minimum value
  for this field.
 <p>
  The TimeOfDay attached to this property is unchanged by this call.
...
#pragma pop_macro("INCLUDE_ALL_OrgJodaTimeTimeOfDay")
