...
//  source: /Users/Mike/Projects/joda-time/src/main/java/org/joda/time/base/AbstractInterval.java
//

#ifndef _OrgJodaTimeBaseAbstractInterval_H_
#define _OrgJodaTimeBaseAbstractInterval_H_
...
/**
 ...
 <p> This class should generally not be used directly by API users. The ReadableInterval interface should be used when different kinds of intervals are to be referenced. <p> AbstractInterval subclasses may be mutable and not thread-safe.
...
/**
 ...
 <p> Non-zero duration intervals are inclusive of the start instant and exclusive of the end. A zero duration interval cannot contain anything.
...
/**
 ...
 <p> Intervals are inclusive of the start instant and exclusive of the end. Only the end time of the specified interval is used in the comparison.
 @param interval the interval to compare to, null means now
...
/**
 @brief Converts the duration of the interval to a <code>Period</code> using the All period type.
...
/**
 @brief Converts the duration of the interval to a <code>Period</code> using the specified period type.
 <p> This method should be used to exract the field values describing the difference between the start and end instants.
