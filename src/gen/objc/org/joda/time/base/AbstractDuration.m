...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeBaseAbstractDuration__Annotations$0(void);
...
- (NSString *)description {
  ...
  while ([buf java_length] < (negative ? 7 : 6)) {
    [buf insertWithInt:negative ? 3 : 2 withNSString:@"0"];
  }
  if ((JreLongDiv(millis, 1000)) * 1000 == millis) {
    [buf setLengthWithInt:[buf java_length] - 3];
  }
  else {
    [buf insertWithInt:[buf java_length] - 3 withNSString:@"."];
  }
