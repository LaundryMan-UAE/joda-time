...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/base/BaseSingleFieldPeriod.java
//
...
jint OrgJodaTimeBaseBaseSingleFieldPeriod_standardPeriodInWithOrgJodaTimeReadablePeriod_withLong_(id<OrgJodaTimeReadablePeriod> period, jlong millisPerUnit) {
  ...
  return OrgJodaTimeFieldFieldUtils_safeToIntWithLong_(JreLongDiv(duration, millisPerUnit));
}
