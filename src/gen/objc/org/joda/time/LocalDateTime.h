...
@endcode
 ...
 @throw IllegalArgumentExceptionif any value if invalid
 */
...
FOUNDATION_EXPORT OrgJodaTimeLocalDateTime *OrgJodaTimeLocalDateTime_now(void);
...
FOUNDATION_EXPORT OrgJodaTimeLocalDateTime *new_OrgJodaTimeLocalDateTime_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeLocalDateTime *create_OrgJodaTimeLocalDateTime_init(void);
