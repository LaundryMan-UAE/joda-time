...
#pragma push_macro("INCLUDE_ALL_OrgJodaTimeDateMidnight")
#ifdef RESTRICT_OrgJodaTimeDateMidnight
#define INCLUDE_ALL_OrgJodaTimeDateMidnight 0
#else
#define INCLUDE_ALL_OrgJodaTimeDateMidnight 1
#endif
#undef RESTRICT_OrgJodaTimeDateMidnight

#if !defined (OrgJodaTimeDateMidnight_) && (INCLUDE_ALL_OrgJodaTimeDateMidnight || defined(INCLUDE_OrgJodaTimeDateMidnight))
...
- (instancetype)initWithInt:(jint)arg0
                    ...
                    withInt:(jint)arg5
                    withInt:(jint)arg6
  withOrgJodaTimeChronology:(OrgJodaTimeChronology *)arg7 NS_UNAVAILABLE;
...
- (instancetype)initWithInt:(jint)arg0
                    ...
                    withInt:(jint)arg5
                    withInt:(jint)arg6
withOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)arg7 NS_UNAVAILABLE;

@end

J2OBJC_EMPTY_STATIC_INIT(OrgJodaTimeDateMidnight)

FOUNDATION_EXPORT OrgJodaTimeDateMidnight *OrgJodaTimeDateMidnight_now(void);
...
FOUNDATION_EXPORT OrgJodaTimeDateMidnight *new_OrgJodaTimeDateMidnight_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeDateMidnight *create_OrgJodaTimeDateMidnight_init(void);
...
#if !defined (OrgJodaTimeDateMidnight_Property_) && (INCLUDE_ALL_OrgJodaTimeDateMidnight || defined(INCLUDE_OrgJodaTimeDateMidnight_Property))
...
#pragma pop_macro("INCLUDE_ALL_OrgJodaTimeDateMidnight")
