...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "putWithJavaUtilMap:withNSString:withNSString:", "put", "V", 0xa, NULL, NULL },
    ...
    { "getDefaultTimeZoneNames", NULL, "Ljava.util.Map;", 0x19, NULL, NULL },
    { "setDefaultTimeZoneNamesWithJavaUtilMap:", "setDefaultTimeZoneNames", "V", 0x19, NULL, NULL },
