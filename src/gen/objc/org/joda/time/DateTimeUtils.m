...
//  source: /Users/andrefonseca/Documents/PodsFolders/Joda-Time/src/main/java/org/joda/time/DateTimeUtils.java
//
...
/*!
 @brief The millisecond provider currently in use.
 */
inline id<JavaUtilMap> OrgJodaTimeDateTimeUtils_get_cZoneNames();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "cZoneNames", "cZoneNames", 0x4a, "Ljava.util.Map;", &OrgJodaTimeDateTimeUtils_cZoneNames, "Ljava/util/Map<Ljava/lang/String;Lorg/joda/time/DateTimeZone;>;", .constantValue.asLong = 0 },
  };
...
void OrgJodaTimeDateTimeUtils_checkPermission() {
  ...
  if (sm != nil) {
    [sm checkPermissionWithJavaSecurityPermission:[new_OrgJodaTimeJodaTimePermission_initWithNSString_(@"CurrentTime.setProvider") autorelease]];
  }
}
...
id<OrgJodaTimeReadableInterval> OrgJodaTimeDateTimeUtils_getReadableIntervalWithOrgJodaTimeReadableInterval_(id<OrgJodaTimeReadableInterval> interval) {
  ...
  if (interval == nil) {
    ...
    interval = [new_OrgJodaTimeInterval_initWithLong_withLong_(now, now) autorelease];
  }
  return interval;
}
...
jboolean OrgJodaTimeDateTimeUtils_isContiguousWithOrgJodaTimeReadablePartial_(id<OrgJodaTimeReadablePartial> partial) {
  OrgJodaTimeDateTimeUtils_initialize();
  if (partial == nil) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(@"Partial must not be null") autorelease];
  }
...
JavaTextDateFormatSymbols *OrgJodaTimeDateTimeUtils_getDateFormatSymbolsWithJavaUtilLocale_(JavaUtilLocale *locale) {
  ...
  @catch (JavaLangException *ex) {
    return [new_JavaTextDateFormatSymbols_initWithJavaUtilLocale_(locale) autorelease];
  }
}
...
void OrgJodaTimeDateTimeUtils_setDefaultTimeZoneNamesWithJavaUtilMap_(id<JavaUtilMap> names) {
  OrgJodaTimeDateTimeUtils_initialize();
  JreVolatileStrongAssign(&OrgJodaTimeDateTimeUtils_cZoneNames, JavaUtilCollections_unmodifiableMapWithJavaUtilMap_([new_JavaUtilHashMap_initWithJavaUtilMap_(names) autorelease]));
}
