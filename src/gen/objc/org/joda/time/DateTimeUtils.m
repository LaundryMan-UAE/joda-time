...
inline JavaUtilConcurrentAtomicAtomicReference *OrgJodaTimeDateTimeUtils_get_cZoneNames(void);
...
__attribute__((unused)) static id<JavaUtilMap> OrgJodaTimeDateTimeUtils_buildDefaultTimeZoneNames(void);
