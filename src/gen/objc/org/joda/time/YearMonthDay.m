...
//  source: /Users/marcussmith/temp/joda-time/src/main/java/org/joda/time/YearMonthDay.java
//
 ...
 */
inline jlong OrgJodaTimeYearMonthDay_get_serialVersionUID(void);
 ...
 */
inline IOSObjectArray *OrgJodaTimeYearMonthDay_get_FIELD_TYPES(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeYearMonthDay__Annotations$0(void);
...
/*!
 @brief Serialization version
 */
inline jlong OrgJodaTimeYearMonthDay_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeYearMonthDay_Property__Annotations$0(void);
...
- (IOSObjectArray *)getFieldTypes {
  return [((IOSObjectArray *) nil_chk(OrgJodaTimeYearMonthDay_FIELD_TYPES)) java_clone];
}
...
OrgJodaTimeYearMonthDay *OrgJodaTimeYearMonthDay_fromCalendarFieldsWithJavaUtilCalendar_(JavaUtilCalendar *calendar) {
  ...
  return create_OrgJodaTimeYearMonthDay_initWithInt_withInt_withInt_([calendar getWithInt:JavaUtilCalendar_YEAR], [calendar getWithInt:JavaUtilCalendar_MONTH] + 1, [calendar getWithInt:JavaUtilCalendar_DAY_OF_MONTH]);
}
...
OrgJodaTimeYearMonthDay *OrgJodaTimeYearMonthDay_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeYearMonthDay_initWithInt_withInt_withInt_([date getYear] + 1900, [date getMonth] + 1, [date getDate]);
}
