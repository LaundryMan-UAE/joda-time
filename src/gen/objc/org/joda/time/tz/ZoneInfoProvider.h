...
FOUNDATION_EXPORT OrgJodaTimeTzZoneInfoProvider *new_OrgJodaTimeTzZoneInfoProvider_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeTzZoneInfoProvider *create_OrgJodaTimeTzZoneInfoProvider_init(void);
