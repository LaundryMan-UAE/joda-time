...
//  source: /Users/marcussmith/HambroPerks/hambroperks_org/joda-time/src/main/java/org/joda/time/tz/FixedDateTimeZone.java
//
...
inline jlong OrgJodaTimeTzFixedDateTimeZone_get_serialVersionUID(void);
...
- (JavaUtilTimeZone *)toTimeZone {
  ...
  if ([((NSString *) nil_chk(id_)) java_length] == 6 && ([id_ java_hasPrefix:@"+"] || [id_ java_hasPrefix:@"-"])) {
