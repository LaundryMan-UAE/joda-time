...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/tz/CachedDateTimeZone.java
//
...
inline jlong OrgJodaTimeTzCachedDateTimeZone_get_serialVersionUID(void);
...
inline jint OrgJodaTimeTzCachedDateTimeZone_get_cInfoCacheMask(void);
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeTzCachedDateTimeZone class]]) {
    return [((OrgJodaTimeDateTimeZone *) nil_chk(iZone_)) isEqual:((OrgJodaTimeTzCachedDateTimeZone *) nil_chk(((OrgJodaTimeTzCachedDateTimeZone *) obj)))->iZone_];
  }
  return false;
}
...
OrgJodaTimeTzCachedDateTimeZone *OrgJodaTimeTzCachedDateTimeZone_forZoneWithOrgJodaTimeDateTimeZone_(OrgJodaTimeDateTimeZone *zone) {
  ...
  if ([zone isKindOfClass:[OrgJodaTimeTzCachedDateTimeZone class]]) {
    return (OrgJodaTimeTzCachedDateTimeZone *) zone;
  }
