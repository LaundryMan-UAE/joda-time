...
- (OrgJodaTimeTzDateTimeZoneBuilder_Transition *)withMillisWithLong:(jlong)millis;
...
inline jint OrgJodaTimeTzDateTimeZoneBuilder_RuleSet_get_YEAR_LIMIT(void);
...
__attribute__((unused)) static OrgJodaTimeTzDateTimeZoneBuilder_RuleSet *new_OrgJodaTimeTzDateTimeZoneBuilder_RuleSet_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeTzDateTimeZoneBuilder_RuleSet *create_OrgJodaTimeTzDateTimeZoneBuilder_RuleSet_init(void);
...
inline jlong OrgJodaTimeTzDateTimeZoneBuilder_DSTZone_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeTzDateTimeZoneBuilder_PrecalculatedZone_get_serialVersionUID(void);
...
- (void)writeToWithNSString:(NSString *)zoneID
  ...
  if ([zone isKindOfClass:[OrgJodaTimeTzFixedDateTimeZone class]]) {
    ...
    if ([zone isKindOfClass:[OrgJodaTimeTzCachedDateTimeZone class]]) {
      ...
      zone = [((OrgJodaTimeTzCachedDateTimeZone *) nil_chk(((OrgJodaTimeTzCachedDateTimeZone *) zone))) getUncachedZone];
    }
    else {
...
void OrgJodaTimeTzDateTimeZoneBuilder_writeMillisWithJavaIoDataOutput_withLong_(id<JavaIoDataOutput> outArg, jlong millis) {
  OrgJodaTimeTzDateTimeZoneBuilder_initialize();
  if (JreLongMod(millis, (30 * 60000LL)) == 0) {
    jlong units = JreLongDiv(millis, (30 * 60000LL));
    if ((JreRShift64((JreLShift64(units, (64 - 6))), (64 - 6))) == units) {
      [((id<JavaIoDataOutput>) nil_chk(outArg)) writeByteWithInt:(jint) (units & (jint) 0x3f)];
      return;
    }
  }
  if (JreLongMod(millis, 60000LL) == 0) {
    jlong minutes = JreLongDiv(millis, 60000LL);
  ...
  if (JreLongMod(millis, 1000LL) == 0) {
    jlong seconds = JreLongDiv(millis, 1000LL);
...
jboolean OrgJodaTimeTzDateTimeZoneBuilder_addTransitionWithJavaUtilArrayList_withOrgJodaTimeTzDateTimeZoneBuilder_Transition_(OrgJodaTimeTzDateTimeZoneBuilder *self, JavaUtilArrayList *transitions, OrgJodaTimeTzDateTimeZoneBuilder_Transition *tr) {
  ...
  OrgJodaTimeTzDateTimeZoneBuilder_Transition *previous = [transitions removeWithInt:size - 1];
  OrgJodaTimeTzDateTimeZoneBuilder_Transition *adjusted = [tr withMillisWithLong:[((OrgJodaTimeTzDateTimeZoneBuilder_Transition *) nil_chk(previous)) getMillis]];
  return OrgJodaTimeTzDateTimeZoneBuilder_addTransitionWithJavaUtilArrayList_withOrgJodaTimeTzDateTimeZoneBuilder_Transition_(self, transitions, adjusted);
}
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeTzDateTimeZoneBuilder_OfYear class]]) {
    OrgJodaTimeTzDateTimeZoneBuilder_OfYear *other = (OrgJodaTimeTzDateTimeZoneBuilder_OfYear *) obj;
...
- (NSString *)description {
  return JreStrcat("$C$I$I$I$Z$IC", @"[OfYear]\nMode: ", iMode_, @"\nMonthOfYear: ", iMonthOfYear_, @"\nDayOfMonth: ", iDayOfMonth_, @"\nDayOfWeek: ", iDayOfWeek_, @"\nAdvanceDayOfWeek: ", iAdvance_, @"\nMillisOfDay: ", iMillisOfDay_, 0x000a);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "J", 0x2, 14, 15, -1, -1, -1, -1 },
    { NULL, "J", 0x2, 16, 15, -1, -1, -1, -1 },
    { NULL, "J", 0x2, 17, 15, -1, -1, -1, -1 },
    { NULL, "J", 0x2, 18, 15, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  ...
  methods[7].selector = @selector(writeToWithJavaIoDataOutput:);
  methods[8].selector = @selector(setDayOfMonthNextWithOrgJodaTimeChronology:withLong:);
  methods[9].selector = @selector(setDayOfMonthPreviousWithOrgJodaTimeChronology:withLong:);
  methods[10].selector = @selector(setDayOfMonthWithOrgJodaTimeChronology:withLong:);
  methods[11].selector = @selector(setDayOfWeekWithOrgJodaTimeChronology:withLong:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
  ...
  static const void *ptrTable[] = { "readFrom", "LJavaIoDataInput;", "LJavaIoIOException;", "CIIIZI", "setInstant", "III", "next", "JII", "previous", "equals", "LNSObject;", "toString", "writeTo", "LJavaIoDataOutput;", "setDayOfMonthNext", "LOrgJodaTimeChronology;J", "setDayOfMonthPrevious", "setDayOfMonth", "setDayOfWeek", "LOrgJodaTimeTzDateTimeZoneBuilder;" };
  static const J2ObjcClassInfo _OrgJodaTimeTzDateTimeZoneBuilder_OfYear = { "OfYear", "org.joda.time.tz", ptrTable, methods, fields, 7, 0x1a, 12, 6, 19, -1, -1, -1, -1 };
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeTzDateTimeZoneBuilder_Recurrence class]]) {
    OrgJodaTimeTzDateTimeZoneBuilder_Recurrence *other = (OrgJodaTimeTzDateTimeZoneBuilder_Recurrence *) obj;
...
- (OrgJodaTimeTzDateTimeZoneBuilder_Recurrence *)renameAppendWithNSString:(NSString *)appendNameKey {
  return [self renameWithNSString:[(JreStrcat("$$", iNameKey_, appendNameKey)) java_intern]];
}

- (NSString *)description {
  return JreStrcat("@$$$I", iOfYear_, @" named ", iNameKey_, @" at ", iSaveMillis_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "readFrom", "LJavaIoDataInput;", "LJavaIoIOException;", "LOrgJodaTimeTzDateTimeZoneBuilder_OfYear;LNSString;I", "next", "JII", "previous", "equals", "LNSObject;", "writeTo", "LJavaIoDataOutput;", "rename", "LNSString;", "renameAppend", "toString", "LOrgJodaTimeTzDateTimeZoneBuilder;" };
  static const J2ObjcClassInfo _OrgJodaTimeTzDateTimeZoneBuilder_Recurrence = { "Recurrence", "org.joda.time.tz", ptrTable, methods, fields, 7, 0x1a, 12, 3, 15, -1, -1, -1, -1 };
...
- (NSString *)description {
  return JreStrcat("I$I$@", iFromYear_, @" to ", iToYear_, @" using ", iRecurrence_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgJodaTimeTzDateTimeZoneBuilder_Recurrence;II", "next", "JII", "toString", "LOrgJodaTimeTzDateTimeZoneBuilder;" };
  static const J2ObjcClassInfo _OrgJodaTimeTzDateTimeZoneBuilder_Rule = { "Rule", "org.joda.time.tz", ptrTable, methods, fields, 7, 0x1a, 8, 3, 4, -1, -1, -1, -1 };
...
- (OrgJodaTimeTzDateTimeZoneBuilder_Transition *)withMillisWithLong:(jlong)millis {
  return create_OrgJodaTimeTzDateTimeZoneBuilder_Transition_initWithLong_withNSString_withInt_withInt_(millis, iNameKey_, iWallOffset_, iStandardOffset_);
}
...
- (jboolean)isTransitionFromWithOrgJodaTimeTzDateTimeZoneBuilder_Transition:(OrgJodaTimeTzDateTimeZoneBuilder_Transition *)other {
  ...
  return iMillis_ > other->iMillis_ && (iWallOffset_ != other->iWallOffset_ || iStandardOffset_ != other->iStandardOffset_ || !([((NSString *) nil_chk(iNameKey_)) isEqual:other->iNameKey_]));
}

- (NSString *)description {
  return JreStrcat("@CICI", create_OrgJodaTimeDateTime_initWithLong_withOrgJodaTimeDateTimeZone_(iMillis_, JreLoadStatic(OrgJodaTimeDateTimeZone, UTC)), ' ', iStandardOffset_, ' ', iWallOffset_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "I", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LOrgJodaTimeTzDateTimeZoneBuilder_Transition;", 0x1, 3, 4, -1, -1, -1, -1 },
  ...
  methods[8].selector = @selector(withMillisWithLong:);
  methods[9].selector = @selector(isTransitionFromWithOrgJodaTimeTzDateTimeZoneBuilder_Transition:);
  ...
  static const void *ptrTable[] = { "JLOrgJodaTimeTzDateTimeZoneBuilder_Transition;", "JLOrgJodaTimeTzDateTimeZoneBuilder_Rule;I", "JLNSString;II", "withMillis", "J", "isTransitionFrom", "LOrgJodaTimeTzDateTimeZoneBuilder_Transition;", "toString", "LOrgJodaTimeTzDateTimeZoneBuilder;" };
  static const J2ObjcClassInfo _OrgJodaTimeTzDateTimeZoneBuilder_Transition = { "Transition", "org.joda.time.tz", ptrTable, methods, fields, 7, 0x1a, 11, 4, 8, -1, -1, -1, -1 };
...
- (OrgJodaTimeTzDateTimeZoneBuilder_DSTZone *)buildTailZoneWithNSString:(NSString *)id_ {
  if ([((JavaUtilArrayList *) nil_chk(iRules_)) size] == 2) {
    ...
    if ([((OrgJodaTimeTzDateTimeZoneBuilder_Rule *) nil_chk(startRule)) getToYear] == JavaLangInteger_MAX_VALUE && [((OrgJodaTimeTzDateTimeZoneBuilder_Rule *) nil_chk(endRule)) getToYear] == JavaLangInteger_MAX_VALUE) {
      return create_OrgJodaTimeTzDateTimeZoneBuilder_DSTZone_initWithNSString_withInt_withOrgJodaTimeTzDateTimeZoneBuilder_Recurrence_withOrgJodaTimeTzDateTimeZoneBuilder_Recurrence_(id_, iStandardOffset_, startRule->iRecurrence_, ((OrgJodaTimeTzDateTimeZoneBuilder_Rule *) nil_chk(endRule))->iRecurrence_);
    }
  }
  return nil;
}
...
- (NSString *)description {
  return JreStrcat("$$I$I$IC@C@", iInitialNameKey_, @" initial: ", iInitialSaveMillis_, @" std: ", iStandardOffset_, @" upper: ", iUpperYear_, ' ', iUpperOfYear_, ' ', iRules_);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "YEAR_LIMIT", "I", .constantValue.asLong = 0, 0x1a, -1, 17, -1, -1 },
    { "iStandardOffset_", "I", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "iRules_", "LJavaUtilArrayList;", .constantValue.asLong = 0, 0x2, -1, -1, 18, -1 },
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeTzDateTimeZoneBuilder_DSTZone class]]) {
    OrgJodaTimeTzDateTimeZoneBuilder_DSTZone *other = (OrgJodaTimeTzDateTimeZoneBuilder_DSTZone *) obj;
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeTzDateTimeZoneBuilder_PrecalculatedZone class]]) {
    OrgJodaTimeTzDateTimeZoneBuilder_PrecalculatedZone *other = (OrgJodaTimeTzDateTimeZoneBuilder_PrecalculatedZone *) obj;
  ...
  for (jint i = 0; i < nameKeys->size_ - 1; i++) {
    ...
    if (curOffset != nextOffset && curStdOffset == nextStdOffset && [((NSString *) nil_chk(curNameKey)) isEqual:nextNameKey] && [p getYears] == 0 && [p getMonths] > 4 && [p getMonths] < 8 && [curNameKey isEqual:IOSObjectArray_Get(zoneNameData, 2)] && [curNameKey isEqual:IOSObjectArray_Get(zoneNameData, 4)]) {
      if (OrgJodaTimeTzZoneInfoLogger_verbose()) {
        ...
        [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, out))) printlnWithNSString:JreStrcat("$@$@", @"     - ", create_OrgJodaTimeDateTime_initWithLong_withOrgJodaTimeChronology_(IOSLongArray_Get(trans, i), chrono), @" - ", create_OrgJodaTimeDateTime_initWithLong_withOrgJodaTimeChronology_(IOSLongArray_Get(trans, i + 1), chrono))];
      }
      if (curOffset > nextOffset) {
        IOSObjectArray_Set(nameKeys, i, [(JreStrcat("$$", curNameKey, @"-Summer")) java_intern]);
      }
      else if (curOffset < nextOffset) {
        IOSObjectArray_Set(nameKeys, i + 1, [(JreStrcat("$$", nextNameKey, @"-Summer")) java_intern]);
        i++;
      }
    }
  }
