...
/*!
 @brief Returns null if RuleSet is exhausted or upper limit reached.Calling
  this method will throw away rules as they each become
  exhausted.
 Copy the RuleSet before using it to compute transitions.
...
- (void)writeToWithNSString:(NSString *)zoneID
  ...
  if ([JavaIoDataOutput_class_() isInstance:outArg]) {
    ...
    [self writeToWithNSString:zoneID withJavaIoDataOutput:create_JavaIoDataOutputStream_initWithJavaIoOutputStream_(outArg)];
  }
}
