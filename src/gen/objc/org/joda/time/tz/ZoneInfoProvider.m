...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/tz/ZoneInfoProvider.java
//
...
- (OrgJodaTimeDateTimeZone *)getZoneWithNSString:(NSString *)id_ {
  ...
  if ([obj isKindOfClass:[JavaLangRefSoftReference class]]) {
    JavaLangRefSoftReference *ref = (JavaLangRefSoftReference *) obj;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgJodaTimeTzZoneInfoProvider_1 = { "", "org.joda.time.tz", ptrTable, methods, fields, 7, 0x8010, 2, 2, 1, -1, 2, 3, -1 };
