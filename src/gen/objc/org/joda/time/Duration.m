...
- (jlong)getStandardDays {
  return JreLongDiv([self getMillis], OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY);
}

- (jlong)getStandardHours {
  return JreLongDiv([self getMillis], OrgJodaTimeDateTimeConstants_MILLIS_PER_HOUR);
}

- (jlong)getStandardMinutes {
  return JreLongDiv([self getMillis], OrgJodaTimeDateTimeConstants_MILLIS_PER_MINUTE);
}

- (jlong)getStandardSeconds {
  return JreLongDiv([self getMillis], OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[30].selector = @selector(abs);
  ...
  static const J2ObjcClassInfo _OrgJodaTimeDuration = { "Duration", "org.joda.time", ptrTable, methods, fields, 7, 0x11, 31, 2, -1, -1, -1, -1, -1 };
