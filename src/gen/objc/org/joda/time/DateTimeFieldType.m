...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/DateTimeFieldType.java
//
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeDateTimeFieldType_StandardDateTimeFieldType class]]) {
    return iOrdinal_ == ((OrgJodaTimeDateTimeFieldType_StandardDateTimeFieldType *) nil_chk(((OrgJodaTimeDateTimeFieldType_StandardDateTimeFieldType *) obj)))->iOrdinal_;
  }
  return false;
}
