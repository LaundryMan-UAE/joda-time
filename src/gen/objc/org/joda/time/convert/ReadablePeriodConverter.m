...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/convert/ReadablePeriodConverter.java
//
...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertReadablePeriodConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertReadablePeriodConverter_INSTANCE, new_OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate());
...
void OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate(OrgJodaTimeConvertReadablePeriodConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertReadablePeriodConverter *new_OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertReadablePeriodConverter, initPackagePrivate)
}

OrgJodaTimeConvertReadablePeriodConverter *create_OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertReadablePeriodConverter, initPackagePrivate)
}
