...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertReadablePartialConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertReadablePartialConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertReadablePartialConverter_INSTANCE, new_OrgJodaTimeConvertReadablePartialConverter_initPackagePrivate());
...
void OrgJodaTimeConvertReadablePartialConverter_initPackagePrivate(OrgJodaTimeConvertReadablePartialConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertReadablePartialConverter *new_OrgJodaTimeConvertReadablePartialConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertReadablePartialConverter, initPackagePrivate)
}

OrgJodaTimeConvertReadablePartialConverter *create_OrgJodaTimeConvertReadablePartialConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertReadablePartialConverter, initPackagePrivate)
}
