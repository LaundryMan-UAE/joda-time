...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertReadableDurationConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertReadableDurationConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertReadableDurationConverter_INSTANCE, new_OrgJodaTimeConvertReadableDurationConverter_initPackagePrivate());
...
void OrgJodaTimeConvertReadableDurationConverter_initPackagePrivate(OrgJodaTimeConvertReadableDurationConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertReadableDurationConverter *new_OrgJodaTimeConvertReadableDurationConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertReadableDurationConverter, initPackagePrivate)
}

OrgJodaTimeConvertReadableDurationConverter *create_OrgJodaTimeConvertReadableDurationConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertReadableDurationConverter, initPackagePrivate)
}
