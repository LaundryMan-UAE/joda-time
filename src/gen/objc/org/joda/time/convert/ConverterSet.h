...
FOUNDATION_EXPORT void OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(OrgJodaTimeConvertConverterSet *self, IOSObjectArray *converters);

FOUNDATION_EXPORT OrgJodaTimeConvertConverterSet *new_OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(IOSObjectArray *converters) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeConvertConverterSet *create_OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(IOSObjectArray *converters);
