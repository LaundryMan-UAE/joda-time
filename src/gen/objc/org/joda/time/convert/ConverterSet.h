...
/*!
 @brief Returns a copy of this set, with the given converter added.If a
  matching converter is already in the set, the given converter replaces
  it.
 If the converter is exactly the same as one already in the set, the
 ...
 @throw NullPointerExceptionif converter is null
 */
...
/*!
 @brief Returns a copy of this set, with the given converter removed.If the
