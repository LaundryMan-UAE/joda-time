...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/convert/ConverterManager.java
//
...
inline OrgJodaTimeConvertConverterManager *OrgJodaTimeConvertConverterManager_get_INSTANCE(void);
...
- (id<OrgJodaTimeConvertInstantConverter>)getInstantConverterWithId:(id)object {
  id<OrgJodaTimeConvertInstantConverter> converter = (id<OrgJodaTimeConvertInstantConverter>) cast_check([((OrgJodaTimeConvertConverterSet *) nil_chk(iInstantConverters_)) selectWithIOSClass:object == nil ? nil : [object java_getClass]], OrgJodaTimeConvertInstantConverter_class_());
  if (converter != nil) {
    return converter;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"No instant converter found for type: ", (object == nil ? @"null" : [[object java_getClass] getName])));
}
...
- (id<OrgJodaTimeConvertPartialConverter>)getPartialConverterWithId:(id)object {
  id<OrgJodaTimeConvertPartialConverter> converter = (id<OrgJodaTimeConvertPartialConverter>) cast_check([((OrgJodaTimeConvertConverterSet *) nil_chk(iPartialConverters_)) selectWithIOSClass:object == nil ? nil : [object java_getClass]], OrgJodaTimeConvertPartialConverter_class_());
  if (converter != nil) {
    return converter;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"No partial converter found for type: ", (object == nil ? @"null" : [[object java_getClass] getName])));
}
...
- (id<OrgJodaTimeConvertDurationConverter>)getDurationConverterWithId:(id)object {
  id<OrgJodaTimeConvertDurationConverter> converter = (id<OrgJodaTimeConvertDurationConverter>) cast_check([((OrgJodaTimeConvertConverterSet *) nil_chk(iDurationConverters_)) selectWithIOSClass:object == nil ? nil : [object java_getClass]], OrgJodaTimeConvertDurationConverter_class_());
  if (converter != nil) {
    return converter;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"No duration converter found for type: ", (object == nil ? @"null" : [[object java_getClass] getName])));
}
...
- (id<OrgJodaTimeConvertPeriodConverter>)getPeriodConverterWithId:(id)object {
  id<OrgJodaTimeConvertPeriodConverter> converter = (id<OrgJodaTimeConvertPeriodConverter>) cast_check([((OrgJodaTimeConvertConverterSet *) nil_chk(iPeriodConverters_)) selectWithIOSClass:object == nil ? nil : [object java_getClass]], OrgJodaTimeConvertPeriodConverter_class_());
  if (converter != nil) {
    return converter;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"No period converter found for type: ", (object == nil ? @"null" : [[object java_getClass] getName])));
}
...
- (id<OrgJodaTimeConvertIntervalConverter>)getIntervalConverterWithId:(id)object {
  id<OrgJodaTimeConvertIntervalConverter> converter = (id<OrgJodaTimeConvertIntervalConverter>) cast_check([((OrgJodaTimeConvertConverterSet *) nil_chk(iIntervalConverters_)) selectWithIOSClass:object == nil ? nil : [object java_getClass]], OrgJodaTimeConvertIntervalConverter_class_());
  if (converter != nil) {
    return converter;
  }
  @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"No interval converter found for type: ", (object == nil ? @"null" : [[object java_getClass] getName])));
}
