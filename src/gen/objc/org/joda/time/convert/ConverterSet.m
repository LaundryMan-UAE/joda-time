...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/convert/ConverterSet.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeConvertConverterArray:(IOSObjectArray *)converters {
  OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(self, converters);
  return self;
}
...
- (OrgJodaTimeConvertConverterSet *)addWithOrgJodaTimeConvertConverter:(id<OrgJodaTimeConvertConverter>)converter
  ...
  for (jint i = 0; i < length; i++) {
    ...
    if ([converter getSupportedType] == [((id<OrgJodaTimeConvertConverter>) nil_chk(existing)) getSupportedType]) {
      ...
      return create_OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(copy_);
    }
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeConvertConverterArray:);
...
void OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(OrgJodaTimeConvertConverterSet *self, IOSObjectArray *converters) {
  NSObject_init(self);
...
OrgJodaTimeConvertConverterSet *new_OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(IOSObjectArray *converters) {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertConverterSet, initPackagePrivateWithOrgJodaTimeConvertConverterArray_, converters)
}

OrgJodaTimeConvertConverterSet *create_OrgJodaTimeConvertConverterSet_initPackagePrivateWithOrgJodaTimeConvertConverterArray_(IOSObjectArray *converters) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertConverterSet, initPackagePrivateWithOrgJodaTimeConvertConverterArray_, converters)
}
