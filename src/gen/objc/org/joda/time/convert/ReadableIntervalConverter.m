...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/convert/ReadableIntervalConverter.java
//
...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertReadableIntervalConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertReadableIntervalConverter_INSTANCE, new_OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate());
...
void OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate(OrgJodaTimeConvertReadableIntervalConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertReadableIntervalConverter *new_OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertReadableIntervalConverter, initPackagePrivate)
}

OrgJodaTimeConvertReadableIntervalConverter *create_OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertReadableIntervalConverter, initPackagePrivate)
}
