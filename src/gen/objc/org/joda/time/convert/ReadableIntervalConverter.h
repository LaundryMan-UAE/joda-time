...
FOUNDATION_EXPORT void OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate(OrgJodaTimeConvertReadableIntervalConverter *self);

FOUNDATION_EXPORT OrgJodaTimeConvertReadableIntervalConverter *new_OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeConvertReadableIntervalConverter *create_OrgJodaTimeConvertReadableIntervalConverter_initPackagePrivate(void);
