...
inline OrgJodaTimeConvertDateConverter *OrgJodaTimeConvertDateConverter_get_INSTANCE(void);
...
FOUNDATION_EXPORT void OrgJodaTimeConvertDateConverter_initPackagePrivate(OrgJodaTimeConvertDateConverter *self);

FOUNDATION_EXPORT OrgJodaTimeConvertDateConverter *new_OrgJodaTimeConvertDateConverter_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeConvertDateConverter *create_OrgJodaTimeConvertDateConverter_initPackagePrivate(void);
