...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertNullConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertNullConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertNullConverter_INSTANCE, new_OrgJodaTimeConvertNullConverter_initPackagePrivate());
...
void OrgJodaTimeConvertNullConverter_initPackagePrivate(OrgJodaTimeConvertNullConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertNullConverter *new_OrgJodaTimeConvertNullConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertNullConverter, initPackagePrivate)
}

OrgJodaTimeConvertNullConverter *create_OrgJodaTimeConvertNullConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertNullConverter, initPackagePrivate)
}
