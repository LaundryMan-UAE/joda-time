...
FOUNDATION_EXPORT void OrgJodaTimeConvertStringConverter_initPackagePrivate(OrgJodaTimeConvertStringConverter *self);

FOUNDATION_EXPORT OrgJodaTimeConvertStringConverter *new_OrgJodaTimeConvertStringConverter_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeConvertStringConverter *create_OrgJodaTimeConvertStringConverter_initPackagePrivate(void);
