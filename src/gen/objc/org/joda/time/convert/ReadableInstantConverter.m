...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertReadableInstantConverter_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertReadableInstantConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertReadableInstantConverter_INSTANCE, new_OrgJodaTimeConvertReadableInstantConverter_initPackagePrivate());
...
void OrgJodaTimeConvertReadableInstantConverter_initPackagePrivate(OrgJodaTimeConvertReadableInstantConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertReadableInstantConverter *new_OrgJodaTimeConvertReadableInstantConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertReadableInstantConverter, initPackagePrivate)
}

OrgJodaTimeConvertReadableInstantConverter *create_OrgJodaTimeConvertReadableInstantConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertReadableInstantConverter, initPackagePrivate)
}
