...
FOUNDATION_EXPORT void OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate(OrgJodaTimeConvertReadablePeriodConverter *self);

FOUNDATION_EXPORT OrgJodaTimeConvertReadablePeriodConverter *new_OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeConvertReadablePeriodConverter *create_OrgJodaTimeConvertReadablePeriodConverter_initPackagePrivate(void);
