...
- (instancetype)initPackagePrivate {
  OrgJodaTimeConvertCalendarConverter_initPackagePrivate(self);
  return self;
}
...
- (OrgJodaTimeChronology *)getChronologyWithId:(id)object
  ...
  if ([((NSString *) nil_chk([[nil_chk(object) java_getClass] getName])) java_hasSuffix:@".BuddhistCalendar"]) {
    ...
    JavaUtilGregorianCalendar *gc = (JavaUtilGregorianCalendar *) object;
...
+ (void)initialize {
  if (self == [OrgJodaTimeConvertCalendarConverter class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeConvertCalendarConverter_INSTANCE, new_OrgJodaTimeConvertCalendarConverter_initPackagePrivate());
...
void OrgJodaTimeConvertCalendarConverter_initPackagePrivate(OrgJodaTimeConvertCalendarConverter *self) {
  OrgJodaTimeConvertAbstractConverter_init(self);
}

OrgJodaTimeConvertCalendarConverter *new_OrgJodaTimeConvertCalendarConverter_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeConvertCalendarConverter, initPackagePrivate)
}

OrgJodaTimeConvertCalendarConverter *create_OrgJodaTimeConvertCalendarConverter_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeConvertCalendarConverter, initPackagePrivate)
}
