...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/DateTimeZone.java
//
...
- (NSString *)getShortNameWithLong:(jlong)instant
  ...
  if ([np isKindOfClass:[OrgJodaTimeTzDefaultNameProvider class]]) {
    name = [((OrgJodaTimeTzDefaultNameProvider *) nil_chk(((OrgJodaTimeTzDefaultNameProvider *) np))) getShortNameWithJavaUtilLocale:locale withNSString:iID_ withNSString:nameKey withBoolean:[self isStandardOffsetWithLong:instant]];
  }
  else {
...
- (NSString *)getNameWithLong:(jlong)instant
  ...
  id<OrgJodaTimeTzNameProvider> np = OrgJodaTimeDateTimeZone_getNameProvider();
  if ([np isKindOfClass:[OrgJodaTimeTzDefaultNameProvider class]]) {
    name = [((OrgJodaTimeTzDefaultNameProvider *) nil_chk(((OrgJodaTimeTzDefaultNameProvider *) np))) getNameWithJavaUtilLocale:locale withNSString:iID_ withNSString:nameKey withBoolean:[self isStandardOffsetWithLong:instant]];
  }
  else {
...
id<OrgJodaTimeTzProvider> OrgJodaTimeDateTimeZone_getDefaultProvider() {
  ...
  @try {
    ...
    if (providerClass != nil) {
      @try {
        IOSClass *cls = IOSClass_forName_initialize_classLoader_(providerClass, false, [OrgJodaTimeDateTimeZone_class_() getClassLoader]);
        if (![OrgJodaTimeTzProvider_class_() isAssignableFrom:cls]) {
          @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"System property referred to class that does not implement ", OrgJodaTimeTzProvider_class_()));
        }
        id<OrgJodaTimeTzProvider> provider = [((JavaLangReflectConstructor *) nil_chk([((IOSClass *) nil_chk([((IOSClass *) nil_chk(cls)) asSubclass:OrgJodaTimeTzProvider_class_()])) getConstructor:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]])) newInstanceWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
        return OrgJodaTimeDateTimeZone_validateProviderWithOrgJodaTimeTzProvider_(provider);
      }
  ...
  @try {
    id<OrgJodaTimeTzProvider> provider = create_OrgJodaTimeTzZoneInfoProvider_initWithNSString_(OrgJodaTimeDateTimeZone_DEFAULT_TZ_DATA_PATH);
    return OrgJodaTimeDateTimeZone_validateProviderWithOrgJodaTimeTzProvider_(provider);
  }
  @catch (JavaLangException *ex) {
    [ex printStackTrace];
...
id<OrgJodaTimeTzNameProvider> OrgJodaTimeDateTimeZone_getDefaultNameProvider() {
  ...
  @try {
    ...
    if (providerClass != nil) {
      @try {
        IOSClass *cls = IOSClass_forName_initialize_classLoader_(providerClass, false, [OrgJodaTimeDateTimeZone_class_() getClassLoader]);
        if (![OrgJodaTimeTzNameProvider_class_() isAssignableFrom:cls]) {
          @throw create_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"System property referred to class that does not implement ", OrgJodaTimeTzNameProvider_class_()));
        }
        nameProvider = [((JavaLangReflectConstructor *) nil_chk([((IOSClass *) nil_chk([((IOSClass *) nil_chk(cls)) asSubclass:OrgJodaTimeTzNameProvider_class_()])) getConstructor:[IOSObjectArray arrayWithLength:0 type:IOSClass_class_()]])) newInstanceWithNSObjectArray:[IOSObjectArray arrayWithLength:0 type:NSObject_class_()]];
      }
      @catch (JavaLangException *ex) {
        @throw create_JavaLangRuntimeException_initWithJavaLangThrowable_(ex);
      }
...
NSString *OrgJodaTimeDateTimeZone_printOffsetWithInt_(jint offset) {
  ...
  jint hours = JreIntDiv(offset, OrgJodaTimeDateTimeConstants_MILLIS_PER_HOUR);
  ...
  jint minutes = JreIntDiv(offset, OrgJodaTimeDateTimeConstants_MILLIS_PER_MINUTE);
  [buf appendWithChar:':'];
  ...
  jint seconds = JreIntDiv(offset, OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND);
  [buf appendWithChar:':'];
