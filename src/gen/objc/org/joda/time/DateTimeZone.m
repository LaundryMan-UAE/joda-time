...
//  source: /Users/Salton/Documents/Projects/joda-time/src/main/java/org/joda/time/DateTimeZone.java
//
...
/*!
 @brief Parses an offset from the string.
...
OrgJodaTimeDateTimeZone *OrgJodaTimeDateTimeZone_forTimeZoneWithJavaUtilTimeZone_(JavaUtilTimeZone *zone) {
  ...
  if (convId == nil) {
    ...
    if ([convId hasPrefix:@"GMT+"] || [convId hasPrefix:@"GMT-"]) {
      ...
      if (((jint) [((NSString *) nil_chk(convId)) length]) > 2) {
