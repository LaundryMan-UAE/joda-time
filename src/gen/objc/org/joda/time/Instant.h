...
//  source: /Users/Salton/Documents/Projects/joda-time/src/main/java/org/joda/time/Instant.java
//
...
/*!
 @brief Obtains an <code>Instant</code> set to the milliseconds from 1970-01-01T00:00:00Z.
...
/*!
 @brief Obtains an <code>Instant</code> set to the seconds from 1970-01-01T00:00:00Z.
...
/*!
 @brief Parses an <code>Instant</code> from the specified string.
 <p>
...
/*!
 @brief Parses an <code>Instant</code> from the specified string using a formatter.
 @param str  the string to parse, not null
...
/*!
 ...
 To manage the sub-second part of the instant, use <code>toDateTime()</code>
 and <code>DateTime.withMillisOfSecond(int)</code>.
...
J2OBJC_STATIC_INIT(OrgJodaTimeInstant)

/*!
 @brief The Java epoch of 1970-01-01T00:00:00Z.
 @since 2.10
 */
inline OrgJodaTimeInstant *OrgJodaTimeInstant_get_EPOCH();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT OrgJodaTimeInstant *OrgJodaTimeInstant_EPOCH;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgJodaTimeInstant, EPOCH, OrgJodaTimeInstant *)

FOUNDATION_EXPORT OrgJodaTimeInstant *OrgJodaTimeInstant_now();

FOUNDATION_EXPORT OrgJodaTimeInstant *OrgJodaTimeInstant_ofEpochMilliWithLong_(jlong epochMilli);

FOUNDATION_EXPORT OrgJodaTimeInstant *OrgJodaTimeInstant_ofEpochSecondWithLong_(jlong epochSecond);
