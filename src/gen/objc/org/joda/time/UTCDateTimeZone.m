...
- (instancetype)initPackagePrivate {
  OrgJodaTimeUTCDateTimeZone_initPackagePrivate(self);
  return self;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeUTCDateTimeZone class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeUTCDateTimeZone_INSTANCE, new_OrgJodaTimeUTCDateTimeZone_initPackagePrivate());
...
void OrgJodaTimeUTCDateTimeZone_initPackagePrivate(OrgJodaTimeUTCDateTimeZone *self) {
  OrgJodaTimeDateTimeZone_initWithNSString_(self, @"UTC");
}

OrgJodaTimeUTCDateTimeZone *new_OrgJodaTimeUTCDateTimeZone_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeUTCDateTimeZone, initPackagePrivate)
}

OrgJodaTimeUTCDateTimeZone *create_OrgJodaTimeUTCDateTimeZone_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeUTCDateTimeZone, initPackagePrivate)
}
