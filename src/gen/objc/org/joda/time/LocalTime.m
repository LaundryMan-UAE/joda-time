...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/LocalTime.java
//
...
- (jboolean)isEqual:(id)partial {
  ...
  if ([partial isKindOfClass:[OrgJodaTimeLocalTime class]]) {
    OrgJodaTimeLocalTime *other = (OrgJodaTimeLocalTime *) partial;
...
OrgJodaTimeLocalTime *OrgJodaTimeLocalTime_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeLocalTime_initWithInt_withInt_withInt_withInt_([date getHours], [date getMinutes], [date getSeconds], JreIntMod((((jint) (JreLongMod([date getTime], 1000))) + 1000), 1000));
}
