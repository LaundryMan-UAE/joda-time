 ...
 */
inline jlong OrgJodaTimeLocalTime_get_serialVersionUID(void);
...
/*!
 @brief The index of the hourOfDay field in the field array
 */
inline jint OrgJodaTimeLocalTime_get_HOUR_OF_DAY(void);
#define OrgJodaTimeLocalTime_HOUR_OF_DAY 0
J2OBJC_STATIC_FIELD_CONSTANT(OrgJodaTimeLocalTime, HOUR_OF_DAY, jint)

/*!
 @brief The index of the minuteOfHour field in the field array
 */
inline jint OrgJodaTimeLocalTime_get_MINUTE_OF_HOUR(void);
#define OrgJodaTimeLocalTime_MINUTE_OF_HOUR 1
J2OBJC_STATIC_FIELD_CONSTANT(OrgJodaTimeLocalTime, MINUTE_OF_HOUR, jint)

/*!
 @brief The index of the secondOfMinute field in the field array
 */
inline jint OrgJodaTimeLocalTime_get_SECOND_OF_MINUTE(void);
#define OrgJodaTimeLocalTime_SECOND_OF_MINUTE 2
J2OBJC_STATIC_FIELD_CONSTANT(OrgJodaTimeLocalTime, SECOND_OF_MINUTE, jint)

/*!
 @brief The index of the millisOfSecond field in the field array
 */
inline jint OrgJodaTimeLocalTime_get_MILLIS_OF_SECOND(void);
 ...
 */
inline id<JavaUtilSet> OrgJodaTimeLocalTime_get_TIME_DURATION_TYPES(void);
...
__attribute__((unused)) static id OrgJodaTimeLocalTime_readResolve(OrgJodaTimeLocalTime *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalTime__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalTime__Annotations$1(void);
 ...
 */
inline jlong OrgJodaTimeLocalTime_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeLocalTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalTime_Property *self, JavaIoObjectOutputStream *oos);

__attribute__((unused)) static void OrgJodaTimeLocalTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalTime_Property *self, JavaIoObjectInputStream *oos);
...
- (id)readResolve {
  return OrgJodaTimeLocalTime_readResolve(self);
}
...
- (OrgJodaTimeLocalTime_Property *)propertyWithOrgJodaTimeDateTimeFieldType:(OrgJodaTimeDateTimeFieldType *)fieldType {
  ...
  return create_OrgJodaTimeLocalTime_Property_initWithOrgJodaTimeLocalTime_withOrgJodaTimeDateTimeField_(self, [fieldType getFieldWithOrgJodaTimeChronology:[self getChronology]]);
}
...
OrgJodaTimeLocalTime *OrgJodaTimeLocalTime_fromCalendarFieldsWithJavaUtilCalendar_(JavaUtilCalendar *calendar) {
  ...
  return create_OrgJodaTimeLocalTime_initWithInt_withInt_withInt_withInt_([calendar getWithInt:JavaUtilCalendar_HOUR_OF_DAY], [calendar getWithInt:JavaUtilCalendar_MINUTE], [calendar getWithInt:JavaUtilCalendar_SECOND], [calendar getWithInt:JavaUtilCalendar_MILLISECOND]);
}
...
OrgJodaTimeLocalTime *OrgJodaTimeLocalTime_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeLocalTime_initWithInt_withInt_withInt_withInt_([date getHours], [date getMinutes], [date getSeconds], (((jint) ([date getTime] % 1000)) + 1000) % 1000);
}
...
id OrgJodaTimeLocalTime_readResolve(OrgJodaTimeLocalTime *self) {
  if (self->iChronology_ == nil) {
    return create_OrgJodaTimeLocalTime_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, OrgJodaTimeChronoISOChronology_getInstanceUTC());
  }
  if ([((OrgJodaTimeDateTimeZone *) nil_chk(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC))) isEqual:[self->iChronology_ getZone]] == false) {
    return create_OrgJodaTimeLocalTime_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, [self->iChronology_ withUTC]);
  }
  return self;
}
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)oos {
  OrgJodaTimeLocalTime_Property_writeObjectWithJavaIoObjectOutputStream_(self, oos);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  OrgJodaTimeLocalTime_Property_readObjectWithJavaIoObjectInputStream_(self, oos);
}
...
void OrgJodaTimeLocalTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalTime_Property *self, JavaIoObjectOutputStream *oos) {
...
void OrgJodaTimeLocalTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalTime_Property *self, JavaIoObjectInputStream *oos) {
  JreStrongAssign(&self->iInstant_, (OrgJodaTimeLocalTime *) cast_chk([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeLocalTime class]));
  ...
  JreStrongAssign(&self->iField_, [((OrgJodaTimeDateTimeFieldType *) nil_chk(type)) getFieldWithOrgJodaTimeChronology:[((OrgJodaTimeLocalTime *) nil_chk(self->iInstant_)) getChronology]]);
}
