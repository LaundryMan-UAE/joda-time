...
/*!
 @brief Restores the state of this bucket from a previously saved state.The
...
/*!
 @brief Saves the state of this bucket, returning it in an opaque object.Call
  restoreState to undo any changes that were made since the state was
  saved.
 Calls to saveState may be nested.
