...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  for (NSString * __strong id_ in nil_chk(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_ALL_IDS)) {
    if (OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithWithJavaLangCharSequence_withInt_withNSString_(text, position, id_)) {
      if (best == nil || [((NSString *) nil_chk(id_)) java_length] > [best java_length]) {
        best = id_;
      }
    }
  }
  if (best != nil) {
    ...
    return position + [best java_length];
  }
  return ~position;
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId class]) {
    ...
    JreStrongAssign(&OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_ALL_IDS, OrgJodaTimeDateTimeZone_getAvailableIDs());
    {
      jint max = 0;
      for (NSString * __strong id_ in nil_chk(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_ALL_IDS)) {
        max = JavaLangMath_maxWithInt_withInt_(max, [((NSString *) nil_chk(id_)) java_length]);
      }
