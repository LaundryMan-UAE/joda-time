...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/format/DateTimeFormatterBuilder.java
//
...
__attribute__((unused)) static jint OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter_parseIntoWithOrgJodaTimeFormatDateTimeParserBucket_withJavaLangCharSequence_withInt_(OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter *self, OrgJodaTimeFormatDateTimeParserBucket *bucket, id<JavaLangCharSequence> text, jint position);
...
inline id<JavaUtilMap> OrgJodaTimeFormatDateTimeFormatterBuilder_TextField_get_cParseCache(void);
...
inline id<JavaUtilList> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_ALL_IDS(void);
...
inline id<JavaUtilMap> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_GROUPED_IDS(void);
static id<JavaUtilMap> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId, GROUPED_IDS, id<JavaUtilMap>)

inline id<JavaUtilList> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_BASE_GROUPED_IDS(void);
static id<JavaUtilList> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_BASE_GROUPED_IDS;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId, BASE_GROUPED_IDS, id<JavaUtilList>)
...
jboolean OrgJodaTimeFormatDateTimeFormatterBuilder_isPrinterWithId_(OrgJodaTimeFormatDateTimeFormatterBuilder *self, id f) {
  if ([OrgJodaTimeFormatInternalPrinter_class_() isInstance:f]) {
    if ([f isKindOfClass:[OrgJodaTimeFormatDateTimeFormatterBuilder_Composite class]]) {
      return [((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) f))) isPrinter];
    }
    return true;
  }
  return false;
...
jboolean OrgJodaTimeFormatDateTimeFormatterBuilder_isParserWithId_(OrgJodaTimeFormatDateTimeFormatterBuilder *self, id f) {
  if ([OrgJodaTimeFormatInternalParser_class_() isInstance:f]) {
    if ([f isKindOfClass:[OrgJodaTimeFormatDateTimeFormatterBuilder_Composite class]]) {
      return [((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) f))) isParser];
    }
    return true;
  }
  return false;
...
jboolean OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithWithJavaLangCharSequence_withInt_withNSString_(id<JavaLangCharSequence> text, jint position, NSString *search) {
  OrgJodaTimeFormatDateTimeFormatterBuilder_initialize();
  jint searchLen = [((NSString *) nil_chk(search)) java_length];
  if (([((id<JavaLangCharSequence>) nil_chk(text)) java_length] - position) < searchLen) {
    return false;
  }
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)text
                                                   withInt:(jint)position {
  if (position >= [((id<JavaLangCharSequence>) nil_chk(text)) java_length]) {
    return ~position;
  }
...
- (jint)estimatePrintedLength {
  return [((NSString *) nil_chk(iValue_)) java_length];
}
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  if (OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithIgnoreCaseWithJavaLangCharSequence_withInt_withNSString_(text, position, iValue_)) {
    return position + [((NSString *) nil_chk(iValue_)) java_length];
  }
  return ~position;
}
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)text
                                                   withInt:(jint)position {
  return OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter_parseIntoWithOrgJodaTimeFormatDateTimeParserBucket_withJavaLangCharSequence_withInt_(self, bucket, text, position);
}
...
jint OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter_parseIntoWithOrgJodaTimeFormatDateTimeParserBucket_withJavaLangCharSequence_withInt_(OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter *self, OrgJodaTimeFormatDateTimeParserBucket *bucket, id<JavaLangCharSequence> text, jint position) {
  jint limit = JavaLangMath_minWithInt_withInt_(self->iMaxParsedDigits_, [((id<JavaLangCharSequence>) nil_chk(text)) java_length] - position);
  jboolean negative = false;
  jboolean positive = false;
  jint length = 0;
  while (length < limit) {
    jchar c = [text charAtWithInt:position + length];
    if (length == 0 && (c == '-' || c == '+') && self->iSigned_) {
      negative = (c == '-');
      positive = (c == '+');
      ...
      length++;
      limit = JavaLangMath_minWithInt_withInt_(limit + 1, [text java_length] - position);
      continue;
    }
    if (c < '0' || c > '9') {
      break;
  ...
  [((OrgJodaTimeFormatDateTimeParserBucket *) nil_chk(bucket)) saveFieldWithOrgJodaTimeDateTimeFieldType:self->iFieldType_ withInt:value];
  return position;
}
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)text
                                                   withInt:(jint)position {
  jint newPos = OrgJodaTimeFormatDateTimeFormatterBuilder_NumberFormatter_parseIntoWithOrgJodaTimeFormatDateTimeParserBucket_withJavaLangCharSequence_withInt_(self, bucket, text, position);
  if (newPos < 0) {
    return newPos;
  }
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)text
                                                   withInt:(jint)position {
  jint limit = [((id<JavaLangCharSequence>) nil_chk(text)) java_length] - position;
  if (!iLenientParse_) {
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  if (innerMap == nil) {
    ...
    [((id<JavaUtilMap>) nil_chk(OrgJodaTimeFormatDateTimeFormatterBuilder_TextField_cParseCache)) putWithId:locale withId:innerMap];
  }
  ...
  if (array == nil) {
    ...
    for (jint i = min; i <= max; i++) {
      ...
      [validValues putWithId:[((NSString *) nil_chk([property getAsShortTextWithJavaUtilLocale:locale])) java_lowercaseStringWithJRELocale:locale] withId:JreLoadStatic(JavaLangBoolean, TRUE)];
      [validValues putWithId:[((NSString *) nil_chk([property getAsShortTextWithJavaUtilLocale:locale])) java_uppercaseStringWithJRELocale:locale] withId:JreLoadStatic(JavaLangBoolean, TRUE)];
      [validValues putWithId:[property getAsTextWithJavaUtilLocale:locale] withId:JreLoadStatic(JavaLangBoolean, TRUE)];
      [validValues putWithId:[((NSString *) nil_chk([property getAsTextWithJavaUtilLocale:locale])) java_lowercaseStringWithJRELocale:locale] withId:JreLoadStatic(JavaLangBoolean, TRUE)];
      [validValues putWithId:[((NSString *) nil_chk([property getAsTextWithJavaUtilLocale:locale])) java_uppercaseStringWithJRELocale:locale] withId:JreLoadStatic(JavaLangBoolean, TRUE)];
    }
  ...
  jint limit = JavaLangMath_minWithInt_withInt_([((id<JavaLangCharSequence>) nil_chk(text)) java_length], position + maxLength);
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  jint limit = JavaLangMath_minWithInt_withInt_(iMaxDigits_, [((id<JavaLangCharSequence>) nil_chk(text)) java_length] - position);
  jlong value = 0;
...
IOSLongArray *OrgJodaTimeFormatDateTimeFormatterBuilder_Fraction_getFractionDataWithLong_withOrgJodaTimeDateTimeField_(OrgJodaTimeFormatDateTimeFormatterBuilder_Fraction *self, jlong fraction, OrgJodaTimeDateTimeField *field) {
  ...
  while (true) {
    ...
    if ((JreLongDiv((rangeMillis * scalar), scalar)) == rangeMillis) {
      break;
    }
    maxDigits--;
  }
  return [IOSLongArray arrayWithLongs:(jlong[]){ JreLongDiv(fraction * scalar, rangeMillis), maxDigits } count:2];
}
...
- (jint)estimatePrintedLength {
  ...
  if (iZeroOffsetPrintText_ != nil && [iZeroOffsetPrintText_ java_length] > est) {
    est = [iZeroOffsetPrintText_ java_length];
  }
  return est;
}
...
- (void)printToWithJavaLangAppendable:(id<JavaLangAppendable>)buf
  ...
  jint hours = JreIntDiv(displayOffset, OrgJodaTimeDateTimeConstants_MILLIS_PER_HOUR);
  ...
  jint minutes = JreIntDiv(displayOffset, OrgJodaTimeDateTimeConstants_MILLIS_PER_MINUTE);
  if (iShowSeparators_) {
    [buf appendWithChar:':'];
  }
  ...
  jint seconds = JreIntDiv(displayOffset, OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND);
  if (iShowSeparators_) {
    [buf appendWithChar:':'];
  }
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  if (iZeroOffsetParseText_ != nil) {
    if ([iZeroOffsetParseText_ java_length] == 0) {
      if (limit > 0) {
        jchar c = [text charAtWithInt:position];
        if (c == '-' || c == '+') {
    ...
    if (OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithIgnoreCaseWithJavaLangCharSequence_withInt_withNSString_(text, position, iZeroOffsetParseText_)) {
      [((OrgJodaTimeFormatDateTimeParserBucket *) nil_chk(bucket)) setOffsetWithJavaLangInteger:JavaLangInteger_valueOfWithInt_(0)];
      return position + [iZeroOffsetParseText_ java_length];
    }
  }
  break_zeroOffset: ;
  if (limit <= 1) {
...
jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneOffset_digitCountWithJavaLangCharSequence_withInt_withInt_(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneOffset *self, id<JavaLangCharSequence> text, jint position, jint amount) {
  jint limit = JavaLangMath_minWithInt_withInt_([((id<JavaLangCharSequence>) nil_chk(text)) java_length] - position, amount);
  amount = 0;
  for (; limit > 0; limit--) {
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
  ...
  for (NSString * __strong name in nil_chk([parseLookup keySet])) {
    if (OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithWithJavaLangCharSequence_withInt_withNSString_(text, position, name)) {
      if (matched == nil || [((NSString *) nil_chk(name)) java_length] > [matched java_length]) {
        matched = name;
      }
    }
  }
  if (matched != nil) {
    ...
    return position + [matched java_length];
  }
  return ~position;
}
...
jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_PREFIX_LENGTH;
...
- (jint)parseIntoWithOrgJodaTimeFormatDateTimeParserBucket:(OrgJodaTimeFormatDateTimeParserBucket *)bucket
                                  withJavaLangCharSequence:(id<JavaLangCharSequence>)text
                                                   withInt:(jint)position {
  id<JavaUtilList> suffixSet = OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_BASE_GROUPED_IDS;
  jint textLen = [((id<JavaLangCharSequence>) nil_chk(text)) java_length];
  jint matchLen = JavaLangMath_minWithInt_withInt_(textLen, position + OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_PREFIX_LENGTH);
  jint pos = position;
  NSString *prefix = @"";
  for (jint i = pos; i < matchLen; i++) {
    if ([text charAtWithInt:i] == '/') {
      prefix = [((id<JavaLangCharSequence>) nil_chk([text subSequenceFrom:pos to:i + 1])) description];
      pos += [((NSString *) nil_chk(prefix)) java_length];
      NSString *prefixLookup = prefix;
      if (i < textLen) {
        JreStrAppend(&prefixLookup, "C", [text charAtWithInt:i + 1]);
      }
      suffixSet = [((id<JavaUtilMap>) nil_chk(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS)) getWithId:prefixLookup];
      if (suffixSet == nil) {
        return ~position;
      }
      break;
  ...
  NSString *best = nil;
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(suffixSet)) size]; i++) {
    NSString *suffix = [suffixSet getWithInt:i];
    if (OrgJodaTimeFormatDateTimeFormatterBuilder_csStartsWithWithJavaLangCharSequence_withInt_withNSString_(text, pos, suffix)) {
      if (best == nil || [((NSString *) nil_chk(suffix)) java_length] > [best java_length]) {
        best = suffix;
      }
    }
  }
  if (best != nil) {
    [((OrgJodaTimeFormatDateTimeParserBucket *) nil_chk(bucket)) setZoneWithOrgJodaTimeDateTimeZone:OrgJodaTimeDateTimeZone_forIDWithNSString_(JreStrcat("$$", prefix, best))];
    return pos + [best java_length];
  }
  return ~position;
}
...
- (OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_Enum)toNSEnum {
  return (OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_Enum)[self ordinal];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId;", 0x9, 6, 7, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "INSTANCE", "LOrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId;", .constantValue.asLong = 0, 0x4019, -1, 8, -1, -1 },
    { "ALL_IDS", "LJavaUtilList;", .constantValue.asLong = 0, 0x1a, -1, 9, 10, -1 },
    { "GROUPED_IDS", "LJavaUtilMap;", .constantValue.asLong = 0, 0x1a, -1, 11, 12, -1 },
    { "BASE_GROUPED_IDS", "LJavaUtilList;", .constantValue.asLong = 0, 0x1a, -1, 13, 10, -1 },
    { "MAX_LENGTH", "I", .constantValue.asLong = 0, 0x18, -1, 14, -1, -1 },
    { "MAX_PREFIX_LENGTH", "I", .constantValue.asLong = 0, 0x18, -1, 15, -1, -1 },
  };
  static const void *ptrTable[] = { "printTo", "LJavaLangAppendable;JLOrgJodaTimeChronology;ILOrgJodaTimeDateTimeZone;LJavaUtilLocale;", "LJavaIoIOException;", "LJavaLangAppendable;LOrgJodaTimeReadablePartial;LJavaUtilLocale;", "parseInto", "LOrgJodaTimeFormatDateTimeParserBucket;LJavaLangCharSequence;I", "valueOf", "LNSString;", &JreEnum(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId, INSTANCE), &OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_ALL_IDS, "Ljava/util/List<Ljava/lang/String;>;", &OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS, "Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;", &OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_BASE_GROUPED_IDS, &OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_LENGTH, &OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_PREFIX_LENGTH, "LOrgJodaTimeFormatDateTimeFormatterBuilder;", "Ljava/lang/Enum<Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;>;Lorg/joda/time/format/InternalPrinter;Lorg/joda/time/format/InternalParser;" };
  static const J2ObjcClassInfo _OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId = { "TimeZoneId", "org.joda.time.format", ptrTable, methods, fields, 7, 0x4018, 7, 6, 16, -1, -1, 17, -1 };
...
+ (void)initialize {
  if (self == [OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId class]) {
    ...
    id e;
    for (jint i = 0; i < 1; i++) {
      ((void)(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_values_[i] = e = objc_constructInstance(self, (void *)ptr)), ptr += objSize);
      OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_initWithNSString_withInt_(e, JreEnumConstantName(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_class_(), i), i);
    }
    JreStrongAssignAndConsume(&OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_BASE_GROUPED_IDS, new_JavaUtilArrayList_init());
    {
      ...
      JreStrongAssignAndConsume(&OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS, new_JavaUtilHashMap_init());
      jint max = 0;
      jint maxPrefix = 0;
      for (NSString * __strong id_ in OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_ALL_IDS) {
        jint pos = [((NSString *) nil_chk(id_)) java_indexOf:'/'];
        if (pos >= 0) {
          if (pos < [id_ java_length]) {
            pos++;
          }
          maxPrefix = JavaLangMath_maxWithInt_withInt_(maxPrefix, pos);
          NSString *prefix = [id_ java_substring:0 endIndex:pos + 1];
          NSString *suffix = [id_ java_substring:pos];
          if (![OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS containsKeyWithId:prefix]) {
            [OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS putWithId:prefix withId:create_JavaUtilArrayList_init()];
          }
          [((id<JavaUtilList>) nil_chk([OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_GROUPED_IDS getWithId:prefix])) addWithId:suffix];
        }
        else {
          [OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_BASE_GROUPED_IDS addWithId:id_];
        }
        max = JavaLangMath_maxWithInt_withInt_(max, [id_ java_length]);
      }
      OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_LENGTH = max;
      OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_PREFIX_LENGTH = maxPrefix;
    }
...
void OrgJodaTimeFormatDateTimeFormatterBuilder_Composite_decomposeWithJavaUtilList_withJavaUtilList_withJavaUtilList_(OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *self, id<JavaUtilList> elementPairs, id<JavaUtilList> printerList, id<JavaUtilList> parserList) {
  ...
  for (jint i = 0; i < size; i += 2) {
    ...
    if ([element isKindOfClass:[OrgJodaTimeFormatDateTimeFormatterBuilder_Composite class]]) {
      OrgJodaTimeFormatDateTimeFormatterBuilder_Composite_addArrayToListWithJavaUtilList_withNSObjectArray_(self, printerList, ((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) element)))->iPrinters_);
    }
    else {
    ...
    if ([element isKindOfClass:[OrgJodaTimeFormatDateTimeFormatterBuilder_Composite class]]) {
      OrgJodaTimeFormatDateTimeFormatterBuilder_Composite_addArrayToListWithJavaUtilList_withNSObjectArray_(self, parserList, ((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatDateTimeFormatterBuilder_Composite *) element)))->iParsers_);
    }
    else {
  ...
  for (jint i = 0; i < length; i++) {
    ...
    if (parsePos >= position) {
      if (parsePos > bestValidPos) {
        if (parsePos >= [((id<JavaLangCharSequence>) nil_chk(text)) java_length] || (i + 1) >= length || IOSObjectArray_Get(parsers, i + 1) == nil) {
          return parsePos;
        }
