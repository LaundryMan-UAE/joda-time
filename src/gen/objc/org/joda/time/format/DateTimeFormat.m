...
/*!
 @brief Select a format from a two character style pattern.The first character
 ...
 */
inline jint OrgJodaTimeFormatDateTimeFormat_get_PATTERN_CACHE_SIZE(void);
...
/*!
 @brief Maps patterns to formatters, patterns don't vary by locale.Size capped at PATTERN_CACHE_SIZE
 */
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeFormatDateTimeFormat_get_cPatternCache(void);
 ...
 */
inline JavaUtilConcurrentAtomicAtomicReferenceArray *OrgJodaTimeFormatDateTimeFormat_get_cStyleCache(void);
...
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeFormatDateTimeFormat_StyleFormatter_get_cCache(void);
...
OrgJodaTimeFormatDateTimeFormatter *OrgJodaTimeFormatDateTimeFormat_createFormatterForPatternWithNSString_(NSString *pattern) {
  OrgJodaTimeFormatDateTimeFormat_initialize();
  if (pattern == nil || [pattern java_length] == 0) {
...
OrgJodaTimeFormatDateTimeFormatter *OrgJodaTimeFormatDateTimeFormat_createFormatterForStyleWithNSString_(NSString *style) {
  OrgJodaTimeFormatDateTimeFormat_initialize();
  if (style == nil || [style java_length] != 2) {
