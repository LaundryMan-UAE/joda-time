...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/format/DateTimePrinterInternalPrinter.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter:(id<OrgJodaTimeFormatDateTimePrinter>)underlying;

@end

J2OBJC_FIELD_SETTER(OrgJodaTimeFormatDateTimePrinterInternalPrinter, underlying_, id<OrgJodaTimeFormatDateTimePrinter>)

__attribute__((unused)) static void OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(OrgJodaTimeFormatDateTimePrinterInternalPrinter *self, id<OrgJodaTimeFormatDateTimePrinter> underlying);

__attribute__((unused)) static OrgJodaTimeFormatDateTimePrinterInternalPrinter *new_OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(id<OrgJodaTimeFormatDateTimePrinter> underlying) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeFormatDateTimePrinterInternalPrinter *create_OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(id<OrgJodaTimeFormatDateTimePrinter> underlying);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter:(id<OrgJodaTimeFormatDateTimePrinter>)underlying {
  OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(self, underlying);
  return self;
}
...
- (void)printToWithJavaLangAppendable:(id<JavaLangAppendable>)appendable
  ...
  if ([appendable isKindOfClass:[JavaLangStringBuffer class]]) {
    JavaLangStringBuffer *buf = (JavaLangStringBuffer *) appendable;
  ...
  else if ([appendable isKindOfClass:[JavaIoWriter class]]) {
    JavaIoWriter *out = (JavaIoWriter *) appendable;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter:);
...
id<OrgJodaTimeFormatInternalPrinter> OrgJodaTimeFormatDateTimePrinterInternalPrinter_ofWithOrgJodaTimeFormatDateTimePrinter_(id<OrgJodaTimeFormatDateTimePrinter> underlying) {
  ...
  return create_OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(underlying);
}

void OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(OrgJodaTimeFormatDateTimePrinterInternalPrinter *self, id<OrgJodaTimeFormatDateTimePrinter> underlying) {
  NSObject_init(self);
  JreStrongAssign(&self->underlying_, underlying);
}

OrgJodaTimeFormatDateTimePrinterInternalPrinter *new_OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(id<OrgJodaTimeFormatDateTimePrinter> underlying) {
  J2OBJC_NEW_IMPL(OrgJodaTimeFormatDateTimePrinterInternalPrinter, initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_, underlying)
}

OrgJodaTimeFormatDateTimePrinterInternalPrinter *create_OrgJodaTimeFormatDateTimePrinterInternalPrinter_initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_(id<OrgJodaTimeFormatDateTimePrinter> underlying) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeFormatDateTimePrinterInternalPrinter, initPackagePrivateWithOrgJodaTimeFormatDateTimePrinter_, underlying)
}
