...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/format/InternalPrinterDateTimePrinter.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatInternalPrinter:(id<OrgJodaTimeFormatInternalPrinter>)underlying;

@end

J2OBJC_FIELD_SETTER(OrgJodaTimeFormatInternalPrinterDateTimePrinter, underlying_, id<OrgJodaTimeFormatInternalPrinter>)

__attribute__((unused)) static void OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(OrgJodaTimeFormatInternalPrinterDateTimePrinter *self, id<OrgJodaTimeFormatInternalPrinter> underlying);

__attribute__((unused)) static OrgJodaTimeFormatInternalPrinterDateTimePrinter *new_OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(id<OrgJodaTimeFormatInternalPrinter> underlying) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeFormatInternalPrinterDateTimePrinter *create_OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(id<OrgJodaTimeFormatInternalPrinter> underlying);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatInternalPrinter:(id<OrgJodaTimeFormatInternalPrinter>)underlying {
  OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(self, underlying);
  return self;
}
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeFormatInternalPrinterDateTimePrinter class]]) {
    OrgJodaTimeFormatInternalPrinterDateTimePrinter *other = (OrgJodaTimeFormatInternalPrinterDateTimePrinter *) obj;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initPackagePrivateWithOrgJodaTimeFormatInternalPrinter:);
...
id<OrgJodaTimeFormatDateTimePrinter> OrgJodaTimeFormatInternalPrinterDateTimePrinter_ofWithOrgJodaTimeFormatInternalPrinter_(id<OrgJodaTimeFormatInternalPrinter> underlying) {
  ...
  if ([underlying isKindOfClass:[OrgJodaTimeFormatDateTimePrinterInternalPrinter class]]) {
    return [((OrgJodaTimeFormatDateTimePrinterInternalPrinter *) nil_chk(((OrgJodaTimeFormatDateTimePrinterInternalPrinter *) underlying))) getUnderlying];
  }
  ...
  return create_OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(underlying);
}

void OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(OrgJodaTimeFormatInternalPrinterDateTimePrinter *self, id<OrgJodaTimeFormatInternalPrinter> underlying) {
  NSObject_init(self);
  JreStrongAssign(&self->underlying_, underlying);
}

OrgJodaTimeFormatInternalPrinterDateTimePrinter *new_OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(id<OrgJodaTimeFormatInternalPrinter> underlying) {
  J2OBJC_NEW_IMPL(OrgJodaTimeFormatInternalPrinterDateTimePrinter, initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_, underlying)
}

OrgJodaTimeFormatInternalPrinterDateTimePrinter *create_OrgJodaTimeFormatInternalPrinterDateTimePrinter_initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_(id<OrgJodaTimeFormatInternalPrinter> underlying) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeFormatInternalPrinterDateTimePrinter, initPackagePrivateWithOrgJodaTimeFormatInternalPrinter_, underlying)
}
