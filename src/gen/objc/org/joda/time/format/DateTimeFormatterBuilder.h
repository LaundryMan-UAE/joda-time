...
inline jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_MAX_PREFIX_LENGTH(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_MAX_PREFIX_LENGTH;
J2OBJC_STATIC_FIELD_PRIMITIVE_FINAL(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId, MAX_PREFIX_LENGTH, jint)
