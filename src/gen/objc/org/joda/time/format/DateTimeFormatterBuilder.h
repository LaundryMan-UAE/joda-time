...
/*!
 ...
 @throw IllegalArgumentExceptionif formatter is null or of an invalid type
 */
...
/*!
 @brief Appends just a parser.With no matching printer, a printer cannot be
 ...
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif parser is null or of an invalid type
 */
...
/*!
 @brief Appends just a printer.With no matching parser, a parser cannot be
 ...
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif printer is null or of an invalid type
 */
...
/*!
 ...
 @param parser the parser to add, not null
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif printer or parser is null or of an invalid type
 */
- (OrgJodaTimeFormatDateTimeFormatterBuilder *)appendWithOrgJodaTimeFormatDateTimePrinter:(id<OrgJodaTimeFormatDateTimePrinter>)printer
                                                      withOrgJodaTimeFormatDateTimeParser:(id<OrgJodaTimeFormatDateTimeParser>)parser;

/*!
 @brief Appends a printer and a set of matching parsers.When parsing, the first
  parser in the list is selected for parsing.
 If it fails, the next is
 ...
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif any printer or parser is of an invalid type
 @throw IllegalArgumentExceptionif any parser element but the last is null
 */
- (OrgJodaTimeFormatDateTimeFormatterBuilder *)appendWithOrgJodaTimeFormatDateTimePrinter:(id<OrgJodaTimeFormatDateTimePrinter>)printer
...
/*!
 @brief Instructs the printer to emit a locale-specific dayOfWeek text.The
...
/*!
 ...
 @param maxDigits maximum number of digits to  <i> parse </i> , or the estimated
   maximum number of digits to print
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif field type is null
 */
...
/*!
 ...
 @return this DateTimeFormatterBuilder, for chaining
 @throw IllegalArgumentExceptionif field type is null or if <code>numDigits <= 0</code>
 @since 1.5
 */
...
/*!
 @brief Instructs the printer to emit a remainder of time as a decimal fraction,
  ...
  minuteOfHour and the time is 12:30:45, the value printed is 75.
 A
...
/*!
 @brief Instructs the printer to emit a locale-specific monthOfYear text.The
...
/*!
 @brief Appends just a parser element which is optional.With no matching
...
/*!
 ...
 Time zone names are not unique, thus the API forces you to supply the lookup.
  The names are searched in the order of the map, thus it is strongly recommended
  to use a <code>LinkedHashMap</code> or similar.
 @param parseLookup the table of names, null to use the <code>names</code>
 @return this DateTimeFormatterBuilder, for chaining
 */
...
/*!
 @brief Instructs the printer to emit a numeric weekyear field which always prints
  ...
  the range of supported years as <code>(pivot - 50) ..
 (pivot + 49)</code>.
...
/*!
 @brief Instructs the printer to emit a numeric weekyear field which always prints
  ...
  of supported years as <code>(pivot - 50) ..
 (pivot + 49)</code>. If
...
/*!
 ...
 <code>DateTimeFormatter.isParser()</code> will help you determine the state
  of the formatter.
 @throw UnsupportedOperationExceptionif neither printing nor parsing is supported
 */
...
FOUNDATION_EXPORT OrgJodaTimeFormatDateTimeFormatterBuilder *new_OrgJodaTimeFormatDateTimeFormatterBuilder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeFormatDateTimeFormatterBuilder *create_OrgJodaTimeFormatDateTimeFormatterBuilder_init(void);
...
inline jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneName_get_LONG_NAME(void);
...
inline jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneName_get_SHORT_NAME(void);
...
@interface OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId : JavaLangEnum < OrgJodaTimeFormatInternalPrinter, OrgJodaTimeFormatInternalParser >
...
inline OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId *OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_INSTANCE(void);
J2OBJC_ENUM_CONSTANT(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId, INSTANCE)

inline id<JavaUtilSet> OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_ALL_IDS(void);
...
inline jint OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_get_MAX_LENGTH(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT IOSObjectArray *OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_values(void);
