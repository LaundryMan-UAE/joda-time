...
/*!
 @brief Instruct the printer to emit an integer millis field, if supported.
 <p>
 The number of parsed digits can be controlled using <code>maximumParsedDigits(int)</code>.
 @return this PeriodFormatterBuilder
 */
...
/*!
 @brief Print zero values for the next and following appended fields only if the
 period supports it.
 @return this PeriodFormatterBuilder
 */
