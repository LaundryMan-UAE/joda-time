...
/*!
 @brief Sorts elements [0,high).Calling java.util.Arrays isn't always the right
  choice since it always creates an internal copy of the array, even if it
  doesn't need to.
 If the array slice is small enough, an insertion sort
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "restoreState", "LOrgJodaTimeFormatDateTimeParserBucket;" };
  static const J2ObjcClassInfo _OrgJodaTimeFormatDateTimeParserBucket_SavedState = { "SavedState", "org.joda.time.format", ptrTable, methods, fields, 7, 0x0, 2, 5, 1, -1, -1, -1, -1 };
