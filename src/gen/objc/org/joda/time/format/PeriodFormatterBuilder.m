...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/format/PeriodFormatterBuilder.java
//
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_PRINT_ZERO_RARELY_FIRST(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_PRINT_ZERO_RARELY_LAST(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_PRINT_ZERO_IF_SUPPORTED(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_PRINT_ZERO_ALWAYS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_PRINT_ZERO_NEVER(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_YEARS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_MONTHS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_WEEKS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_DAYS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_HOURS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_MINUTES(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_SECONDS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_MILLIS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_SECONDS_MILLIS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_SECONDS_OPTIONAL_MILLIS(void);
...
inline jint OrgJodaTimeFormatPeriodFormatterBuilder_get_MAX_FIELD(void);
...
inline id<JavaUtilConcurrentConcurrentMap> OrgJodaTimeFormatPeriodFormatterBuilder_get_PATTERNS(void);
...
inline id<JavaUtilComparator> OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_get_LENGTH_DESC_COMPARATOR(void);
...
@interface OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 : NSObject < JavaUtilComparator >
...
J2OBJC_EMPTY_STATIC_INIT(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1)

__attribute__((unused)) static void OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *self);

__attribute__((unused)) static OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *new_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *create_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init(void);
...
- (OrgJodaTimeFormatPeriodFormatter *)toFormatter {
  ...
  JreStrongAssign(&iFieldFormatters_, [((IOSObjectArray *) nil_chk(iFieldFormatters_)) java_clone]);
  return formatter;
}
...
- (OrgJodaTimeFormatPeriodFormatterBuilder *)appendWithOrgJodaTimeFormatPeriodFormatter:(OrgJodaTimeFormatPeriodFormatter *)formatter {
  ...
  OrgJodaTimeFormatPeriodFormatterBuilder_append0WithOrgJodaTimeFormatPeriodPrinter_withOrgJodaTimeFormatPeriodParser_(self, [formatter getPrinter], [formatter getParser]);
  return self;
}
...
OrgJodaTimeFormatPeriodFormatterBuilder *OrgJodaTimeFormatPeriodFormatterBuilder_appendSuffixWithOrgJodaTimeFormatPeriodFormatterBuilder_PeriodFieldAffix_(OrgJodaTimeFormatPeriodFormatterBuilder *self, id<OrgJodaTimeFormatPeriodFormatterBuilder_PeriodFieldAffix> suffix) {
  ...
  [((id<JavaUtilList>) nil_chk(self->iElementPairs_)) setWithInt:[self->iElementPairs_ size] - 2 withId:newField];
  [((id<JavaUtilList>) nil_chk(self->iElementPairs_)) setWithInt:[self->iElementPairs_ size] - 1 withId:newField];
...
- (void)finishWithJavaUtilSet:(id<JavaUtilSet>)periodFieldAffixesToIgnore {
  if (JreLoadVolatileId(&iOtherAffixes_) == nil) {
    ...
    NSString *shortestAffix = nil;
    {
      ...
      while (b__ < e__) {
        NSString *affix = *b__++;
        if ([((NSString *) nil_chk(affix)) java_length] < shortestAffixLength) {
          shortestAffixLength = [affix java_length];
          shortestAffix = affix;
        }
      }
    }
      ...
      if (periodFieldAffixToIgnore != nil) {
        {
          ...
          while (b__ < e__) {
            ...
            if ([((NSString *) nil_chk(affixToIgnore)) java_length] > shortestAffixLength || ([affixToIgnore java_equalsIgnoreCase:shortestAffix] && ![affixToIgnore isEqual:shortestAffix])) {
  ...
  if (JreLoadVolatileId(&iOtherAffixes_) != nil) {
    {
      ...
      while (b__ < e__) {
        NSString *affixToIgnore = *b__++;
        jint textToIgnoreLength = [((NSString *) nil_chk(affixToIgnore)) java_length];
        if ((textLength < textToIgnoreLength && [((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:affixToIgnore otherOffset:0 count:textToIgnoreLength]) || (textLength == textToIgnoreLength && [((NSString *) nil_chk(periodStr)) java_regionMatches:false thisOffset:position aString:affixToIgnore otherOffset:0 count:textToIgnoreLength])) {
          return true;
        }
      }
    }
...
- (jint)calculatePrintedLengthWithInt:(jint)value {
  return [((NSString *) nil_chk(iText_)) java_length];
}
...
- (jint)parseWithNSString:(NSString *)periodStr
  ...
  if ([((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:text otherOffset:0 count:textLength]) {
...
- (jint)scanWithNSString:(NSString *)periodStr
  ...
  NSString *text = iText_;
  jint textLength = [((NSString *) nil_chk(text)) java_length];
  jint sourceLength = [((NSString *) nil_chk(periodStr)) java_length];
  for (jint pos = position; pos < sourceLength; pos++) {
    if ([periodStr java_regionMatches:true thisOffset:pos aString:text otherOffset:0 count:textLength]) {
...
- (jint)calculatePrintedLengthWithInt:(jint)value {
  return [(value == 1 ? iSingularText_ : iPluralText_) java_length];
}
...
- (jint)parseWithNSString:(NSString *)periodStr
  ...
  if ([((NSString *) nil_chk(text1)) java_length] < [((NSString *) nil_chk(text2)) java_length]) {
    NSString *temp = text1;
    text1 = text2;
    text2 = temp;
  }
  if ([((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:text1 otherOffset:0 count:[text1 java_length]]) {
    if (![self matchesOtherAffixWithInt:[text1 java_length] withNSString:periodStr withInt:position]) {
      return position + [text1 java_length];
    }
  }
  if ([periodStr java_regionMatches:true thisOffset:position aString:text2 otherOffset:0 count:[text2 java_length]]) {
    if (![self matchesOtherAffixWithInt:[text2 java_length] withNSString:periodStr withInt:position]) {
      return position + [text2 java_length];
    }
  }
  return ~position;
}
...
- (jint)scanWithNSString:(NSString *)periodStr
  ...
  jint textLength1 = [text1 java_length];
  jint textLength2 = [text2 java_length];
  jint sourceLength = [((NSString *) nil_chk(periodStr)) java_length];
  for (jint pos = position; pos < sourceLength; pos++) {
    if ([periodStr java_regionMatches:true thisOffset:pos aString:text1 otherOffset:0 count:textLength1]) {
      if (![self matchesOtherAffixWithInt:[text1 java_length] withNSString:periodStr withInt:pos]) {
        return pos;
      }
    }
    if ([periodStr java_regionMatches:true thisOffset:pos aString:text2 otherOffset:0 count:textLength2]) {
      if (![self matchesOtherAffixWithInt:[text2 java_length] withNSString:periodStr withInt:pos]) {
        return pos;
      }
    }
  }
...
- (jint)calculatePrintedLengthWithInt:(jint)value {
  return [((NSString *) nil_chk(IOSObjectArray_Get(nil_chk(iSuffixes_), OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_selectSuffixIndexWithInt_(self, value)))) java_length];
}
...
- (jint)parseWithNSString:(NSString *)periodStr
                  withInt:(jint)position {
  {
    ...
    while (b__ < e__) {
      NSString *text = *b__++;
      if ([((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:text otherOffset:0 count:[((NSString *) nil_chk(text)) java_length]]) {
        if (![self matchesOtherAffixWithInt:[text java_length] withNSString:periodStr withInt:position]) {
          return position + [text java_length];
        }
      }
    }
  }
  ...
  for (jint pos = position; pos < sourceLength; pos++) {
    {
      ...
      while (b__ < e__) {
        NSString *text = *b__++;
        if ([periodStr java_regionMatches:true thisOffset:pos aString:text otherOffset:0 count:[((NSString *) nil_chk(text)) java_length]]) {
          if (![self matchesOtherAffixWithInt:[text java_length] withNSString:periodStr withInt:pos]) {
            return pos;
          }
        }
      }
...
- (IOSObjectArray *)getAffixes {
  return [((IOSObjectArray *) nil_chk(iSuffixes_)) java_clone];
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_LENGTH_DESC_COMPARATOR, new_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init());
...
void OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_initWithNSStringArray_withNSStringArray_(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix *self, IOSObjectArray *regExes, IOSObjectArray *texts) {
  OrgJodaTimeFormatPeriodFormatterBuilder_IgnorableAffix_init(self);
  JreStrongAssign(&self->iSuffixes_, [((IOSObjectArray *) nil_chk(texts)) java_clone]);
  ...
  JreStrongAssign(&self->iSuffixesSortedDescByLength_, [((IOSObjectArray *) nil_chk(self->iSuffixes_)) java_clone]);
...
jint OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_selectSuffixIndexWithInt_(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix *self, jint value) {
  NSString *valueString = NSString_java_valueOfInt_(value);
...
@implementation OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END
...
- (jint)compareWithId:(NSString *)o1
               withId:(NSString *)o2 {
  return [((NSString *) nil_chk(o2)) java_length] - [((NSString *) nil_chk(o1)) java_length];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 = { "", "org.joda.time.format", ptrTable, methods, NULL, 7, 0x8018, 2, 0, 2, -1, -1, 3, -1 };
  return &_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1;
}

@end

void OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *self) {
  NSObject_init(self);
}

OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *new_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init() {
  J2OBJC_NEW_IMPL(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1, init)
}

OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1 *create_OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1_init() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeFormatPeriodFormatterBuilder_RegExAffix_1, init)
}
...
- (IOSObjectArray *)getAffixes {
  return [((IOSObjectArray *) nil_chk(iLeftRightCombinations_)) java_clone];
}
...
- (jint)calculatePrintedLengthWithOrgJodaTimeReadablePeriod:(id<OrgJodaTimeReadablePeriod>)period
  ...
  if (iFieldType_ >= OrgJodaTimeFormatPeriodFormatterBuilder_SECONDS_MILLIS) {
    ...
    sum++;
    if (iFieldType_ == OrgJodaTimeFormatPeriodFormatterBuilder_SECONDS_OPTIONAL_MILLIS && (JreLongMod(JavaLangMath_absWithLong_(valueLong), OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND)) == 0) {
      sum -= 4;
    }
    valueLong = JreLongDiv(valueLong, OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND);
  }
...
- (void)printToWithJavaLangStringBuffer:(JavaLangStringBuffer *)buf
  ...
  jint value = (jint) valueLong;
  if (iFieldType_ >= OrgJodaTimeFormatPeriodFormatterBuilder_SECONDS_MILLIS) {
    value = (jint) (JreLongDiv(valueLong, OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND));
  }
  if (iPrefix_ != nil) {
    [iPrefix_ printToWithJavaLangStringBuffer:buf withInt:value];
  }
  jint bufLen = [((JavaLangStringBuffer *) nil_chk(buf)) java_length];
  ...
  if (iFieldType_ >= OrgJodaTimeFormatPeriodFormatterBuilder_SECONDS_MILLIS) {
    jint dp = (jint) (JreLongMod(JavaLangMath_absWithLong_(valueLong), OrgJodaTimeDateTimeConstants_MILLIS_PER_SECOND));
...
- (jint)parseIntoWithOrgJodaTimeReadWritablePeriod:(id<OrgJodaTimeReadWritablePeriod>)period
  ...
  if (position >= [((NSString *) nil_chk(text)) java_length]) {
  ...
  if (suffixPos > 0) {
    ...
    limit = JavaLangMath_minWithInt_withInt_(iMaxParsedDigits_, [text java_length] - position);
  }
  jint length = 0;
  jint fractPos = -1;
...
jint OrgJodaTimeFormatPeriodFormatterBuilder_FieldFormatter_parseIntWithNSString_withInt_withInt_(OrgJodaTimeFormatPeriodFormatterBuilder_FieldFormatter *self, NSString *text, jint position, jint length) {
  if (length >= 10) {
    return JavaLangInteger_parseIntWithNSString_([((NSString *) nil_chk(text)) java_substring:position endIndex:position + length]);
  }
  if (length <= 0) {
    return 0;
  }
...
- (jint)parseIntoWithOrgJodaTimeReadWritablePeriod:(id<OrgJodaTimeReadWritablePeriod>)period
                                      withNSString:(NSString *)periodStr
                                           withInt:(jint)position
                                withJavaUtilLocale:(JavaUtilLocale *)locale {
  if ([((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:iText_ otherOffset:0 count:[((NSString *) nil_chk(iText_)) java_length]]) {
    return position + [iText_ java_length];
  }
  return ~position;
}
  ...
  if (iUseBefore_) {
    if ([before countFieldsToPrintWithOrgJodaTimeReadablePeriod:period withInt:1 withJavaUtilLocale:locale] > 0) {
      if (iUseAfter_) {
        ...
        if (afterCount > 0) {
          sum += [(afterCount > 1 ? iText_ : iFinalText_) java_length];
        }
      }
      else {
        sum += [((NSString *) nil_chk(iText_)) java_length];
      }
    }
  }
...
- (jint)parseIntoWithOrgJodaTimeReadWritablePeriod:(id<OrgJodaTimeReadWritablePeriod>)period
  ...
  if (position > oldPos) {
    ...
    for (jint i = 0; i < length; i++) {
      ...
      if ((parsedForm == nil || [parsedForm java_length] == 0) || [((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:parsedForm otherOffset:0 count:[((NSString *) nil_chk(parsedForm)) java_length]]) {
        parsedFormLength = (parsedForm == nil ? 0 : [parsedForm java_length]);
  ...
  for (jint i = 0; i < size; i += 2) {
    ...
    if ([OrgJodaTimeFormatPeriodPrinter_class_() isInstance:element]) {
      if ([element isKindOfClass:[OrgJodaTimeFormatPeriodFormatterBuilder_Composite class]]) {
        OrgJodaTimeFormatPeriodFormatterBuilder_Composite_addArrayToListWithJavaUtilList_withNSObjectArray_(self, printerList, ((OrgJodaTimeFormatPeriodFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatPeriodFormatterBuilder_Composite *) element)))->iPrinters_);
      }
      else {
    ...
    if ([OrgJodaTimeFormatPeriodParser_class_() isInstance:element]) {
      if ([element isKindOfClass:[OrgJodaTimeFormatPeriodFormatterBuilder_Composite class]]) {
        OrgJodaTimeFormatPeriodFormatterBuilder_Composite_addArrayToListWithJavaUtilList_withNSObjectArray_(self, parserList, ((OrgJodaTimeFormatPeriodFormatterBuilder_Composite *) nil_chk(((OrgJodaTimeFormatPeriodFormatterBuilder_Composite *) element)))->iParsers_);
      }
      else {
