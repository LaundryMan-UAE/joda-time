      ...
      if (periodFieldAffixToIgnore != nil) {
        {
          ...
          while (b__ < e__) {
            ...
            if ([((NSString *) nil_chk(affixToIgnore)) java_length] > shortestAffixLength) {
  ...
  if (JreLoadVolatileId(&iOtherAffixes_) != nil) {
    {
      ...
      while (b__ < e__) {
        ...
        if (textLength < textToIgnoreLength && [((NSString *) nil_chk(periodStr)) java_regionMatches:true thisOffset:position aString:affixToIgnore otherOffset:0 count:textToIgnoreLength]) {
          return true;
        }
      }
    }
