...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/format/DateTimeParserInternalParser.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatDateTimeParser:(id<OrgJodaTimeFormatDateTimeParser>)underlying;

@end

J2OBJC_FIELD_SETTER(OrgJodaTimeFormatDateTimeParserInternalParser, underlying_, id<OrgJodaTimeFormatDateTimeParser>)

__attribute__((unused)) static void OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(OrgJodaTimeFormatDateTimeParserInternalParser *self, id<OrgJodaTimeFormatDateTimeParser> underlying);

__attribute__((unused)) static OrgJodaTimeFormatDateTimeParserInternalParser *new_OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(id<OrgJodaTimeFormatDateTimeParser> underlying) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeFormatDateTimeParserInternalParser *create_OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(id<OrgJodaTimeFormatDateTimeParser> underlying);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeFormatDateTimeParser:(id<OrgJodaTimeFormatDateTimeParser>)underlying {
  OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(self, underlying);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initPackagePrivateWithOrgJodaTimeFormatDateTimeParser:);
...
id<OrgJodaTimeFormatInternalParser> OrgJodaTimeFormatDateTimeParserInternalParser_ofWithOrgJodaTimeFormatDateTimeParser_(id<OrgJodaTimeFormatDateTimeParser> underlying) {
  ...
  return create_OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(underlying);
}

void OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(OrgJodaTimeFormatDateTimeParserInternalParser *self, id<OrgJodaTimeFormatDateTimeParser> underlying) {
  NSObject_init(self);
  JreStrongAssign(&self->underlying_, underlying);
}

OrgJodaTimeFormatDateTimeParserInternalParser *new_OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(id<OrgJodaTimeFormatDateTimeParser> underlying) {
  J2OBJC_NEW_IMPL(OrgJodaTimeFormatDateTimeParserInternalParser, initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_, underlying)
}

OrgJodaTimeFormatDateTimeParserInternalParser *create_OrgJodaTimeFormatDateTimeParserInternalParser_initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_(id<OrgJodaTimeFormatDateTimeParser> underlying) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeFormatDateTimeParserInternalParser, initPackagePrivateWithOrgJodaTimeFormatDateTimeParser_, underlying)
}
