...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/LocalDate.java
//
...
inline jlong OrgJodaTimeLocalDate_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeLocalDate_readResolve(OrgJodaTimeLocalDate *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$2(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$3(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$4(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDate__Annotations$5(void);
...
inline jlong OrgJodaTimeLocalDate_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeLocalDate_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalDate_Property *self, JavaIoObjectOutputStream *oos);

__attribute__((unused)) static void OrgJodaTimeLocalDate_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalDate_Property *self, JavaIoObjectInputStream *oos);
...
- (id)readResolve {
  return OrgJodaTimeLocalDate_readResolve(self);
}
...
- (jboolean)isEqual:(id)partial {
  ...
  if ([partial isKindOfClass:[OrgJodaTimeLocalDate class]]) {
    OrgJodaTimeLocalDate *other = (OrgJodaTimeLocalDate *) partial;
...
- (OrgJodaTimeLocalDate_Property *)propertyWithOrgJodaTimeDateTimeFieldType:(OrgJodaTimeDateTimeFieldType *)fieldType {
  ...
  return create_OrgJodaTimeLocalDate_Property_initWithOrgJodaTimeLocalDate_withOrgJodaTimeDateTimeField_(self, [fieldType getFieldWithOrgJodaTimeChronology:[self getChronology]]);
}
...
id OrgJodaTimeLocalDate_readResolve(OrgJodaTimeLocalDate *self) {
  if (self->iChronology_ == nil) {
    return create_OrgJodaTimeLocalDate_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, OrgJodaTimeChronoISOChronology_getInstanceUTC());
  }
  if ([((OrgJodaTimeDateTimeZone *) nil_chk(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC))) isEqual:[self->iChronology_ getZone]] == false) {
    return create_OrgJodaTimeLocalDate_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, [self->iChronology_ withUTC]);
  }
  return self;
}
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)oos {
  OrgJodaTimeLocalDate_Property_writeObjectWithJavaIoObjectOutputStream_(self, oos);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  OrgJodaTimeLocalDate_Property_readObjectWithJavaIoObjectInputStream_(self, oos);
}
...
void OrgJodaTimeLocalDate_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalDate_Property *self, JavaIoObjectOutputStream *oos) {
...
void OrgJodaTimeLocalDate_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalDate_Property *self, JavaIoObjectInputStream *oos) {
  JreStrongAssign(&self->iInstant_, (OrgJodaTimeLocalDate *) cast_chk([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeLocalDate class]));
  ...
  JreStrongAssign(&self->iField_, [((OrgJodaTimeDateTimeFieldType *) nil_chk(type)) getFieldWithOrgJodaTimeChronology:[((OrgJodaTimeLocalDate *) nil_chk(self->iInstant_)) getChronology]]);
}
