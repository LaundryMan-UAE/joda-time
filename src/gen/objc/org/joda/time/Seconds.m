...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/Seconds.java
//
...
- (OrgJodaTimeWeeks *)toStandardWeeks {
  return OrgJodaTimeWeeks_weeksWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_SECONDS_PER_WEEK));
}

- (OrgJodaTimeDays *)toStandardDays {
  return OrgJodaTimeDays_daysWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_SECONDS_PER_DAY));
}

- (OrgJodaTimeHours *)toStandardHours {
  return OrgJodaTimeHours_hoursWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_SECONDS_PER_HOUR));
}

- (OrgJodaTimeMinutes *)toStandardMinutes {
  return OrgJodaTimeMinutes_minutesWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_SECONDS_PER_MINUTE));
}
...
- (OrgJodaTimeSeconds *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeSeconds_secondsWithInt_(JreIntDiv([self getValue], divisor));
}
