...
inline jlong OrgJodaTimeTimeOfDay_get_serialVersionUID(void);
...
inline IOSObjectArray *OrgJodaTimeTimeOfDay_get_FIELD_TYPES(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeTimeOfDay__Annotations$0(void);
...
inline jlong OrgJodaTimeTimeOfDay_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeTimeOfDay_Property__Annotations$0(void);
...
- (IOSObjectArray *)getFieldTypes {
  return [((IOSObjectArray *) nil_chk(OrgJodaTimeTimeOfDay_FIELD_TYPES)) java_clone];
}
...
OrgJodaTimeTimeOfDay *OrgJodaTimeTimeOfDay_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeTimeOfDay_initWithInt_withInt_withInt_withInt_([date getHours], [date getMinutes], [date getSeconds], JreIntMod((((jint) (JreLongMod([date getTime], 1000))) + 1000), 1000));
}
