...
//  source: /Users/marcussmith/HambroPerks/hambroperks_org/joda-time/src/main/java/org/joda/time/DurationField.java
//
...
/*!
 @brief Get the millisecond duration of this field from its value relative to an
...
/*!
 @brief Returns the amount of milliseconds per unit value of this field.For
...
/*!
 ...
 @return the value of the field, in the units of the field, which may be
  negative
 @throw ArithmeticExceptionif the value is too large for an int
 */
...
/*!
 @brief Is this field precise.A precise field can calculate its value from
  milliseconds without needing a reference date.
 Put another way, a
  precise field's unit size is not variable.
 @return true if precise
 - seealso: #getUnitMillis()
 */
- (jboolean)isPrecise;
