...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/Minutes.java
//
...
inline OrgJodaTimeFormatPeriodFormatter *OrgJodaTimeMinutes_get_PARSER(void);
...
inline jlong OrgJodaTimeMinutes_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeMinutes_readResolve(OrgJodaTimeMinutes *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMinutes__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMinutes__Annotations$1(void);
...
- (id)readResolve {
  return OrgJodaTimeMinutes_readResolve(self);
}
...
- (OrgJodaTimeWeeks *)toStandardWeeks {
  return OrgJodaTimeWeeks_weeksWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_MINUTES_PER_WEEK));
}

- (OrgJodaTimeDays *)toStandardDays {
  return OrgJodaTimeDays_daysWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_MINUTES_PER_DAY));
}

- (OrgJodaTimeHours *)toStandardHours {
  return OrgJodaTimeHours_hoursWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_MINUTES_PER_HOUR));
}
...
- (OrgJodaTimeMinutes *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeMinutes_minutesWithInt_(JreIntDiv([self getValue], divisor));
}
...
- (NSString *)description {
  return JreStrcat("$$C", @"PT", NSString_java_valueOfInt_([self getValue]), 'M');
}
...
id OrgJodaTimeMinutes_readResolve(OrgJodaTimeMinutes *self) {
