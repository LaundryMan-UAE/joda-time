 ...
 */
inline jlong OrgJodaTimePeriodType_get_serialVersionUID(void);
...
/*!
 @brief Cache of all the known types.
 */
inline id<JavaUtilMap> OrgJodaTimePeriodType_get_cTypes(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cStandard(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYMDTime(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYMD(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYWDTime(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYWD(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYDTime(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYD(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cDTime(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cTime(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cYears(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cMonths(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cWeeks(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cDays(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cHours(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cMinutes(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cSeconds(void);
...
inline OrgJodaTimePeriodType *OrgJodaTimePeriodType_get_cMillis(void);
...
OrgJodaTimePeriodType *OrgJodaTimePeriodType_forFieldsWithOrgJodaTimeDurationFieldTypeArray_(IOSObjectArray *types) {
  ...
  @synchronized(OrgJodaTimePeriodType_class_()) {
    ...
    if ([cached isKindOfClass:[OrgJodaTimePeriodType class]]) {
      return JreRetainedLocalValue((OrgJodaTimePeriodType *) cast_chk(cached, [OrgJodaTimePeriodType class]));
    }
    if (cached != nil) {
    ...
    if (checkedType != nil) {
      ...
      return JreRetainedLocalValue(checkedType);
    }
    [cache putWithId:checkPartType withId:type];
    return JreRetainedLocalValue(type);
  }
}
