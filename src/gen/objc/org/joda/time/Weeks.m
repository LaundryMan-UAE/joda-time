...
inline OrgJodaTimeFormatPeriodFormatter *OrgJodaTimeWeeks_get_PARSER(void);
...
inline jlong OrgJodaTimeWeeks_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeWeeks_readResolve(OrgJodaTimeWeeks *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeWeeks__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeWeeks__Annotations$1(void);
...
- (id)readResolve {
  return OrgJodaTimeWeeks_readResolve(self);
}
...
- (OrgJodaTimeWeeks *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeWeeks_weeksWithInt_(JreIntDiv([self getValue], divisor));
}
...
- (NSString *)description {
  return JreStrcat("C$C", 'P', NSString_java_valueOfInt_([self getValue]), 'W');
}
...
id OrgJodaTimeWeeks_readResolve(OrgJodaTimeWeeks *self) {
