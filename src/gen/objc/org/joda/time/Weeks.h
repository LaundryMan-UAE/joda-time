...
//  source: /Users/marcussmith/temp/joda-time/src/main/java/org/joda/time/Weeks.java
//

#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgJodaTimeWeeks")
#ifdef RESTRICT_OrgJodaTimeWeeks
#define INCLUDE_ALL_OrgJodaTimeWeeks 0
#else
#define INCLUDE_ALL_OrgJodaTimeWeeks 1
#endif
#undef RESTRICT_OrgJodaTimeWeeks

#if !defined (OrgJodaTimeWeeks_) && (INCLUDE_ALL_OrgJodaTimeWeeks || defined(INCLUDE_OrgJodaTimeWeeks))
...
/*!
 @brief Constant representing zero weeks.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_ZERO(void);
...
/*!
 @brief Constant representing one week.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_ONE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 @brief Constant representing two weeks.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_TWO(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 @brief Constant representing three weeks.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_THREE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 @brief Constant representing the maximum number of weeks that can be stored in this object.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_MAX_VALUE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 @brief Constant representing the minimum number of weeks that can be stored in this object.
 */
inline OrgJodaTimeWeeks *OrgJodaTimeWeeks_get_MIN_VALUE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
...
#pragma pop_macro("INCLUDE_ALL_OrgJodaTimeWeeks")
