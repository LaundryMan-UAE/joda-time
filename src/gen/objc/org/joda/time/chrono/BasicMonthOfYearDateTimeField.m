...
inline jlong OrgJodaTimeChronoBasicMonthOfYearDateTimeField_get_serialVersionUID(void);
...
inline jint OrgJodaTimeChronoBasicMonthOfYearDateTimeField_get_MIN(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoBasicMonthOfYearDateTimeField_readResolve(OrgJodaTimeChronoBasicMonthOfYearDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology
  ...
  OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(self, chronology, leapMonth);
  return self;
}
...
- (jlong)addWithLong:(jlong)instant
  ...
  if (thisMonth > 0 && monthToUse < 0) {
    if (JavaLangMath_signumWithFloat_(months + iMax_) == JavaLangMath_signumWithFloat_(months)) {
      yearToUse--;
      months += iMax_;
    }
    else {
  ...
  if (monthToUse >= 0) {
    yearToUse = yearToUse + (JreIntDiv(monthToUse, iMax_));
    monthToUse = (JreIntMod(monthToUse, iMax_)) + 1;
  }
  else {
    yearToUse = yearToUse + (JreIntDiv(monthToUse, iMax_)) - 1;
    monthToUse = JavaLangMath_absWithInt_(monthToUse);
    jint remMonthToUse = JreIntMod(monthToUse, iMax_);
    if (remMonthToUse == 0) {
      remMonthToUse = iMax_;
    }
...
- (jlong)addWithLong:(jlong)instant
  ...
  if (monthToUse >= 0) {
    yearToUse = thisYear + (JreLongDiv(monthToUse, iMax_));
    monthToUse = (JreLongMod(monthToUse, iMax_)) + 1;
  }
  else {
    yearToUse = thisYear + (JreLongDiv(monthToUse, iMax_)) - 1;
    monthToUse = JavaLangMath_absWithLong_(monthToUse);
    jint remMonthToUse = (jint) (JreLongMod(monthToUse, iMax_));
    if (remMonthToUse == 0) {
      remMonthToUse = iMax_;
    }
    monthToUse = iMax_ - remMonthToUse + 1;
...
- (IOSIntArray *)addWithOrgJodaTimeReadablePartial:(id<OrgJodaTimeReadablePartial>)partial
  ...
  if ([((id<OrgJodaTimeReadablePartial>) nil_chk(partial)) size] > 0 && [((OrgJodaTimeDateTimeFieldType *) nil_chk([partial getFieldTypeWithInt:0])) isEqual:OrgJodaTimeDateTimeFieldType_monthOfYear()] && fieldIndex == 0) {
    ...
    jint newMonth = (JreIntMod((curMonth0 + (JreIntMod(valueToAdd, 12)) + 12), 12)) + 1;
...
- (id)readResolve {
  return OrgJodaTimeChronoBasicMonthOfYearDateTimeField_readResolve(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeChronoBasicChronology:withInt:);
...
void OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(OrgJodaTimeChronoBasicMonthOfYearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology, jint leapMonth) {
...
OrgJodaTimeChronoBasicMonthOfYearDateTimeField *new_OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(OrgJodaTimeChronoBasicChronology *chronology, jint leapMonth) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicMonthOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_, chronology, leapMonth)
}

OrgJodaTimeChronoBasicMonthOfYearDateTimeField *create_OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(OrgJodaTimeChronoBasicChronology *chronology, jint leapMonth) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicMonthOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_, chronology, leapMonth)
}

id OrgJodaTimeChronoBasicMonthOfYearDateTimeField_readResolve(OrgJodaTimeChronoBasicMonthOfYearDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) monthOfYear];
}
