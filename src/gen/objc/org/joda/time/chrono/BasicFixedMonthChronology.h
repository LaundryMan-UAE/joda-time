...
inline jint OrgJodaTimeChronoBasicFixedMonthChronology_get_MONTH_LENGTH(void);
...
inline jlong OrgJodaTimeChronoBasicFixedMonthChronology_get_MILLIS_PER_YEAR(void);
...
inline jlong OrgJodaTimeChronoBasicFixedMonthChronology_get_MILLIS_PER_MONTH(void);
...
FOUNDATION_EXPORT void OrgJodaTimeChronoBasicFixedMonthChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoBasicFixedMonthChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek);
