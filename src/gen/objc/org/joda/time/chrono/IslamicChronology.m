...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/IslamicChronology.java
//
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_serialVersionUID(void);
...
inline OrgJodaTimeDateTimeField *OrgJodaTimeChronoIslamicChronology_get_ERA_FIELD(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_MIN_YEAR(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_MAX_YEAR(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_MONTH_PAIR_LENGTH(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_LONG_MONTH_LENGTH(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_SHORT_MONTH_LENGTH(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_MONTH_PAIR(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_MONTH(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_LONG_MONTH(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_YEAR(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_SHORT_YEAR(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_LONG_YEAR(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_YEAR_1(void);
...
inline jint OrgJodaTimeChronoIslamicChronology_get_CYCLE(void);
...
inline jlong OrgJodaTimeChronoIslamicChronology_get_MILLIS_PER_CYCLE(void);
...
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeChronoIslamicChronology_get_cCache(void);
...
inline OrgJodaTimeChronoIslamicChronology *OrgJodaTimeChronoIslamicChronology_get_INSTANCE_UTC(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoIslamicChronology_readResolve(OrgJodaTimeChronoIslamicChronology *self);
...
inline jlong OrgJodaTimeChronoIslamicChronology_LeapYearPatternType_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoIslamicChronology_LeapYearPatternType_readResolve(OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *self);
...
- (id)readResolve {
  return OrgJodaTimeChronoIslamicChronology_readResolve(self);
}
...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeChronoIslamicChronology class]]) {
    OrgJodaTimeChronoIslamicChronology *chrono = (OrgJodaTimeChronoIslamicChronology *) obj;
...
- (jint)getYearWithLong:(jlong)instant {
  ...
  jlong cycles = JreLongDiv(millisIslamic, OrgJodaTimeChronoIslamicChronology_MILLIS_PER_CYCLE);
  jlong cycleRemainder = JreLongMod(millisIslamic, OrgJodaTimeChronoIslamicChronology_MILLIS_PER_CYCLE);
...
- (jint)getDayOfMonthWithLong:(jlong)millis {
  ...
  return JreIntMod((JreIntMod(doy, OrgJodaTimeChronoIslamicChronology_MONTH_PAIR_LENGTH)), OrgJodaTimeChronoIslamicChronology_LONG_MONTH_LENGTH) + 1;
}
...
- (jint)getDaysInYearMonthWithInt:(jint)year
  ...
  return (JreIntMod(--month, 2) == 0 ? OrgJodaTimeChronoIslamicChronology_LONG_MONTH_LENGTH : OrgJodaTimeChronoIslamicChronology_SHORT_MONTH_LENGTH);
}
...
- (jint)getMonthOfYearWithLong:(jlong)millis
                       withInt:(jint)year {
  jint doyZeroBased = (jint) (JreLongDiv((millis - [self getYearMillisWithInt:year]), OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY));
  if (doyZeroBased == 354) {
    return 12;
  }
  return (JreIntDiv((doyZeroBased * 2), OrgJodaTimeChronoIslamicChronology_MONTH_PAIR_LENGTH)) + 1;
}
...
- (jlong)getAverageMillisPerYearDividedByTwo {
  return JreLongDiv(OrgJodaTimeChronoIslamicChronology_MILLIS_PER_YEAR, 2);
}
...
- (jlong)calculateFirstDayOfYearMillisWithInt:(jint)year {
  ...
  year--;
  jlong cycle = JreIntDiv(year, OrgJodaTimeChronoIslamicChronology_CYCLE);
  jlong millis = OrgJodaTimeChronoIslamicChronology_MILLIS_YEAR_1 + cycle * OrgJodaTimeChronoIslamicChronology_MILLIS_PER_CYCLE;
  jint cycleRemainder = (JreIntMod(year, OrgJodaTimeChronoIslamicChronology_CYCLE)) + 1;
...
- (jlong)getApproxMillisAtEpochDividedByTwo {
  return JreLongDiv((-OrgJodaTimeChronoIslamicChronology_MILLIS_YEAR_1), 2);
}
...
- (void)assembleWithOrgJodaTimeChronoAssembledChronology_Fields:(OrgJodaTimeChronoAssembledChronology_Fields *)fields {
  if ([self getBase] == nil) {
    ...
    JreStrongAssignAndConsume(&fields->monthOfYear_, new_OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(self, 12));
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoIslamicChronology class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeChronoIslamicChronology_ERA_FIELD, new_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(@"AH"));
...
OrgJodaTimeChronoIslamicChronology *OrgJodaTimeChronoIslamicChronology_getInstanceWithOrgJodaTimeDateTimeZone_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(OrgJodaTimeDateTimeZone *zone, OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *leapYears) {
  ...
  if (chrono == nil) {
    @synchronized(chronos) {
      chrono = JreRetainedLocalValue(IOSObjectArray_Get(chronos, leapYears->index_));
      if (chrono == nil) {
        if (zone == JreLoadStatic(OrgJodaTimeDateTimeZone, UTC)) {
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoIslamicChronology_initWithOrgJodaTimeChronology_withId_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(nil, nil, leapYears));
          ...
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoIslamicChronology_initWithOrgJodaTimeChronology_withId_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(OrgJodaTimeChronoLimitChronology_getInstanceWithOrgJodaTimeChronology_withOrgJodaTimeReadableDateTime_withOrgJodaTimeReadableDateTime_(chrono, lowerLimit, nil), nil, leapYears));
        }
        else {
          chrono = JreRetainedLocalValue(OrgJodaTimeChronoIslamicChronology_getInstanceWithOrgJodaTimeDateTimeZone_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC), leapYears));
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoIslamicChronology_initWithOrgJodaTimeChronology_withId_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(OrgJodaTimeChronoZonedChronology_getInstanceWithOrgJodaTimeChronology_withOrgJodaTimeDateTimeZone_(chrono, zone), nil, leapYears));
        }
...
void OrgJodaTimeChronoIslamicChronology_initWithOrgJodaTimeChronology_withId_withOrgJodaTimeChronoIslamicChronology_LeapYearPatternType_(OrgJodaTimeChronoIslamicChronology *self, OrgJodaTimeChronology *base, id param, OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *leapYears) {
  OrgJodaTimeChronoBasicChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(self, base, param, 4);
...
id OrgJodaTimeChronoIslamicChronology_readResolve(OrgJodaTimeChronoIslamicChronology *self) {
...
- (jboolean)isLeapYearWithInt:(jint)year {
  jint key = JreLShift32(1, (JreIntMod(year, 30)));
  return ((pattern_ & key) > 0);
}

- (id)readResolve {
  return OrgJodaTimeChronoIslamicChronology_LeapYearPatternType_readResolve(self);
}

- (jboolean)isEqual:(id)obj {
  if ([obj isKindOfClass:[OrgJodaTimeChronoIslamicChronology_LeapYearPatternType class]]) {
    return index_ == ((OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *) nil_chk(((OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *) obj)))->index_;
  }
  return false;
}
...
id OrgJodaTimeChronoIslamicChronology_LeapYearPatternType_readResolve(OrgJodaTimeChronoIslamicChronology_LeapYearPatternType *self) {
  switch (self->index_) {
    case 0:
