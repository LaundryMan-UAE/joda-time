...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/BasicDayOfMonthDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoBasicDayOfMonthDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoBasicDayOfMonthDateTimeField_readResolve(OrgJodaTimeChronoBasicDayOfMonthDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology
  ...
  OrgJodaTimeChronoBasicDayOfMonthDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, chronology, days);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoBasicDayOfMonthDateTimeField_readResolve(self);
}
...
void OrgJodaTimeChronoBasicDayOfMonthDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicDayOfMonthDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
...
OrgJodaTimeChronoBasicDayOfMonthDateTimeField *new_OrgJodaTimeChronoBasicDayOfMonthDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicDayOfMonthDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}

OrgJodaTimeChronoBasicDayOfMonthDateTimeField *create_OrgJodaTimeChronoBasicDayOfMonthDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicDayOfMonthDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}

id OrgJodaTimeChronoBasicDayOfMonthDateTimeField_readResolve(OrgJodaTimeChronoBasicDayOfMonthDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) dayOfMonth];
}
