...
inline jlong OrgJodaTimeChronoBasicGJChronology_get_serialVersionUID(void);
...
inline IOSIntArray *OrgJodaTimeChronoBasicGJChronology_get_MIN_DAYS_PER_MONTH_ARRAY(void);
...
inline IOSIntArray *OrgJodaTimeChronoBasicGJChronology_get_MAX_DAYS_PER_MONTH_ARRAY(void);
...
inline IOSLongArray *OrgJodaTimeChronoBasicGJChronology_get_MIN_TOTAL_MILLIS_BY_MONTH_ARRAY(void);
...
inline IOSLongArray *OrgJodaTimeChronoBasicGJChronology_get_MAX_TOTAL_MILLIS_BY_MONTH_ARRAY(void);
...
inline jlong OrgJodaTimeChronoBasicGJChronology_get_FEB_29(void);
...
void OrgJodaTimeChronoBasicGJChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoBasicGJChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek) {
