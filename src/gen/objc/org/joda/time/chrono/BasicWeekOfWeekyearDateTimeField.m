...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/BasicWeekOfWeekyearDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_readResolve(OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology
  ...
  OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, chronology, weeks);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_readResolve(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeChronoBasicChronology:withOrgJodaTimeDurationField:);
...
void OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *weeks) {
...
OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField *new_OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *weeks) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, weeks)
}

OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField *create_OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *weeks) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, weeks)
}

id OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField_readResolve(OrgJodaTimeChronoBasicWeekOfWeekyearDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) weekOfWeekyear];
}
