...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/BasicWeekyearDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoBasicWeekyearDateTimeField_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoBasicWeekyearDateTimeField_get_WEEK_53(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoBasicWeekyearDateTimeField_readResolve(OrgJodaTimeChronoBasicWeekyearDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology {
  OrgJodaTimeChronoBasicWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(self, chronology);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoBasicWeekyearDateTimeField_readResolve(self);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeChronoBasicChronology:);
...
void OrgJodaTimeChronoBasicWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicWeekyearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology) {
...
OrgJodaTimeChronoBasicWeekyearDateTimeField *new_OrgJodaTimeChronoBasicWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicWeekyearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

OrgJodaTimeChronoBasicWeekyearDateTimeField *create_OrgJodaTimeChronoBasicWeekyearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicWeekyearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

id OrgJodaTimeChronoBasicWeekyearDateTimeField_readResolve(OrgJodaTimeChronoBasicWeekyearDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) weekyear];
}
