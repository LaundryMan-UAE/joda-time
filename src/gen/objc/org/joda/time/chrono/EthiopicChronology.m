...
- (jlong)getApproxMillisAtEpochDividedByTwo {
  return JreLongDiv((1962LL * OrgJodaTimeChronoBasicFixedMonthChronology_MILLIS_PER_YEAR + 112LL * OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY), 2);
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoEthiopicChronology class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeChronoEthiopicChronology_ERA_FIELD, new_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(@"EE"));
