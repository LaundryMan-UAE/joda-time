...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/ZonedChronology.java
//
...
inline jlong OrgJodaTimeChronoZonedChronology_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoZonedChronology_get_NEAR_ZERO(void);
...
inline jlong OrgJodaTimeChronoZonedChronology_ZonedDurationField_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoZonedChronology_ZonedDateTimeField_get_serialVersionUID(void);
...
- (jboolean)isEqual:(id)obj {
  if (self == obj) {
    ...
    OrgJodaTimeChronoZonedChronology_ZonedDurationField *other = (OrgJodaTimeChronoZonedChronology_ZonedDurationField *) obj;
...
- (jboolean)isEqual:(id)obj {
  if (self == obj) {
    ...
    OrgJodaTimeChronoZonedChronology_ZonedDateTimeField *other = (OrgJodaTimeChronoZonedChronology_ZonedDateTimeField *) obj;
