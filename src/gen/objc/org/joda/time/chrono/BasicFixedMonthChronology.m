...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/BasicFixedMonthChronology.java
//
...
inline jlong OrgJodaTimeChronoBasicFixedMonthChronology_get_serialVersionUID(void);
...
- (jint)getDayOfMonthWithLong:(jlong)millis {
  return JreIntMod(([self getDayOfYearWithLong:millis] - 1), OrgJodaTimeChronoBasicFixedMonthChronology_MONTH_LENGTH) + 1;
}
...
- (jint)getMonthOfYearWithLong:(jlong)millis {
  return JreIntDiv(([self getDayOfYearWithLong:millis] - 1), OrgJodaTimeChronoBasicFixedMonthChronology_MONTH_LENGTH) + 1;
}

- (jint)getMonthOfYearWithLong:(jlong)millis
                       withInt:(jint)year {
  jlong monthZeroBased = JreLongDiv((millis - [self getYearMillisWithInt:year]), OrgJodaTimeChronoBasicFixedMonthChronology_MILLIS_PER_MONTH);
...
- (jlong)getAverageMillisPerYearDividedByTwo {
  return JreLongDiv(OrgJodaTimeChronoBasicFixedMonthChronology_MILLIS_PER_YEAR, 2);
}
...
void OrgJodaTimeChronoBasicFixedMonthChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoBasicFixedMonthChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek) {
