...
inline jint OrgJodaTimeChronoBasicSingleEraDateTimeField_get_ERA_VALUE(void);
...
- (instancetype)initPackagePrivateWithNSString:(NSString *)text {
  OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(self, text);
  return self;
}
...
- (jint)getMaximumTextLengthWithJavaUtilLocale:(JavaUtilLocale *)locale {
  return [((NSString *) nil_chk(iEraText_)) java_length];
}
...
void OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(OrgJodaTimeChronoBasicSingleEraDateTimeField *self, NSString *text) {
...
OrgJodaTimeChronoBasicSingleEraDateTimeField *new_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(NSString *text) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicSingleEraDateTimeField, initPackagePrivateWithNSString_, text)
}

OrgJodaTimeChronoBasicSingleEraDateTimeField *create_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(NSString *text) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicSingleEraDateTimeField, initPackagePrivateWithNSString_, text)
}
