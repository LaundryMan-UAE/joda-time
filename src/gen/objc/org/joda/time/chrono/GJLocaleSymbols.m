...
static id<JavaUtilConcurrentConcurrentMap> OrgJodaTimeChronoGJLocaleSymbols_cCache_;
...
- (jint)monthOfYearTextToValueWithNSString:(NSString *)text {
  ...
  @throw [new_OrgJodaTimeIllegalFieldValueException_initWithOrgJodaTimeDateTimeFieldType_withNSString_(OrgJodaTimeDateTimeFieldType_monthOfYear(), text) autorelease];
}
...
- (jint)dayOfWeekTextToValueWithNSString:(NSString *)text {
  ...
  @throw [new_OrgJodaTimeIllegalFieldValueException_initWithOrgJodaTimeDateTimeFieldType_withNSString_(OrgJodaTimeDateTimeFieldType_dayOfWeek(), text) autorelease];
}
...
- (jint)halfdayTextToValueWithNSString:(NSString *)text {
  ...
  @throw [new_OrgJodaTimeIllegalFieldValueException_initWithOrgJodaTimeDateTimeFieldType_withNSString_(OrgJodaTimeDateTimeFieldType_halfdayOfDay(), text) autorelease];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "addSymbolsWithJavaUtilTreeMap:withNSStringArray:withJavaLangIntegerArray:", "addSymbols", "V", 0xa, NULL, NULL },
    { "addNumeralsWithJavaUtilTreeMap:withInt:withInt:withJavaLangIntegerArray:", "addNumerals", "V", 0xa, NULL, NULL },
...
OrgJodaTimeChronoGJLocaleSymbols *OrgJodaTimeChronoGJLocaleSymbols_forLocaleWithJavaUtilLocale_(JavaUtilLocale *locale) {
  ...
  if (symbols == nil) {
    symbols = [new_OrgJodaTimeChronoGJLocaleSymbols_initWithJavaUtilLocale_(locale) autorelease];
