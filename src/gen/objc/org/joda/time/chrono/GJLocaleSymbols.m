...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/GJLocaleSymbols.java
//
...
- (instancetype)initPackagePrivateWithJavaUtilLocale:(JavaUtilLocale *)locale;
...
inline id<JavaUtilConcurrentConcurrentMap> OrgJodaTimeChronoGJLocaleSymbols_get_cCache(void);
...
__attribute__((unused)) static void OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(OrgJodaTimeChronoGJLocaleSymbols *self, JavaUtilLocale *locale);

__attribute__((unused)) static OrgJodaTimeChronoGJLocaleSymbols *new_OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(JavaUtilLocale *locale) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeChronoGJLocaleSymbols *create_OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(JavaUtilLocale *locale);
...
- (instancetype)initPackagePrivateWithJavaUtilLocale:(JavaUtilLocale *)locale {
  OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(self, locale);
  return self;
}
...
- (jint)halfdayTextToValueWithNSString:(NSString *)text {
  ...
  for (jint i = ((IOSObjectArray *) nil_chk(halfday))->size_; --i >= 0; ) {
    if ([((NSString *) nil_chk(IOSObjectArray_Get(halfday, i))) java_equalsIgnoreCase:text]) {
      return i;
    }
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[6].selector = @selector(initPackagePrivateWithJavaUtilLocale:);
...
OrgJodaTimeChronoGJLocaleSymbols *OrgJodaTimeChronoGJLocaleSymbols_forLocaleWithJavaUtilLocale_(JavaUtilLocale *locale) {
  ...
  if (symbols == nil) {
    symbols = create_OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(locale);
...
void OrgJodaTimeChronoGJLocaleSymbols_addNumeralsWithJavaUtilTreeMap_withInt_withInt_withJavaLangIntegerArray_(JavaUtilTreeMap *map, jint start, jint end, IOSObjectArray *integers) {
  ...
  for (jint i = start; i <= end; i++) {
    [((JavaUtilTreeMap *) nil_chk(map)) putWithId:[((NSString *) nil_chk(NSString_java_valueOfInt_(i))) java_intern] withId:IOSObjectArray_Get(nil_chk(integers), i)];
  }
}
...
void OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(OrgJodaTimeChronoGJLocaleSymbols *self, JavaUtilLocale *locale) {
  NSObject_init(self);
...
OrgJodaTimeChronoGJLocaleSymbols *new_OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(JavaUtilLocale *locale) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJLocaleSymbols, initPackagePrivateWithJavaUtilLocale_, locale)
}

OrgJodaTimeChronoGJLocaleSymbols *create_OrgJodaTimeChronoGJLocaleSymbols_initPackagePrivateWithJavaUtilLocale_(JavaUtilLocale *locale) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJLocaleSymbols, initPackagePrivateWithJavaUtilLocale_, locale)
}
