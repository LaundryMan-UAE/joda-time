...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/BasicDayOfYearDateTimeField.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology
  ...
  OrgJodaTimeChronoBasicDayOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, chronology, days);
  return self;
}
...
void OrgJodaTimeChronoBasicDayOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicDayOfYearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
...
OrgJodaTimeChronoBasicDayOfYearDateTimeField *new_OrgJodaTimeChronoBasicDayOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicDayOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}

OrgJodaTimeChronoBasicDayOfYearDateTimeField *create_OrgJodaTimeChronoBasicDayOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicDayOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}
