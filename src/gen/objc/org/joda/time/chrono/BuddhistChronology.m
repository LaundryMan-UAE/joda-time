...
- (jboolean)isEqual:(id)obj {
  ...
  if ([obj isKindOfClass:[OrgJodaTimeChronoBuddhistChronology class]]) {
    OrgJodaTimeChronoBuddhistChronology *chrono = (OrgJodaTimeChronoBuddhistChronology *) obj;
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoBuddhistChronology class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeChronoBuddhistChronology_ERA_FIELD, new_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(@"BE"));
