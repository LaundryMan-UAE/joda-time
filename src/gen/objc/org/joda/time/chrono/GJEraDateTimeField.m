...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/GJEraDateTimeField.java
//
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology {
  OrgJodaTimeChronoGJEraDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(self, chronology);
  return self;
}
...
void OrgJodaTimeChronoGJEraDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoGJEraDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology) {
...
OrgJodaTimeChronoGJEraDateTimeField *new_OrgJodaTimeChronoGJEraDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJEraDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

OrgJodaTimeChronoGJEraDateTimeField *create_OrgJodaTimeChronoGJEraDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJEraDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}
