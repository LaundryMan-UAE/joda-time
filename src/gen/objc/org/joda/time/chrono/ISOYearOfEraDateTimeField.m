...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/ISOYearOfEraDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoISOYearOfEraDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate(OrgJodaTimeChronoISOYearOfEraDateTimeField *self);

__attribute__((unused)) static OrgJodaTimeChronoISOYearOfEraDateTimeField *new_OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeChronoISOYearOfEraDateTimeField *create_OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate(void);

__attribute__((unused)) static id OrgJodaTimeChronoISOYearOfEraDateTimeField_readResolve(OrgJodaTimeChronoISOYearOfEraDateTimeField *self);
...
- (instancetype)initPackagePrivate {
  OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate(self);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoISOYearOfEraDateTimeField_readResolve(self);
}
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoISOYearOfEraDateTimeField class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeChronoISOYearOfEraDateTimeField_INSTANCE, new_OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate());
...
void OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate(OrgJodaTimeChronoISOYearOfEraDateTimeField *self) {
...
OrgJodaTimeChronoISOYearOfEraDateTimeField *new_OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoISOYearOfEraDateTimeField, initPackagePrivate)
}

OrgJodaTimeChronoISOYearOfEraDateTimeField *create_OrgJodaTimeChronoISOYearOfEraDateTimeField_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoISOYearOfEraDateTimeField, initPackagePrivate)
}

id OrgJodaTimeChronoISOYearOfEraDateTimeField_readResolve(OrgJodaTimeChronoISOYearOfEraDateTimeField *self) {
