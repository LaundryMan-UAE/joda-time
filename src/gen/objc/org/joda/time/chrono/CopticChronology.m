...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/CopticChronology.java
//
...
- (jlong)getApproxMillisAtEpochDividedByTwo {
  return JreLongDiv((1686LL * OrgJodaTimeChronoBasicFixedMonthChronology_MILLIS_PER_YEAR + 112LL * OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY), 2);
}
...
- (void)assembleWithOrgJodaTimeChronoAssembledChronology_Fields:(OrgJodaTimeChronoAssembledChronology_Fields *)fields {
  if ([self getBase] == nil) {
    ...
    JreStrongAssignAndConsume(&fields->monthOfYear_, new_OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(self, 13));
...
+ (void)initialize {
  if (self == [OrgJodaTimeChronoCopticChronology class]) {
    JreStrongAssignAndConsume(&OrgJodaTimeChronoCopticChronology_ERA_FIELD, new_OrgJodaTimeChronoBasicSingleEraDateTimeField_initPackagePrivateWithNSString_(@"AM"));
...
void OrgJodaTimeChronoCopticChronology_initWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoCopticChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek) {
  OrgJodaTimeChronoBasicFixedMonthChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(self, base, param, minDaysInFirstWeek);
}
