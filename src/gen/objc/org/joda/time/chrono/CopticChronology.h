 ...
 */
inline jint OrgJodaTimeChronoCopticChronology_get_AM(void);
#define OrgJodaTimeChronoCopticChronology_AM 1
J2OBJC_STATIC_FIELD_CONSTANT(OrgJodaTimeChronoCopticChronology, AM, jint)

FOUNDATION_EXPORT OrgJodaTimeChronoCopticChronology *OrgJodaTimeChronoCopticChronology_getInstanceUTC(void);

FOUNDATION_EXPORT OrgJodaTimeChronoCopticChronology *OrgJodaTimeChronoCopticChronology_getInstance(void);
