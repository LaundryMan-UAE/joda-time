...
- (instancetype)initPackagePrivateWithOrgJodaTimeDateTimeField:(OrgJodaTimeDateTimeField *)yearField
  ...
  OrgJodaTimeChronoGJYearOfEraDateTimeField_initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_(self, yearField, chronology);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeDateTimeField:withOrgJodaTimeChronoBasicChronology:);
...
void OrgJodaTimeChronoGJYearOfEraDateTimeField_initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoGJYearOfEraDateTimeField *self, OrgJodaTimeDateTimeField *yearField, OrgJodaTimeChronoBasicChronology *chronology) {
...
OrgJodaTimeChronoGJYearOfEraDateTimeField *new_OrgJodaTimeChronoGJYearOfEraDateTimeField_initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_(OrgJodaTimeDateTimeField *yearField, OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJYearOfEraDateTimeField, initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_, yearField, chronology)
}

OrgJodaTimeChronoGJYearOfEraDateTimeField *create_OrgJodaTimeChronoGJYearOfEraDateTimeField_initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_(OrgJodaTimeDateTimeField *yearField, OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJYearOfEraDateTimeField, initPackagePrivateWithOrgJodaTimeDateTimeField_withOrgJodaTimeChronoBasicChronology_, yearField, chronology)
}
