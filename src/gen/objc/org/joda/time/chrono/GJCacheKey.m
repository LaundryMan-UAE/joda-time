...
- (instancetype)initPackagePrivateWithOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone
  ...
  OrgJodaTimeChronoGJCacheKey_initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_(self, zone, cutoverInstant, minDaysInFirstWeek);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initPackagePrivateWithOrgJodaTimeDateTimeZone:withOrgJodaTimeInstant:withInt:);
...
void OrgJodaTimeChronoGJCacheKey_initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_(OrgJodaTimeChronoGJCacheKey *self, OrgJodaTimeDateTimeZone *zone, OrgJodaTimeInstant *cutoverInstant, jint minDaysInFirstWeek) {
  NSObject_init(self);
...
OrgJodaTimeChronoGJCacheKey *new_OrgJodaTimeChronoGJCacheKey_initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_(OrgJodaTimeDateTimeZone *zone, OrgJodaTimeInstant *cutoverInstant, jint minDaysInFirstWeek) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJCacheKey, initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_, zone, cutoverInstant, minDaysInFirstWeek)
}

OrgJodaTimeChronoGJCacheKey *create_OrgJodaTimeChronoGJCacheKey_initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_(OrgJodaTimeDateTimeZone *zone, OrgJodaTimeInstant *cutoverInstant, jint minDaysInFirstWeek) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJCacheKey, initPackagePrivateWithOrgJodaTimeDateTimeZone_withOrgJodaTimeInstant_withInt_, zone, cutoverInstant, minDaysInFirstWeek)
}
