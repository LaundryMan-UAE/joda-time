...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/JulianChronology.java
//
...
inline jlong OrgJodaTimeChronoJulianChronology_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoJulianChronology_get_MILLIS_PER_YEAR(void);
...
inline jlong OrgJodaTimeChronoJulianChronology_get_MILLIS_PER_MONTH(void);
...
inline jint OrgJodaTimeChronoJulianChronology_get_MIN_YEAR(void);
...
inline jint OrgJodaTimeChronoJulianChronology_get_MAX_YEAR(void);
...
inline OrgJodaTimeChronoJulianChronology *OrgJodaTimeChronoJulianChronology_get_INSTANCE_UTC(void);
...
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeChronoJulianChronology_get_cCache(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoJulianChronology_readResolve(OrgJodaTimeChronoJulianChronology *self);
...
- (id)readResolve {
  return OrgJodaTimeChronoJulianChronology_readResolve(self);
}
...
- (jlong)getAverageMillisPerYearDividedByTwo {
  return JreLongDiv(OrgJodaTimeChronoJulianChronology_MILLIS_PER_YEAR, 2);
}
...
- (jlong)getApproxMillisAtEpochDividedByTwo {
  return JreLongDiv((1969LL * OrgJodaTimeChronoJulianChronology_MILLIS_PER_YEAR + 352LL * OrgJodaTimeDateTimeConstants_MILLIS_PER_DAY), 2);
}
    ...
    @synchronized(chronos) {
      ...
      if (chrono == nil) {
        if (zone == JreLoadStatic(OrgJodaTimeDateTimeZone, UTC)) {
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoJulianChronology_initWithOrgJodaTimeChronology_withId_withInt_(nil, nil, minDaysInFirstWeek));
        }
        else {
          chrono = JreRetainedLocalValue(OrgJodaTimeChronoJulianChronology_getInstanceWithOrgJodaTimeDateTimeZone_withInt_(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC), minDaysInFirstWeek));
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoJulianChronology_initWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoZonedChronology_getInstanceWithOrgJodaTimeChronology_withOrgJodaTimeDateTimeZone_(chrono, zone), nil, minDaysInFirstWeek));
        }
...
id OrgJodaTimeChronoJulianChronology_readResolve(OrgJodaTimeChronoJulianChronology *self) {
