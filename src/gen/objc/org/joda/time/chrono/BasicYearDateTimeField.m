...
inline jlong OrgJodaTimeChronoBasicYearDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoBasicYearDateTimeField_readResolve(OrgJodaTimeChronoBasicYearDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology {
  OrgJodaTimeChronoBasicYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(self, chronology);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoBasicYearDateTimeField_readResolve(self);
}
...
void OrgJodaTimeChronoBasicYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicYearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology) {
...
OrgJodaTimeChronoBasicYearDateTimeField *new_OrgJodaTimeChronoBasicYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoBasicYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

OrgJodaTimeChronoBasicYearDateTimeField *create_OrgJodaTimeChronoBasicYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoBasicYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

id OrgJodaTimeChronoBasicYearDateTimeField_readResolve(OrgJodaTimeChronoBasicYearDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) year];
}
