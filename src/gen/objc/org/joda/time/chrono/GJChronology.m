 ...
 */
inline jlong OrgJodaTimeChronoGJChronology_get_serialVersionUID(void);
...
/*!
 @brief Cache of zone to chronology list
 */
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeChronoGJChronology_get_cCache(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoGJChronology_readResolve(OrgJodaTimeChronoGJChronology *self);
...
inline jlong OrgJodaTimeChronoGJChronology_CutoverField_get_serialVersionUID(void);
...
/*!
 @brief Cutover field for variable length fields.These fields internally call
  set whenever add is called.
 As a result, the same correction applied to
...
inline jlong OrgJodaTimeChronoGJChronology_ImpreciseCutoverField_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoGJChronology_LinkedDurationField_get_serialVersionUID(void);
...
- (id)readResolve {
  return OrgJodaTimeChronoGJChronology_readResolve(self);
}
...
id OrgJodaTimeChronoGJChronology_readResolve(OrgJodaTimeChronoGJChronology *self) {
  return OrgJodaTimeChronoGJChronology_getInstanceWithOrgJodaTimeDateTimeZone_withOrgJodaTimeReadableInstant_withInt_([self getZone], self->iCutoverInstant_, [self getMinimumDaysInFirstWeek]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgJodaTimeDateTimeField;LOrgJodaTimeDateTimeField;J", "LOrgJodaTimeDateTimeField;LOrgJodaTimeDateTimeField;LOrgJodaTimeDurationField;J", "LOrgJodaTimeDateTimeField;LOrgJodaTimeDateTimeField;LOrgJodaTimeDurationField;LOrgJodaTimeDurationField;J", "LOrgJodaTimeDateTimeField;LOrgJodaTimeDateTimeField;LOrgJodaTimeDurationField;JZ", "add", "JI", "JJ", "getDifference", "getDifferenceAsLong", "getMinimumValue", "J", "getMaximumValue", "LOrgJodaTimeChronoGJChronology;" };
