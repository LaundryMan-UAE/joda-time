...
inline jlong OrgJodaTimeChronoGregorianChronology_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeChronoGregorianChronology_get_MILLIS_PER_YEAR(void);
...
inline jlong OrgJodaTimeChronoGregorianChronology_get_MILLIS_PER_MONTH(void);
...
inline jint OrgJodaTimeChronoGregorianChronology_get_DAYS_0000_TO_1970(void);
...
inline jint OrgJodaTimeChronoGregorianChronology_get_MIN_YEAR(void);
...
inline jint OrgJodaTimeChronoGregorianChronology_get_MAX_YEAR(void);
...
inline OrgJodaTimeChronoGregorianChronology *OrgJodaTimeChronoGregorianChronology_get_INSTANCE_UTC(void);
...
inline JavaUtilConcurrentConcurrentHashMap *OrgJodaTimeChronoGregorianChronology_get_cCache(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoGregorianChronology_readResolve(OrgJodaTimeChronoGregorianChronology *self);
...
- (id)readResolve {
  return OrgJodaTimeChronoGregorianChronology_readResolve(self);
}
...
- (jboolean)isLeapYearWithInt:(jint)year {
  return ((year & 3) == 0) && ((JreIntMod(year, 100)) != 0 || (JreIntMod(year, 400)) == 0);
}

- (jlong)calculateFirstDayOfYearMillisWithInt:(jint)year {
  jint leapYears = JreIntDiv(year, 100);
  if (year < 0) {
...
- (jlong)getAverageMillisPerYearDividedByTwo {
  return JreLongDiv(OrgJodaTimeChronoGregorianChronology_MILLIS_PER_YEAR, 2);
}
...
- (jlong)getApproxMillisAtEpochDividedByTwo {
  return JreLongDiv((1970LL * OrgJodaTimeChronoGregorianChronology_MILLIS_PER_YEAR), 2);
}
    ...
    @synchronized(chronos) {
      ...
      if (chrono == nil) {
        if (zone == JreLoadStatic(OrgJodaTimeDateTimeZone, UTC)) {
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoGregorianChronology_initWithOrgJodaTimeChronology_withId_withInt_(nil, nil, minDaysInFirstWeek));
        }
        else {
          chrono = JreRetainedLocalValue(OrgJodaTimeChronoGregorianChronology_getInstanceWithOrgJodaTimeDateTimeZone_withInt_(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC), minDaysInFirstWeek));
          chrono = JreRetainedLocalValue(create_OrgJodaTimeChronoGregorianChronology_initWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoZonedChronology_getInstanceWithOrgJodaTimeChronology_withOrgJodaTimeDateTimeZone_(chrono, zone), nil, minDaysInFirstWeek));
        }
...
void OrgJodaTimeChronoGregorianChronology_initWithOrgJodaTimeChronology_withId_withInt_(OrgJodaTimeChronoGregorianChronology *self, OrgJodaTimeChronology *base, id param, jint minDaysInFirstWeek) {
  OrgJodaTimeChronoBasicGJChronology_initPackagePrivateWithOrgJodaTimeChronology_withId_withInt_(self, base, param, minDaysInFirstWeek);
}
...
id OrgJodaTimeChronoGregorianChronology_readResolve(OrgJodaTimeChronoGregorianChronology *self) {
