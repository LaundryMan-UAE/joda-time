...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/GJDayOfWeekDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoGJDayOfWeekDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeChronoGJDayOfWeekDateTimeField_readResolve(OrgJodaTimeChronoGJDayOfWeekDateTimeField *self);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology
  ...
  OrgJodaTimeChronoGJDayOfWeekDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(self, chronology, days);
  return self;
}
...
- (id)readResolve {
  return OrgJodaTimeChronoGJDayOfWeekDateTimeField_readResolve(self);
}
...
void OrgJodaTimeChronoGJDayOfWeekDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoGJDayOfWeekDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
...
OrgJodaTimeChronoGJDayOfWeekDateTimeField *new_OrgJodaTimeChronoGJDayOfWeekDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJDayOfWeekDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}

OrgJodaTimeChronoGJDayOfWeekDateTimeField *create_OrgJodaTimeChronoGJDayOfWeekDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_(OrgJodaTimeChronoBasicChronology *chronology, OrgJodaTimeDurationField *days) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJDayOfWeekDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withOrgJodaTimeDurationField_, chronology, days)
}

id OrgJodaTimeChronoGJDayOfWeekDateTimeField_readResolve(OrgJodaTimeChronoGJDayOfWeekDateTimeField *self) {
  return [((OrgJodaTimeChronoBasicChronology *) nil_chk(self->iChronology_)) dayOfWeek];
}
