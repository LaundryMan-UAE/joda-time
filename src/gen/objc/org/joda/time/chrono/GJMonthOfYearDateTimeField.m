...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/chrono/GJMonthOfYearDateTimeField.java
//
...
inline jlong OrgJodaTimeChronoGJMonthOfYearDateTimeField_get_serialVersionUID(void);
...
- (instancetype)initPackagePrivateWithOrgJodaTimeChronoBasicChronology:(OrgJodaTimeChronoBasicChronology *)chronology {
  OrgJodaTimeChronoGJMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(self, chronology);
  return self;
}
...
void OrgJodaTimeChronoGJMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoGJMonthOfYearDateTimeField *self, OrgJodaTimeChronoBasicChronology *chronology) {
  OrgJodaTimeChronoBasicMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_withInt_(self, chronology, 2);
}

OrgJodaTimeChronoGJMonthOfYearDateTimeField *new_OrgJodaTimeChronoGJMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_NEW_IMPL(OrgJodaTimeChronoGJMonthOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}

OrgJodaTimeChronoGJMonthOfYearDateTimeField *create_OrgJodaTimeChronoGJMonthOfYearDateTimeField_initPackagePrivateWithOrgJodaTimeChronoBasicChronology_(OrgJodaTimeChronoBasicChronology *chronology) {
  J2OBJC_CREATE_IMPL(OrgJodaTimeChronoGJMonthOfYearDateTimeField, initPackagePrivateWithOrgJodaTimeChronoBasicChronology_, chronology)
}
