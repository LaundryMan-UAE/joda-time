...
inline OrgJodaTimeFormatPeriodFormatter *OrgJodaTimeMonths_get_PARSER(void);
...
inline jlong OrgJodaTimeMonths_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeMonths_readResolve(OrgJodaTimeMonths *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMonths__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMonths__Annotations$1(void);
...
- (id)readResolve {
  return OrgJodaTimeMonths_readResolve(self);
}
...
- (OrgJodaTimeMonths *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeMonths_monthsWithInt_(JreIntDiv([self getValue], divisor));
}
...
- (NSString *)description {
  return JreStrcat("C$C", 'P', NSString_java_valueOfInt_([self getValue]), 'M');
}
...
id OrgJodaTimeMonths_readResolve(OrgJodaTimeMonths *self) {
