...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/Days.java
//
...
inline OrgJodaTimeFormatPeriodFormatter *OrgJodaTimeDays_get_PARSER(void);
...
inline jlong OrgJodaTimeDays_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeDays_readResolve(OrgJodaTimeDays *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeDays__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeDays__Annotations$1(void);
...
- (id)readResolve {
  return OrgJodaTimeDays_readResolve(self);
}
...
- (OrgJodaTimeWeeks *)toStandardWeeks {
  return OrgJodaTimeWeeks_weeksWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_DAYS_PER_WEEK));
}
...
- (OrgJodaTimeDays *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeDays_daysWithInt_(JreIntDiv([self getValue], divisor));
}
...
- (NSString *)description {
  return JreStrcat("C$C", 'P', NSString_java_valueOfInt_([self getValue]), 'D');
}
...
id OrgJodaTimeDays_readResolve(OrgJodaTimeDays *self) {
