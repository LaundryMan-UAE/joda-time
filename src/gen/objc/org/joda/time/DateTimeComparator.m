...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/DateTimeComparator.java
//
...
inline jlong OrgJodaTimeDateTimeComparator_get_serialVersionUID(void);
...
inline OrgJodaTimeDateTimeComparator *OrgJodaTimeDateTimeComparator_get_ALL_INSTANCE(void);
...
inline OrgJodaTimeDateTimeComparator *OrgJodaTimeDateTimeComparator_get_DATE_INSTANCE(void);
...
inline OrgJodaTimeDateTimeComparator *OrgJodaTimeDateTimeComparator_get_TIME_INSTANCE(void);
...
__attribute__((unused)) static id OrgJodaTimeDateTimeComparator_readResolve(OrgJodaTimeDateTimeComparator *self);
...
- (id)readResolve {
  return OrgJodaTimeDateTimeComparator_readResolve(self);
}

- (jboolean)isEqual:(id)object {
  if ([object isKindOfClass:[OrgJodaTimeDateTimeComparator class]]) {
    OrgJodaTimeDateTimeComparator *other = (OrgJodaTimeDateTimeComparator *) object;
...
id OrgJodaTimeDateTimeComparator_readResolve(OrgJodaTimeDateTimeComparator *self) {
  return OrgJodaTimeDateTimeComparator_getInstanceWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDateTimeFieldType_(self->iLowerLimit_, self->iUpperLimit_);
}
