...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/DateTimeUtils.java
//
...
inline id<OrgJodaTimeDateTimeUtils_MillisProvider> OrgJodaTimeDateTimeUtils_get_SYSTEM_MILLIS_PROVIDER(void);
...
FOUNDATION_EXPORT OrgJodaTimeDateTimeUtils *new_OrgJodaTimeDateTimeUtils_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeDateTimeUtils *create_OrgJodaTimeDateTimeUtils_init(void);

FOUNDATION_EXPORT jlong OrgJodaTimeDateTimeUtils_currentTimeMillis(void);

FOUNDATION_EXPORT void OrgJodaTimeDateTimeUtils_setCurrentMillisSystem(void);
...
FOUNDATION_EXPORT id<JavaUtilMap> OrgJodaTimeDateTimeUtils_getDefaultTimeZoneNames(void);
...
FOUNDATION_EXPORT OrgJodaTimeDateTimeUtils_SystemMillisProvider *new_OrgJodaTimeDateTimeUtils_SystemMillisProvider_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeDateTimeUtils_SystemMillisProvider *create_OrgJodaTimeDateTimeUtils_SystemMillisProvider_init(void);
