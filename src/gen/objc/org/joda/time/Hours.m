...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/Hours.java
//
...
inline OrgJodaTimeFormatPeriodFormatter *OrgJodaTimeHours_get_PARSER(void);
...
inline jlong OrgJodaTimeHours_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeHours_readResolve(OrgJodaTimeHours *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeHours__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeHours__Annotations$1(void);
...
- (id)readResolve {
  return OrgJodaTimeHours_readResolve(self);
}
...
- (OrgJodaTimeWeeks *)toStandardWeeks {
  return OrgJodaTimeWeeks_weeksWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_HOURS_PER_WEEK));
}

- (OrgJodaTimeDays *)toStandardDays {
  return OrgJodaTimeDays_daysWithInt_(JreIntDiv([self getValue], OrgJodaTimeDateTimeConstants_HOURS_PER_DAY));
}
...
- (OrgJodaTimeHours *)dividedByWithInt:(jint)divisor {
  ...
  return OrgJodaTimeHours_hoursWithInt_(JreIntDiv([self getValue], divisor));
}
...
- (NSString *)description {
  return JreStrcat("$$C", @"PT", NSString_java_valueOfInt_([self getValue]), 'H');
}
...
id OrgJodaTimeHours_readResolve(OrgJodaTimeHours *self) {
