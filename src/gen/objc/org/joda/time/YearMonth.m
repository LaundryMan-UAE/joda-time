...
inline jlong OrgJodaTimeYearMonth_get_serialVersionUID(void);
...
inline IOSObjectArray *OrgJodaTimeYearMonth_get_FIELD_TYPES(void);
...
__attribute__((unused)) static id OrgJodaTimeYearMonth_readResolve(OrgJodaTimeYearMonth *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeYearMonth__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeYearMonth__Annotations$1(void);
...
inline jlong OrgJodaTimeYearMonth_Property_get_serialVersionUID(void);
...
- (id)readResolve {
  return OrgJodaTimeYearMonth_readResolve(self);
}
...
- (IOSObjectArray *)getFieldTypes {
  return [((IOSObjectArray *) nil_chk(OrgJodaTimeYearMonth_FIELD_TYPES)) java_clone];
}
...
id OrgJodaTimeYearMonth_readResolve(OrgJodaTimeYearMonth *self) {
