...
//  source: /Users/marcussmith/temp/joda-time/src/main/java/org/joda/time/DateTimeField.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "J", 0x401, 16, 17, -1, -1, -1, -1 },
    { NULL, "J", 0x401, 16, 18, -1, -1, -1, -1 },
    { NULL, "[I", 0x401, 16, 19, -1, -1, -1, -1 },
    { NULL, "LOrgJodaTimeDurationField;", 0x401, -1, -1, -1, -1, -1, -1 },
    { NULL, "LOrgJodaTimeDurationField;", 0x401, -1, -1, -1, -1, -1, -1 },
    { NULL, "Z", 0x401, 20, 1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 21, 1, -1, -1, -1, -1 },
    { NULL, "LOrgJodaTimeDurationField;", 0x401, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 22, 1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 22, 23, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 22, 24, -1, -1, -1, -1 },
    { NULL, "I", 0x401, -1, -1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 25, 1, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 25, 23, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 25, 24, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 26, 27, -1, -1, -1, -1 },
    { NULL, "I", 0x401, 28, 27, -1, -1, -1, -1 },
    { NULL, "J", 0x401, 29, 1, -1, -1, -1, -1 },
    ...
    { NULL, "LNSString;", 0x401, 35, -1, -1, -1, -1, -1 },
  };
  ...
  methods[4].selector = @selector(isLenient);
  methods[5].selector = @selector(getWithLong:);
  methods[6].selector = @selector(getAsTextWithLong:withJavaUtilLocale:);
  methods[7].selector = @selector(getAsTextWithLong:);
  methods[8].selector = @selector(getAsTextWithOrgJodaTimeReadablePartial:withInt:withJavaUtilLocale:);
  methods[9].selector = @selector(getAsTextWithOrgJodaTimeReadablePartial:withJavaUtilLocale:);
  methods[10].selector = @selector(getAsTextWithInt:withJavaUtilLocale:);
  methods[11].selector = @selector(getAsShortTextWithLong:withJavaUtilLocale:);
  methods[12].selector = @selector(getAsShortTextWithLong:);
  methods[13].selector = @selector(getAsShortTextWithOrgJodaTimeReadablePartial:withInt:withJavaUtilLocale:);
  methods[14].selector = @selector(getAsShortTextWithOrgJodaTimeReadablePartial:withJavaUtilLocale:);
  methods[15].selector = @selector(getAsShortTextWithInt:withJavaUtilLocale:);
  methods[16].selector = @selector(addWithLong:withInt:);
  methods[17].selector = @selector(addWithLong:withLong:);
  methods[18].selector = @selector(addWithOrgJodaTimeReadablePartial:withInt:withIntArray:withInt:);
  methods[19].selector = @selector(addWrapPartialWithOrgJodaTimeReadablePartial:withInt:withIntArray:withInt:);
  methods[20].selector = @selector(addWrapFieldWithLong:withInt:);
  methods[21].selector = @selector(addWrapFieldWithOrgJodaTimeReadablePartial:withInt:withIntArray:withInt:);
  methods[22].selector = @selector(getDifferenceWithLong:withLong:);
  methods[23].selector = @selector(getDifferenceAsLongWithLong:withLong:);
  methods[24].selector = @selector(setWithLong:withInt:);
  ...
  static const void *ptrTable[] = { "get", "J", "getAsText", "JLJavaUtilLocale;", "LOrgJodaTimeReadablePartial;ILJavaUtilLocale;", "LOrgJodaTimeReadablePartial;LJavaUtilLocale;", "ILJavaUtilLocale;", "getAsShortText", "add", "JI", "JJ", "LOrgJodaTimeReadablePartial;I[II", "addWrapPartial", "addWrapField", "getDifference", "getDifferenceAsLong", "set", "JLNSString;LJavaUtilLocale;", "JLNSString;", "LOrgJodaTimeReadablePartial;I[ILNSString;LJavaUtilLocale;", "isLeap", "getLeapAmount", "getMinimumValue", "LOrgJodaTimeReadablePartial;", "LOrgJodaTimeReadablePartial;[I", "getMaximumValue", "getMaximumTextLength", "LJavaUtilLocale;", "getMaximumShortTextLength", "roundFloor", "roundCeiling", "roundHalfFloor", "roundHalfCeiling", "roundHalfEven", "remainder", "toString" };
  static const J2ObjcClassInfo _OrgJodaTimeDateTimeField = { "DateTimeField", "org.joda.time", ptrTable, methods, NULL, 7, 0x401, 51, 0, -1, -1, -1, -1, -1 };
