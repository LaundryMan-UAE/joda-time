 ...
 */
inline jlong OrgJodaTimeDateMidnight_get_serialVersionUID(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeDateMidnight__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeDateMidnight__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeDateMidnight__Annotations$2(void);
...
/*!
 @brief Serialization lock
 */
inline jlong OrgJodaTimeDateMidnight_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeDateMidnight_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeDateMidnight_Property *self, JavaIoObjectOutputStream *oos);

__attribute__((unused)) static void OrgJodaTimeDateMidnight_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeDateMidnight_Property *self, JavaIoObjectInputStream *oos);
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)oos {
  OrgJodaTimeDateMidnight_Property_writeObjectWithJavaIoObjectOutputStream_(self, oos);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  OrgJodaTimeDateMidnight_Property_readObjectWithJavaIoObjectInputStream_(self, oos);
}
...
void OrgJodaTimeDateMidnight_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeDateMidnight_Property *self, JavaIoObjectOutputStream *oos) {
...
void OrgJodaTimeDateMidnight_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeDateMidnight_Property *self, JavaIoObjectInputStream *oos) {
  JreStrongAssign(&self->iInstant_, (OrgJodaTimeDateMidnight *) cast_chk([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeDateMidnight class]));
  ...
  JreStrongAssign(&self->iField_, [((OrgJodaTimeDateTimeFieldType *) nil_chk(type)) getFieldWithOrgJodaTimeChronology:[((OrgJodaTimeDateMidnight *) nil_chk(self->iInstant_)) getChronology]]);
}
