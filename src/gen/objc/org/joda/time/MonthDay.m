...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/MonthDay.java
//
...
inline jlong OrgJodaTimeMonthDay_get_serialVersionUID(void);
...
inline IOSObjectArray *OrgJodaTimeMonthDay_get_FIELD_TYPES(void);
...
inline OrgJodaTimeFormatDateTimeFormatter *OrgJodaTimeMonthDay_get_PARSER(void);
...
__attribute__((unused)) static id OrgJodaTimeMonthDay_readResolve(OrgJodaTimeMonthDay *self);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMonthDay__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMonthDay__Annotations$1(void);
...
inline jlong OrgJodaTimeMonthDay_Property_get_serialVersionUID(void);
...
- (id)readResolve {
  return OrgJodaTimeMonthDay_readResolve(self);
}
...
- (IOSObjectArray *)getFieldTypes {
  return [((IOSObjectArray *) nil_chk(OrgJodaTimeMonthDay_FIELD_TYPES)) java_clone];
}
...
OrgJodaTimeMonthDay *OrgJodaTimeMonthDay_fromCalendarFieldsWithJavaUtilCalendar_(JavaUtilCalendar *calendar) {
  ...
  return create_OrgJodaTimeMonthDay_initWithInt_withInt_([calendar getWithInt:JavaUtilCalendar_MONTH] + 1, [calendar getWithInt:JavaUtilCalendar_DAY_OF_MONTH]);
}
...
OrgJodaTimeMonthDay *OrgJodaTimeMonthDay_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeMonthDay_initWithInt_withInt_([date getMonth] + 1, [date getDate]);
}
...
id OrgJodaTimeMonthDay_readResolve(OrgJodaTimeMonthDay *self) {
