 ...
 */
inline jlong OrgJodaTimePartial_get_serialVersionUID(void);
...
/*!
 @brief Serialization version
 */
inline jlong OrgJodaTimePartial_Property_get_serialVersionUID(void);
...
- (IOSObjectArray *)getFieldTypes {
  return [((IOSObjectArray *) nil_chk(iTypes_)) java_clone];
}
