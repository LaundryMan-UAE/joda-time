...
/*!
 ...
 <p>
  ...
  available precise field.
 @param duration the duration, in milliseconds
 @throw ArithmeticExceptionif the set exceeds the capacity of the period
 */
...
- (instancetype)initWithIntArray:(IOSIntArray *)arg0
       withOrgJodaTimePeriodType:(OrgJodaTimePeriodType *)arg1 NS_UNAVAILABLE;

- (instancetype)initWithOrgJodaTimeReadablePartial:(id<OrgJodaTimeReadablePartial>)arg0
                    withOrgJodaTimeReadablePartial:(id<OrgJodaTimeReadablePartial>)arg1
                         withOrgJodaTimePeriodType:(OrgJodaTimePeriodType *)arg2 NS_UNAVAILABLE;
...
FOUNDATION_EXPORT OrgJodaTimeMutablePeriod *new_OrgJodaTimeMutablePeriod_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJodaTimeMutablePeriod *create_OrgJodaTimeMutablePeriod_init(void);
