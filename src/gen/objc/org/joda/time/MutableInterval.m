 ...
 */
inline jlong OrgJodaTimeMutableInterval_get_serialVersionUID(void);
...
- (OrgJodaTimeMutableInterval *)copy__ {
  return (OrgJodaTimeMutableInterval *) cast_chk([self java_clone], [OrgJodaTimeMutableInterval class]);
}
