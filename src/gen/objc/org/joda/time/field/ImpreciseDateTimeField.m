...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/ImpreciseDateTimeField.java
//
...
inline jlong OrgJodaTimeFieldImpreciseDateTimeField_get_serialVersionUID(void);
...
inline jlong OrgJodaTimeFieldImpreciseDateTimeField_LinkedDurationField_get_serialVersionUID(void);
...
- (jlong)getDifferenceAsLongWithLong:(jlong)minuendInstant
  ...
  jlong difference = JreLongDiv((minuendInstant - subtrahendInstant), iUnitMillis_);
