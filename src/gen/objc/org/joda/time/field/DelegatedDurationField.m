...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/DelegatedDurationField.java
//
...
inline jlong OrgJodaTimeFieldDelegatedDurationField_get_serialVersionUID(void);
...
- (jboolean)isEqual:(id)obj {
  if ([obj isKindOfClass:[OrgJodaTimeFieldDelegatedDurationField class]]) {
    return [((OrgJodaTimeDurationField *) nil_chk(iField_)) isEqual:((OrgJodaTimeFieldDelegatedDurationField *) nil_chk(((OrgJodaTimeFieldDelegatedDurationField *) obj)))->iField_];
  }
  return false;
}
...
void OrgJodaTimeFieldDelegatedDurationField_initWithOrgJodaTimeDurationField_withOrgJodaTimeDurationFieldType_(OrgJodaTimeFieldDelegatedDurationField *self, OrgJodaTimeDurationField *field, OrgJodaTimeDurationFieldType *type) {
  ...
  JreStrongAssign(&self->iType_, (type == nil ? [field getType] : type));
}
