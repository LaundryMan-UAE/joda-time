...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/ScaledDurationField.java
//
...
inline jlong OrgJodaTimeFieldScaledDurationField_get_serialVersionUID(void);
...
- (jint)getValueWithLong:(jlong)duration {
  return JreIntDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getValueWithLong:duration], iScalar_);
}

- (jlong)getValueAsLongWithLong:(jlong)duration {
  return JreLongDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getValueAsLongWithLong:duration], iScalar_);
}

- (jint)getValueWithLong:(jlong)duration
                withLong:(jlong)instant {
  return JreIntDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getValueWithLong:duration withLong:instant], iScalar_);
}

- (jlong)getValueAsLongWithLong:(jlong)duration
                       withLong:(jlong)instant {
  return JreLongDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getValueAsLongWithLong:duration withLong:instant], iScalar_);
}
...
- (jint)getDifferenceWithLong:(jlong)minuendInstant
  ...
  return JreIntDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getDifferenceWithLong:minuendInstant withLong:subtrahendInstant], iScalar_);
}

- (jlong)getDifferenceAsLongWithLong:(jlong)minuendInstant
                            withLong:(jlong)subtrahendInstant {
  return JreLongDiv([((OrgJodaTimeDurationField *) nil_chk([self getWrappedField])) getDifferenceAsLongWithLong:minuendInstant withLong:subtrahendInstant], iScalar_);
}
...
- (jboolean)isEqual:(id)obj {
  if (self == obj) {
    ...
    OrgJodaTimeFieldScaledDurationField *other = (OrgJodaTimeFieldScaledDurationField *) obj;
