...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/PreciseDurationDateTimeField.java
//
...
inline jlong OrgJodaTimeFieldPreciseDurationDateTimeField_get_serialVersionUID(void);
...
- (jlong)roundFloorWithLong:(jlong)instant {
  if (instant >= 0) {
    return instant - JreLongMod(instant, iUnitMillis_);
  }
  else {
    instant += 1;
    return instant - JreLongMod(instant, iUnitMillis_) - iUnitMillis_;
  }
}
...
- (jlong)remainderWithLong:(jlong)instant {
  if (instant >= 0) {
    return JreLongMod(instant, iUnitMillis_);
  }
  else {
    return JreLongMod((instant + 1), iUnitMillis_) + iUnitMillis_ - 1;
  }
}
