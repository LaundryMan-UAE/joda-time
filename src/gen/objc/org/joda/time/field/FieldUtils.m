...
+ (jlong)safeDivideWithLong:(jlong)dividend
  ...
  return OrgJodaTimeFieldFieldUtils_safeDivideWithLong_withLong_withJavaMathRoundingMode_(dividend, divisor, roundingMode);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[9].selector = @selector(safeDivideWithLong:withLong:withJavaMathRoundingMode:);
  methods[10].selector = @selector(safeToIntWithLong:);
  methods[11].selector = @selector(safeMultiplyToIntWithLong:withLong:);
  methods[12].selector = @selector(verifyValueBoundsWithOrgJodaTimeDateTimeField:withInt:withInt:withInt:);
  methods[13].selector = @selector(verifyValueBoundsWithOrgJodaTimeDateTimeFieldType:withInt:withInt:withInt:);
  methods[14].selector = @selector(verifyValueBoundsWithNSString:withInt:withInt:withInt:);
  methods[15].selector = @selector(getWrappedValueWithInt:withInt:withInt:withInt:);
  methods[16].selector = @selector(getWrappedValueWithInt:withInt:withInt:);
  methods[17].selector = @selector(equalsWithId:withId:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "safeNegate", "I", "safeAdd", "II", "JJ", "safeSubtract", "safeMultiply", "JI", "safeDivide", "JJLJavaMathRoundingMode;", "safeToInt", "J", "safeMultiplyToInt", "verifyValueBounds", "LOrgJodaTimeDateTimeField;III", "LOrgJodaTimeDateTimeFieldType;III", "LNSString;III", "getWrappedValue", "IIII", "III", "equals", "LNSObject;LNSObject;" };
  static const J2ObjcClassInfo _OrgJodaTimeFieldFieldUtils = { "FieldUtils", "org.joda.time.field", ptrTable, methods, NULL, 7, 0x1, 18, 0, -1, -1, -1, -1, -1 };
...
jlong OrgJodaTimeFieldFieldUtils_safeMultiplyWithLong_withLong_(jlong val1, jlong val2) {
  ...
  jlong total = val1 * val2;
  if (JreLongDiv(total, val2) != val1 || (val1 == JavaLangLong_MIN_VALUE && val2 == -1) || (val2 == JavaLangLong_MIN_VALUE && val1 == -1)) {
...
jlong OrgJodaTimeFieldFieldUtils_safeDivideWithLong_withLong_(jlong dividend, jlong divisor) {
  ...
  return JreLongDiv(dividend, divisor);
}

jlong OrgJodaTimeFieldFieldUtils_safeDivideWithLong_withLong_withJavaMathRoundingMode_(jlong dividend, jlong divisor, JavaMathRoundingMode *roundingMode) {
  OrgJodaTimeFieldFieldUtils_initialize();
  if (dividend == JavaLangLong_MIN_VALUE && divisor == -1LL) {
    @throw create_JavaLangArithmeticException_initWithNSString_(JreStrcat("$J$J", @"Multiplication overflows a long: ", dividend, @" / ", divisor));
  }
  JavaMathBigDecimal *dividendBigDecimal = create_JavaMathBigDecimal_initWithLong_(dividend);
  JavaMathBigDecimal *divisorBigDecimal = create_JavaMathBigDecimal_initWithLong_(divisor);
  return [((JavaMathBigDecimal *) nil_chk([dividendBigDecimal divideWithJavaMathBigDecimal:divisorBigDecimal withJavaMathRoundingMode:roundingMode])) longLongValue];
}
...
jint OrgJodaTimeFieldFieldUtils_getWrappedValueWithInt_withInt_withInt_(jint value, jint minValue, jint maxValue) {
  ...
  value -= minValue;
  if (value >= 0) {
    return (JreIntMod(value, wrapRange)) + minValue;
  }
  jint remByRange = JreIntMod((-value), wrapRange);
  if (remByRange == 0) {
    return 0 + minValue;
  }
