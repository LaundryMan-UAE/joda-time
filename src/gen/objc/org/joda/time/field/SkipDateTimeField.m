...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/SkipDateTimeField.java
//
...
inline jlong OrgJodaTimeFieldSkipDateTimeField_get_serialVersionUID(void);
...
__attribute__((unused)) static id OrgJodaTimeFieldSkipDateTimeField_readResolve(OrgJodaTimeFieldSkipDateTimeField *self);
...
- (id)readResolve {
  return OrgJodaTimeFieldSkipDateTimeField_readResolve(self);
}
...
id OrgJodaTimeFieldSkipDateTimeField_readResolve(OrgJodaTimeFieldSkipDateTimeField *self) {
