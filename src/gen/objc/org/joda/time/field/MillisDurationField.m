...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/MillisDurationField.java
//
...
inline jlong OrgJodaTimeFieldMillisDurationField_get_serialVersionUID(void);
...
__attribute__((unused)) static OrgJodaTimeFieldMillisDurationField *new_OrgJodaTimeFieldMillisDurationField_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgJodaTimeFieldMillisDurationField *create_OrgJodaTimeFieldMillisDurationField_init(void);
...
__attribute__((unused)) static id OrgJodaTimeFieldMillisDurationField_readResolve(OrgJodaTimeFieldMillisDurationField *self);
...
- (jboolean)isEqual:(id)obj {
  if ([obj isKindOfClass:[OrgJodaTimeFieldMillisDurationField class]]) {
    return OrgJodaTimeFieldMillisDurationField_getUnitMillis(self) == OrgJodaTimeFieldMillisDurationField_getUnitMillis(nil_chk(((OrgJodaTimeFieldMillisDurationField *) obj)));
  }
  return false;
}
...
- (id)readResolve {
  return OrgJodaTimeFieldMillisDurationField_readResolve(self);
}
...
id OrgJodaTimeFieldMillisDurationField_readResolve(OrgJodaTimeFieldMillisDurationField *self) {
