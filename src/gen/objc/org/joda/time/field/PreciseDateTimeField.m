...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/PreciseDateTimeField.java
//
...
inline jlong OrgJodaTimeFieldPreciseDateTimeField_get_serialVersionUID(void);
...
- (jint)getWithLong:(jlong)instant {
  if (instant >= 0) {
    return (jint) (JreLongMod((JreLongDiv(instant, [self getUnitMillis])), iRange_));
  }
  else {
    return iRange_ - 1 + (jint) (JreLongMod((JreLongDiv((instant + 1), [self getUnitMillis])), iRange_));
  }
}
...
void OrgJodaTimeFieldPreciseDateTimeField_initWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_withOrgJodaTimeDurationField_(OrgJodaTimeFieldPreciseDateTimeField *self, OrgJodaTimeDateTimeFieldType *type, OrgJodaTimeDurationField *unit, OrgJodaTimeDurationField *range) {
  ...
  self->iRange_ = (jint) (JreLongDiv(rangeMillis, [self getUnitMillis]));
  if (self->iRange_ < 2) {
