...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/UnsupportedDateTimeField.java
//
...
inline jlong OrgJodaTimeFieldUnsupportedDateTimeField_get_serialVersionUID(void);
...
inline JavaUtilHashMap *OrgJodaTimeFieldUnsupportedDateTimeField_get_cCache(void);
...
__attribute__((unused)) static id OrgJodaTimeFieldUnsupportedDateTimeField_readResolve(OrgJodaTimeFieldUnsupportedDateTimeField *self);
...
- (jint)getWithLong:(jlong)instant {
  @throw nil_chk(OrgJodaTimeFieldUnsupportedDateTimeField_unsupported(self));
}
...
- (id)readResolve {
  return OrgJodaTimeFieldUnsupportedDateTimeField_readResolve(self);
}
...
id OrgJodaTimeFieldUnsupportedDateTimeField_readResolve(OrgJodaTimeFieldUnsupportedDateTimeField *self) {
  return OrgJodaTimeFieldUnsupportedDateTimeField_getInstanceWithOrgJodaTimeDateTimeFieldType_withOrgJodaTimeDurationField_(self->iType_, self->iDurationField_);
}
