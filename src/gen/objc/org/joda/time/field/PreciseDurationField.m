...
inline jlong OrgJodaTimeFieldPreciseDurationField_get_serialVersionUID(void);
...
- (jlong)getValueAsLongWithLong:(jlong)duration
  ...
  return JreLongDiv(duration, iUnitMillis_);
}
...
- (jlong)getDifferenceAsLongWithLong:(jlong)minuendInstant
  ...
  return JreLongDiv(difference, iUnitMillis_);
}
...
- (jboolean)isEqual:(id)obj {
  if (self == obj) {
    ...
    OrgJodaTimeFieldPreciseDurationField *other = (OrgJodaTimeFieldPreciseDurationField *) obj;
