...
//  source: /Users/andrefonseca/Documents/PodsFolders/Joda-Time/src/main/java/org/joda/time/field/BaseDateTimeField.java
//
...
/*!
 ...
 <p>
 The default implementation calls <code>getAsShortText(long,Locale)</code>.
 @param instant  the milliseconds from 1970-01-01T00:00:00Z to query
 @return the text value of the field
 */
...
/*!
 ...
 and <code>getAsText(ReadablePartial,int,Locale)</code>.
 @param partial  the partial instant to query
 @param locale  the locale to use for selecting a text symbol, null for default
 @return the text value of the field
 */
...
/*!
 ...
 <p>
 The default implementation calls <code>getAsText(long,Locale)</code>.
 @param instant  the milliseconds from 1970-01-01T00:00:00Z to query
 @return the text value of the field
 */
...
/*!
 ...
 <p>
 This implementation uses <code>set(long,String,Locale)</code>.
 <p>
...
/*!
 ...
 <p>
 This implementation uses <code>convertText(String, Locale)</code> and
 <code>set(ReadablePartial,int,int[],int)</code>.
 @param instant  the partial instant
 @param fieldIndex  the index of this field in the instant
 @param values  the values of the partial instant which should be updated
 @param text  the text value to set
