...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/UnsupportedDurationField.java
//
...
inline jlong OrgJodaTimeFieldUnsupportedDurationField_get_serialVersionUID(void);
...
inline JavaUtilHashMap *OrgJodaTimeFieldUnsupportedDurationField_get_cCache(void);
...
__attribute__((unused)) static id OrgJodaTimeFieldUnsupportedDurationField_readResolve(OrgJodaTimeFieldUnsupportedDurationField *self);
...
- (jint)getValueWithLong:(jlong)duration {
  @throw nil_chk(OrgJodaTimeFieldUnsupportedDurationField_unsupported(self));
}
...
- (jboolean)isEqual:(id)obj {
  if (self == obj) {
    ...
    OrgJodaTimeFieldUnsupportedDurationField *other = (OrgJodaTimeFieldUnsupportedDurationField *) obj;
...
- (id)readResolve {
  return OrgJodaTimeFieldUnsupportedDurationField_readResolve(self);
}
...
OrgJodaTimeFieldUnsupportedDurationField *OrgJodaTimeFieldUnsupportedDurationField_getInstanceWithOrgJodaTimeDurationFieldType_(OrgJodaTimeDurationFieldType *type) {
  ...
  @synchronized(OrgJodaTimeFieldUnsupportedDurationField_class_()) {
    ...
    return JreRetainedLocalValue(field);
  }
}
...
id OrgJodaTimeFieldUnsupportedDurationField_readResolve(OrgJodaTimeFieldUnsupportedDurationField *self) {
  return OrgJodaTimeFieldUnsupportedDurationField_getInstanceWithOrgJodaTimeDurationFieldType_(self->iType_);
}
