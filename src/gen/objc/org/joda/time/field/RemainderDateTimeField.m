...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/field/RemainderDateTimeField.java
//
...
- (jint)getWithLong:(jlong)instant {
  ...
  if (value >= 0) {
    return JreIntMod(value, iDivisor_);
  }
  else {
    return (iDivisor_ - 1) + (JreIntMod((value + 1), iDivisor_));
  }
}
...
jint OrgJodaTimeFieldRemainderDateTimeField_getDividedWithInt_(OrgJodaTimeFieldRemainderDateTimeField *self, jint value) {
  if (value >= 0) {
    return JreIntDiv(value, self->iDivisor_);
  }
  else {
    return (JreIntDiv((value + 1), self->iDivisor_)) - 1;
  }
}
