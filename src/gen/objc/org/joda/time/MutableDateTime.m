 ...
 */
inline jlong OrgJodaTimeMutableDateTime_get_serialVersionUID(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeMutableDateTime__Annotations$0(void);
...
/*!
 @brief Serialization version
 */
inline jlong OrgJodaTimeMutableDateTime_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeMutableDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeMutableDateTime_Property *self, JavaIoObjectOutputStream *oos);

__attribute__((unused)) static void OrgJodaTimeMutableDateTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeMutableDateTime_Property *self, JavaIoObjectInputStream *oos);
...
- (OrgJodaTimeMutableDateTime *)copy__ {
  return (OrgJodaTimeMutableDateTime *) cast_chk([self java_clone], [OrgJodaTimeMutableDateTime class]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LNSObject;", 0x1, 64, -1, -1, -1, -1, -1 },
  };
  ...
  methods[83].selector = @selector(java_clone);
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)oos {
  OrgJodaTimeMutableDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(self, oos);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  OrgJodaTimeMutableDateTime_Property_readObjectWithJavaIoObjectInputStream_(self, oos);
}
...
void OrgJodaTimeMutableDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeMutableDateTime_Property *self, JavaIoObjectOutputStream *oos) {
...
void OrgJodaTimeMutableDateTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeMutableDateTime_Property *self, JavaIoObjectInputStream *oos) {
  JreStrongAssign(&self->iInstant_, (OrgJodaTimeMutableDateTime *) cast_chk([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeMutableDateTime class]));
  ...
  JreStrongAssign(&self->iField_, [((OrgJodaTimeDateTimeFieldType *) nil_chk(type)) getFieldWithOrgJodaTimeChronology:[((OrgJodaTimeMutableDateTime *) nil_chk(self->iInstant_)) getChronology]]);
}
