...
//  source: /Users/marcussmith/Laundryman/Libraries/joda-time/src/main/java/org/joda/time/LocalDateTime.java
//
...
inline jlong OrgJodaTimeLocalDateTime_get_serialVersionUID(void);
...
__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDateTime__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *OrgJodaTimeLocalDateTime__Annotations$1(void);
...
inline jlong OrgJodaTimeLocalDateTime_Property_get_serialVersionUID(void);
...
__attribute__((unused)) static void OrgJodaTimeLocalDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalDateTime_Property *self, JavaIoObjectOutputStream *oos);

__attribute__((unused)) static void OrgJodaTimeLocalDateTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalDateTime_Property *self, JavaIoObjectInputStream *oos);
...
- (id)readResolve {
  return OrgJodaTimeLocalDateTime_readResolve(self);
}
...
- (jboolean)isEqual:(id)partial {
  ...
  if ([partial isKindOfClass:[OrgJodaTimeLocalDateTime class]]) {
    OrgJodaTimeLocalDateTime *other = (OrgJodaTimeLocalDateTime *) partial;
...
- (OrgJodaTimeLocalDateTime_Property *)propertyWithOrgJodaTimeDateTimeFieldType:(OrgJodaTimeDateTimeFieldType *)fieldType {
  ...
  return create_OrgJodaTimeLocalDateTime_Property_initWithOrgJodaTimeLocalDateTime_withOrgJodaTimeDateTimeField_(self, [fieldType getFieldWithOrgJodaTimeChronology:[self getChronology]]);
}
...
OrgJodaTimeLocalDateTime *OrgJodaTimeLocalDateTime_fromDateFieldsWithJavaUtilDate_(JavaUtilDate *date) {
  ...
  return create_OrgJodaTimeLocalDateTime_initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_([date getYear] + 1900, [date getMonth] + 1, [date getDate], [date getHours], [date getMinutes], [date getSeconds], JreIntMod((((jint) (JreLongMod([date getTime], 1000))) + 1000), 1000));
}
...
id OrgJodaTimeLocalDateTime_readResolve(OrgJodaTimeLocalDateTime *self) {
  if (self->iChronology_ == nil) {
    return create_OrgJodaTimeLocalDateTime_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, OrgJodaTimeChronoISOChronology_getInstanceUTC());
  }
  if ([((OrgJodaTimeDateTimeZone *) nil_chk(JreLoadStatic(OrgJodaTimeDateTimeZone, UTC))) isEqual:[self->iChronology_ getZone]] == false) {
    return create_OrgJodaTimeLocalDateTime_initWithLong_withOrgJodaTimeChronology_(self->iLocalMillis_, [self->iChronology_ withUTC]);
  }
  return self;
}
...
- (void)writeObjectWithJavaIoObjectOutputStream:(JavaIoObjectOutputStream *)oos {
  OrgJodaTimeLocalDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(self, oos);
}

- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  OrgJodaTimeLocalDateTime_Property_readObjectWithJavaIoObjectInputStream_(self, oos);
}
...
void OrgJodaTimeLocalDateTime_Property_writeObjectWithJavaIoObjectOutputStream_(OrgJodaTimeLocalDateTime_Property *self, JavaIoObjectOutputStream *oos) {
...
void OrgJodaTimeLocalDateTime_Property_readObjectWithJavaIoObjectInputStream_(OrgJodaTimeLocalDateTime_Property *self, JavaIoObjectInputStream *oos) {
  JreStrongAssign(&self->iInstant_, (OrgJodaTimeLocalDateTime *) cast_chk([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeLocalDateTime class]));
  ...
  JreStrongAssign(&self->iField_, [((OrgJodaTimeDateTimeFieldType *) nil_chk(type)) getFieldWithOrgJodaTimeChronology:[((OrgJodaTimeLocalDateTime *) nil_chk(self->iInstant_)) getChronology]]);
}
