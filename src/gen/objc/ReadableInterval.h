...
//  source: /Users/andrewebling/Laundrapp/Joda-time-Project/joda-time/src/main/java/org/joda/time/ReadableInterval.java
//

#ifndef _OrgJodaTimeReadableInterval_H_
#define _OrgJodaTimeReadableInterval_H_
...
/**
 @brief Converts the duration of the interval to a period using the standard period type.
 <p> This method should be used to exract the field values describing the difference between the start and end instants.
 @return a time period derived from the interval
 */
- (OrgJodaTimePeriod *)toPeriod;

/**
 @brief Converts the duration of the interval to a period using the specified period type.
 <p> This method should be used to exract the field values describing the difference between the start and end instants.
...
/**
 @brief Compares this object with the specified object for equality based on start and end millis plus the chronology.
 All ReadableInterval instances are accepted. <p> To compare the duration of two time intervals, use #toDuration() to get the durations and compare those.
...
/**
 @brief Gets a hash code for the time interval that is compatable with the equals method.
 <p> The formula used must be as follows: <pre>int result = 97; result = 31 * result + ((int) (getStartMillis() ^ (getStartMillis() >>> 32))); result = 31 * result + ((int) (getEndMillis() ^ (getEndMillis() >>> 32))); result = 31 * result + getChronology().hashCode(); return result;</pre>
 @return a hash code
 */
- (NSUInteger)hash;
