...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeMonthDay, serialVersionUID, long long int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeMonthDay, MONTH_OF_YEAR, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeMonthDay, DAY_OF_MONTH, int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeMonthDay_Property, serialVersionUID, long long int)
