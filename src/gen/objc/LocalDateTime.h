...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime, serialVersionUID, long long int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime, YEAR, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime, MONTH_OF_YEAR, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime, DAY_OF_MONTH, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime, MILLIS_OF_DAY, int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeLocalDateTime_Property, serialVersionUID, long long int)
