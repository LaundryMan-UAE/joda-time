...
- (OrgJodaTimeChronology *)getChronologyWithId:(id)object
                     withOrgJodaTimeChronology:(OrgJodaTimeChronology *)chrono {
  return [OrgJodaTimeDateTimeUtils getChronologyWithOrgJodaTimeChronology:chrono];
}

- (IOSIntArray *)getPartialValuesWithOrgJodaTimeReadablePartial:(id<OrgJodaTimeReadablePartial>)fieldSource
                                                         withId:(id)object
                                      withOrgJodaTimeChronology:(OrgJodaTimeChronology *)chrono {
  long long int instant = [self getInstantMillisWithId:object withOrgJodaTimeChronology:chrono];
...
- (NSString *)description {
  return [NSString stringWithFormat:@"Converter[%@]", ([self getSupportedType] == nil ? @"null" : [((IOSClass *) nil_chk([self getSupportedType])) getName])];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcClassInfo _OrgJodaTimeConvertAbstractConverter = { "AbstractConverter", "org.joda.time.convert", NULL, 0x401, 10, methods, 0, NULL, 0, NULL};
