...
#ifndef _OrgJodaTimeReadablePeriod_H_
#define _OrgJodaTimeReadablePeriod_H_
 ...
 */
- (int)getWithOrgJodaTimeDurationFieldType:(OrgJodaTimeDurationFieldType *)field;
 ...
 */
- (BOOL)isSupportedWithOrgJodaTimeDurationFieldType:(OrgJodaTimeDurationFieldType *)field;
...
/**
 ...
 Technically, the output can breach the ISO specification as weeks may be included. <p> For example, "PT6H3M5S" represents 6 hours, 3 minutes, 5 seconds.
