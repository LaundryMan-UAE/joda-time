...
#ifndef _OrgJodaTimeFieldAbstractPartialFieldProperty_H_
#define _OrgJodaTimeFieldAbstractPartialFieldProperty_H_
...
/**
 ...
 <p> For example, the following two lines of code are equivalent: <pre> partial.getDayOfMonth(); partial.dayOfMonth().get(); </pre>
...
/**
 ...
 @throws IllegalArgumentException if the instant is null or the instant doesn't support the field of this property
 */
...
/**
 ...
 @throws IllegalArgumentException if the field of this property cannot be queried on the specified instant
 */
