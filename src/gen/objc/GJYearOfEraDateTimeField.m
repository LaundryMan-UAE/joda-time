...
- (instancetype)initWithOrgJodaTimeDateTimeField:(OrgJodaTimeDateTimeField *)yearField
  ...
  if (self = [super initWithOrgJodaTimeDateTimeField:yearField withOrgJodaTimeDateTimeFieldType:[OrgJodaTimeDateTimeFieldType yearOfEra]]) {
...
- (long long int)setWithLong:(long long int)instant
                     withInt:(int)year {
  [OrgJodaTimeFieldFieldUtils verifyValueBoundsWithOrgJodaTimeDateTimeField:self withInt:year withInt:1 withInt:[self getMaximumValue]];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_GJYearOfEraDateTimeField_", "serialVersionUID", 0x1a, "J", NULL, .constantValue.asLong = OrgJodaTimeChronoGJYearOfEraDateTimeField_serialVersionUID },
    { "iChronology_", NULL, 0x12, "Lorg.joda.time.chrono.BasicChronology;", NULL,  },
  };
  static J2ObjcClassInfo _OrgJodaTimeChronoGJYearOfEraDateTimeField = { "GJYearOfEraDateTimeField", "org.joda.time.chrono", NULL, 0x10, 16, methods, 2, fields, 0, NULL};
