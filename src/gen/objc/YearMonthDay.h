...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeYearMonthDay, serialVersionUID, long long int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeYearMonthDay, YEAR, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeYearMonthDay, MONTH_OF_YEAR, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeYearMonthDay, DAY_OF_MONTH, int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeYearMonthDay_Property, serialVersionUID, long long int)
