...
#ifndef _OrgJodaTimeChronoBaseChronology_H_
#define _OrgJodaTimeChronoBaseChronology_H_
...
/**
 @brief BaseChronology provides a skeleton implementation for chronology classes.
 Many utility methods are defined, but all fields are unsupported. <p> BaseChronology is thread-safe and immutable, and all subclasses must be as well.
...
/**
 ...
 <p> This implementation uses DateTimeField#getMinimumValue(ReadablePartial,int[]) and DateTimeField#getMaximumValue(ReadablePartial,int[]) .
...
/**
 ...
 <p>DayOfWeek values are defined in org.joda.time.DateTimeConstants DateTimeConstants . They use the ISO definitions, where 1 is Monday and 7 is Sunday.
 @return DateTimeField or UnsupportedDateTimeField if unsupported
 */
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeChronoBaseChronology, serialVersionUID, long long int)
