...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeChronoBuddhistChronology, serialVersionUID, long long int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeChronoBuddhistChronology, BE, int)
...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeChronoBuddhistChronology, BUDDHIST_OFFSET, int)
