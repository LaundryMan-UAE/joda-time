...
#ifndef _OrgJodaTimeBaseAbstractPeriod_H_
#define _OrgJodaTimeBaseAbstractPeriod_H_
...
/**
 ...
 <p> This class should generally not be used directly by API users. The ReadablePeriod interface should be used when different kinds of periods are to be referenced. <p> AbstractPeriod subclasses may be mutable and not thread-safe.
...
/**
 ...
 <p> The fields are returned largest to smallest, for example Hours, Minutes, Seconds. Each value corresponds to the same array index as <code>getFields()</code>
...
/**
 ...
 <p> For example, "PT6H3M7S" represents 6 hours, 3 minutes, 7 seconds. <p> For more control over the output, see org.joda.time.format.PeriodFormatterBuilder PeriodFormatterBuilder .
