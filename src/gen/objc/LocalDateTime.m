...
//  source: /Users/andrewebling/Laundrapp/Joda-time-Project/joda-time/src/main/java/org/joda/time/LocalDateTime.java
//
...
+ (OrgJodaTimeLocalDateTime *)now {
  return [[OrgJodaTimeLocalDateTime alloc] init];
}
...
+ (OrgJodaTimeLocalDateTime *)nowWithOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone {
  ...
  return [[OrgJodaTimeLocalDateTime alloc] initWithOrgJodaTimeDateTimeZone:zone];
}
...
+ (OrgJodaTimeLocalDateTime *)nowWithOrgJodaTimeChronology:(OrgJodaTimeChronology *)chronology {
  ...
  return [[OrgJodaTimeLocalDateTime alloc] initWithOrgJodaTimeChronology:chronology];
}

+ (OrgJodaTimeLocalDateTime *)parseWithNSString:(NSString *)str {
  return [OrgJodaTimeLocalDateTime parseWithNSString:str withOrgJodaTimeFormatDateTimeFormatter:[OrgJodaTimeFormatISODateTimeFormat localDateOptionalTimeParser]];
}
...
+ (OrgJodaTimeLocalDateTime *)fromDateFieldsWithJavaUtilDate:(JavaUtilDate *)date {
  ...
  if ([((JavaUtilDate *) nil_chk(date)) getTime] < 0) {
    ...
    return [OrgJodaTimeLocalDateTime fromCalendarFieldsWithJavaUtilCalendar:cal];
  }
  return [[OrgJodaTimeLocalDateTime alloc] initWithInt:[date getYear] + 1900 withInt:[date getMonth] + 1 withInt:[date getDate] withInt:[date getHours] withInt:[date getMinutes] withInt:[date getSeconds] withInt:(((int) ([date getTime] % 1000)) + 1000) % 1000];
}

- (instancetype)init {
  return [self initOrgJodaTimeLocalDateTimeWithLong:[OrgJodaTimeDateTimeUtils currentTimeMillis] withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstance]];
}

- (instancetype)initWithOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone {
  return [self initOrgJodaTimeLocalDateTimeWithLong:[OrgJodaTimeDateTimeUtils currentTimeMillis] withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceWithOrgJodaTimeDateTimeZone:zone]];
}

- (instancetype)initWithOrgJodaTimeChronology:(OrgJodaTimeChronology *)chronology {
  return [self initOrgJodaTimeLocalDateTimeWithLong:[OrgJodaTimeDateTimeUtils currentTimeMillis] withOrgJodaTimeChronology:chronology];
}

- (instancetype)initWithLong:(long long int)instant {
  return [self initOrgJodaTimeLocalDateTimeWithLong:instant withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstance]];
}

- (instancetype)initWithLong:(long long int)instant
 withOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone {
  return [self initOrgJodaTimeLocalDateTimeWithLong:instant withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceWithOrgJodaTimeDateTimeZone:zone]];
}

- (instancetype)initOrgJodaTimeLocalDateTimeWithLong:(long long int)instant
  ...
  if (self = [super init]) {
    ...
    iChronology_ = [chronology withUTC];
  }
  return self;
}
...
withOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone {
  if (self = [super init]) {
    ...
    IOSIntArray *values = [converter getPartialValuesWithOrgJodaTimeReadablePartial:self withId:instant withOrgJodaTimeChronology:chronology withOrgJodaTimeFormatDateTimeFormatter:[OrgJodaTimeFormatISODateTimeFormat localDateOptionalTimeParser]];
...
- (instancetype)initWithInt:(int)year
  ...
  return [self initOrgJodaTimeLocalDateTimeWithInt:year withInt:monthOfYear withInt:dayOfMonth withInt:hourOfDay withInt:minuteOfHour withInt:0 withInt:0 withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceUTC]];
}
...
- (instancetype)initWithInt:(int)year
  ...
  return [self initOrgJodaTimeLocalDateTimeWithInt:year withInt:monthOfYear withInt:dayOfMonth withInt:hourOfDay withInt:minuteOfHour withInt:secondOfMinute withInt:0 withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceUTC]];
}
...
- (instancetype)initWithInt:(int)year
  ...
  return [self initOrgJodaTimeLocalDateTimeWithInt:year withInt:monthOfYear withInt:dayOfMonth withInt:hourOfDay withInt:minuteOfHour withInt:secondOfMinute withInt:millisOfSecond withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceUTC]];
}

- (instancetype)initOrgJodaTimeLocalDateTimeWithInt:(int)year
                                            withInt:(int)monthOfYear
                                            withInt:(int)dayOfMonth
                                            withInt:(int)hourOfDay
                                            withInt:(int)minuteOfHour
  ...
  if (self = [super init]) {
    ...
    long long int instant = [((OrgJodaTimeChronology *) nil_chk(chronology)) getDateTimeMillisWithInt:year withInt:monthOfYear withInt:dayOfMonth withInt:hourOfDay withInt:minuteOfHour withInt:secondOfMinute withInt:millisOfSecond];
...
- (id)readResolve {
  if (iChronology_ == nil) {
    return [[OrgJodaTimeLocalDateTime alloc] initWithLong:iLocalMillis_ withOrgJodaTimeChronology:[OrgJodaTimeChronoISOChronology getInstanceUTC]];
  }
  if ([((OrgJodaTimeDateTimeZone *) nil_chk(OrgJodaTimeDateTimeZone_get_UTC_())) isEqual:[((OrgJodaTimeChronology *) nil_chk(iChronology_)) getZone]] == NO) {
    return [[OrgJodaTimeLocalDateTime alloc] initWithLong:iLocalMillis_ withOrgJodaTimeChronology:[iChronology_ withUTC]];
  }
  return self;
}
...
- (int)compareToWithId:(id<OrgJodaTimeReadablePartial>)partial {
  ...
  if ([(id) partial isKindOfClass:[OrgJodaTimeLocalDateTime class]]) {
    OrgJodaTimeLocalDateTime *other = (OrgJodaTimeLocalDateTime *) check_class_cast(partial, [OrgJodaTimeLocalDateTime class]);
    if ([((OrgJodaTimeChronology *) nil_chk(iChronology_)) isEqual:((OrgJodaTimeLocalDateTime *) nil_chk(other))->iChronology_]) {
...
- (OrgJodaTimeDateTime *)toDateTimeWithOrgJodaTimeDateTimeZone:(OrgJodaTimeDateTimeZone *)zone {
  ...
  return [[OrgJodaTimeDateTime alloc] initWithInt:[self getYear] withInt:[self getMonthOfYear] withInt:[self getDayOfMonth] withInt:[self getHourOfDay] withInt:[self getMinuteOfHour] withInt:[self getSecondOfMinute] withInt:[self getMillisOfSecond] withOrgJodaTimeChronology:chrono];
}

- (OrgJodaTimeLocalDate *)toLocalDate {
  return [[OrgJodaTimeLocalDate alloc] initWithLong:[self getLocalMillis] withOrgJodaTimeChronology:[self getChronology]];
}

- (OrgJodaTimeLocalTime *)toLocalTime {
  return [[OrgJodaTimeLocalTime alloc] initWithLong:[self getLocalMillis] withOrgJodaTimeChronology:[self getChronology]];
}

- (JavaUtilDate *)toDate {
  int dom = [self getDayOfMonth];
  JavaUtilDate *date = [[JavaUtilDate alloc] initWithInt:[self getYear] - 1900 withInt:[self getMonthOfYear] - 1 withInt:dom withInt:[self getHourOfDay] withInt:[self getMinuteOfHour] withInt:[self getSecondOfMinute]];
  [date setTimeWithLong:[date getTime] + [self getMillisOfSecond]];
  return [self correctDstTransitionWithJavaUtilDate:date withJavaUtilTimeZone:[JavaUtilTimeZone getDefault]];
}

- (JavaUtilDate *)toDateWithJavaUtilTimeZone:(JavaUtilTimeZone *)timeZone {
  JavaUtilCalendar *calendar = [JavaUtilCalendar getInstanceWithJavaUtilTimeZone:timeZone];
  ...
  return [self correctDstTransitionWithJavaUtilDate:date withJavaUtilTimeZone:timeZone];
}
...
- (JavaUtilDate *)correctDstTransitionWithJavaUtilDate:(JavaUtilDate *)date
  ...
  OrgJodaTimeLocalDateTime *check = [OrgJodaTimeLocalDateTime fromCalendarFieldsWithJavaUtilCalendar:calendar];
  if ([((OrgJodaTimeLocalDateTime *) nil_chk(check)) isBeforeWithOrgJodaTimeReadablePartial:self]) {
    while ([check isBeforeWithOrgJodaTimeReadablePartial:self]) {
      ...
      check = [OrgJodaTimeLocalDateTime fromCalendarFieldsWithJavaUtilCalendar:calendar];
    }
    ...
    JavaUtilCalendar *earlier = [JavaUtilCalendar getInstanceWithJavaUtilTimeZone:timeZone];
    ...
    check = [OrgJodaTimeLocalDateTime fromCalendarFieldsWithJavaUtilCalendar:earlier];
...
- (OrgJodaTimeLocalDateTime *)withLocalMillisWithLong:(long long int)newMillis {
  return (newMillis == [self getLocalMillis] ? self : [[OrgJodaTimeLocalDateTime alloc] initWithLong:newMillis withOrgJodaTimeChronology:[self getChronology]]);
}

- (OrgJodaTimeLocalDateTime *)withDateWithInt:(int)year
                                      withInt:(int)monthOfYear
                                      withInt:(int)dayOfMonth {
...
- (OrgJodaTimeLocalDateTime *)withTimeWithInt:(int)hourOfDay
                                      withInt:(int)minuteOfHour
                                      withInt:(int)secondOfMinute
                                      withInt:(int)millisOfSecond {
  OrgJodaTimeChronology *chrono = [self getChronology];
...
- (OrgJodaTimeLocalDateTime *)withDurationAddedWithOrgJodaTimeReadableDuration:(id<OrgJodaTimeReadableDuration>)durationToAdd
  ...
  long long int instant = [((OrgJodaTimeChronology *) nil_chk([self getChronology])) addWithLong:[self getLocalMillis] withLong:[((id<OrgJodaTimeReadableDuration>) nil_chk(durationToAdd)) getMillis] withInt:scalar];
  return [self withLocalMillisWithLong:instant];
}
...
- (OrgJodaTimeLocalDateTime *)plusYearsWithInt:(int)years {
  if (years == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusMonthsWithInt:(int)months {
  if (months == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusWeeksWithInt:(int)weeks {
  if (weeks == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusDaysWithInt:(int)days {
  if (days == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusHoursWithInt:(int)hours {
  if (hours == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusMinutesWithInt:(int)minutes {
  if (minutes == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusSecondsWithInt:(int)seconds {
  if (seconds == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)plusMillisWithInt:(int)millis {
  if (millis == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusYearsWithInt:(int)years {
  if (years == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusMonthsWithInt:(int)months {
  if (months == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusWeeksWithInt:(int)weeks {
  if (weeks == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusDaysWithInt:(int)days {
  if (days == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusHoursWithInt:(int)hours {
  if (hours == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusMinutesWithInt:(int)minutes {
  if (minutes == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusSecondsWithInt:(int)seconds {
  if (seconds == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime *)minusMillisWithInt:(int)millis {
  if (millis == 0) {
    return self;
  }
...
- (OrgJodaTimeLocalDateTime_Property *)propertyWithOrgJodaTimeDateTimeFieldType:(OrgJodaTimeDateTimeFieldType *)fieldType {
  ...
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeDateTimeFieldType *) nil_chk(fieldType)) getFieldWithOrgJodaTimeChronology:[self getChronology]]];
}
...
- (OrgJodaTimeLocalDateTime *)withEraWithInt:(int)era {
...
- (OrgJodaTimeLocalDateTime *)withCenturyOfEraWithInt:(int)centuryOfEra {
...
- (OrgJodaTimeLocalDateTime *)withYearOfEraWithInt:(int)yearOfEra {
...
- (OrgJodaTimeLocalDateTime *)withYearOfCenturyWithInt:(int)yearOfCentury {
...
- (OrgJodaTimeLocalDateTime *)withYearWithInt:(int)year {
...
- (OrgJodaTimeLocalDateTime *)withWeekyearWithInt:(int)weekyear {
...
- (OrgJodaTimeLocalDateTime *)withMonthOfYearWithInt:(int)monthOfYear {
...
- (OrgJodaTimeLocalDateTime *)withWeekOfWeekyearWithInt:(int)weekOfWeekyear {
...
- (OrgJodaTimeLocalDateTime *)withDayOfYearWithInt:(int)dayOfYear {
...
- (OrgJodaTimeLocalDateTime *)withDayOfMonthWithInt:(int)dayOfMonth {
...
- (OrgJodaTimeLocalDateTime *)withDayOfWeekWithInt:(int)dayOfWeek {
...
- (OrgJodaTimeLocalDateTime *)withHourOfDayWithInt:(int)hour {
...
- (OrgJodaTimeLocalDateTime *)withMinuteOfHourWithInt:(int)minute {
...
- (OrgJodaTimeLocalDateTime *)withSecondOfMinuteWithInt:(int)second {
...
- (OrgJodaTimeLocalDateTime *)withMillisOfSecondWithInt:(int)millis {
...
- (OrgJodaTimeLocalDateTime *)withMillisOfDayWithInt:(int)millis {
...
- (OrgJodaTimeLocalDateTime_Property *)era {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) era]];
}

- (OrgJodaTimeLocalDateTime_Property *)centuryOfEra {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) centuryOfEra]];
}

- (OrgJodaTimeLocalDateTime_Property *)yearOfCentury {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) yearOfCentury]];
}

- (OrgJodaTimeLocalDateTime_Property *)yearOfEra {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) yearOfEra]];
}

- (OrgJodaTimeLocalDateTime_Property *)year {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) year]];
}

- (OrgJodaTimeLocalDateTime_Property *)weekyear {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) weekyear]];
}

- (OrgJodaTimeLocalDateTime_Property *)monthOfYear {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) monthOfYear]];
}

- (OrgJodaTimeLocalDateTime_Property *)weekOfWeekyear {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) weekOfWeekyear]];
}

- (OrgJodaTimeLocalDateTime_Property *)dayOfYear {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) dayOfYear]];
}

- (OrgJodaTimeLocalDateTime_Property *)dayOfMonth {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) dayOfMonth]];
}

- (OrgJodaTimeLocalDateTime_Property *)dayOfWeek {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) dayOfWeek]];
}

- (OrgJodaTimeLocalDateTime_Property *)hourOfDay {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) hourOfDay]];
}

- (OrgJodaTimeLocalDateTime_Property *)minuteOfHour {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) minuteOfHour]];
}

- (OrgJodaTimeLocalDateTime_Property *)secondOfMinute {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) secondOfMinute]];
}

- (OrgJodaTimeLocalDateTime_Property *)millisOfSecond {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) millisOfSecond]];
}

- (OrgJodaTimeLocalDateTime_Property *)millisOfDay {
  return [[OrgJodaTimeLocalDateTime_Property alloc] initWithOrgJodaTimeLocalDateTime:self withOrgJodaTimeDateTimeField:[((OrgJodaTimeChronology *) nil_chk([self getChronology])) millisOfDay]];
}

- (NSString *)description {
  return [((OrgJodaTimeFormatDateTimeFormatter *) nil_chk([OrgJodaTimeFormatISODateTimeFormat dateTime])) printWithOrgJodaTimeReadablePartial:self];
}
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_LocalDateTime_", "serialVersionUID", 0x1a, "J", NULL, .constantValue.asLong = OrgJodaTimeLocalDateTime_serialVersionUID },
  ...
  static J2ObjcClassInfo _OrgJodaTimeLocalDateTime = { "LocalDateTime", "org.joda.time", NULL, 0x11, 118, methods, 7, fields, 0, NULL};
...
- (void)readObjectWithJavaIoObjectInputStream:(JavaIoObjectInputStream *)oos {
  iInstant_ = (OrgJodaTimeLocalDateTime *) check_class_cast([((JavaIoObjectInputStream *) nil_chk(oos)) readObject], [OrgJodaTimeLocalDateTime class]);
...
- (OrgJodaTimeLocalDateTime *)addToCopyWithInt:(int)value {
...
- (OrgJodaTimeLocalDateTime *)addToCopyWithLong:(long long int)value {
...
- (OrgJodaTimeLocalDateTime *)addWrapFieldToCopyWithInt:(int)value {
...
- (OrgJodaTimeLocalDateTime *)setCopyWithInt:(int)value {
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    { "serialVersionUID_Property_", "serialVersionUID", 0x1a, "J", NULL, .constantValue.asLong = OrgJodaTimeLocalDateTime_Property_serialVersionUID },
    { "iInstant_", NULL, 0x82, "Lorg.joda.time.LocalDateTime;", NULL,  },
    { "iField_", NULL, 0x82, "Lorg.joda.time.DateTimeField;", NULL,  },
  };
  static J2ObjcClassInfo _OrgJodaTimeLocalDateTime_Property = { "Property", "org.joda.time", "LocalDateTime", 0x19, 20, methods, 3, fields, 0, NULL};
