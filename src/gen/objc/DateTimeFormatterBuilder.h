...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneName, LONG_NAME, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneName, SHORT_NAME, int)

typedef enum {
  OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_INSTANCE = 0,
} OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId;
...
FOUNDATION_EXPORT OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum *OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum_values[];

#define OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum_INSTANCE OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum_values[OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneId_INSTANCE]
...
FOUNDATION_EXPORT int OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum_MAX_LENGTH_;
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormatterBuilder_TimeZoneIdEnum, MAX_LENGTH_, int)
