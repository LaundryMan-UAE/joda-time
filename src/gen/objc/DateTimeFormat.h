...
J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, FULL, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, LONG, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, MEDIUM, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, SHORT, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, NONE, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, DATE, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, TIME, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, DATETIME, int)

J2OBJC_STATIC_FIELD_GETTER(OrgJodaTimeFormatDateTimeFormat, PATTERN_CACHE_SIZE, int)
